...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\nstruct Trie {\n    struct Node\
    ...
    \ max_l;      // \u3053\u306E\u9802\u70B9\u3092\u6839\u3068\u3059\u308B\u90E8\u5206\
    \u6728\u306B\u542B\u307E\u308C\u308B\u5358\u8A9E\u306E\u6700\u5C0F\u9577\u3068\
    \u6700\u5927\u9577\n\n        Node(long long i, long long c_, long long d): id(i),\
    \ c(c_), common(0), depth(d), min_l(inf64), max_l(-1) {}\n    };\n\n    vector<Node>\
  ...
  requiredBy: []
  timestamp: '2025-03-23 19:02:27+09:00'
  verificationStatus: LIBRARY_ALL_WA
  verifiedWith:
  - test/string/trie-tree/atcoder-abc353-e.test.cpp
  - test/string/trie-tree/atcoder-abc377-g.test.cpp

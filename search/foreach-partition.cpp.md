...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \    return result;\n}\n#line 3 \"search/foreach-partition.cpp\"\n\nvoid recursive_partition(vector<vector<long\
    ...
    \ {\n        rep(i, indices.size()) {\n            insert(i, idx);\n         \
    \   indices[i].push_back(idx);\n            recursive_partition(indices, K, idx\
    \ - 1, f, insert, erase);\n            indices[i].pop_back();\n            erase(i,\
    \ idx);\n        }\n    }\n\n    if (indices.size() < K) {\n        insert(indices.size(),\
    \ idx);\n        indices.push_back({idx});\n        recursive_partition(indices,\
    ...
    \u3057\u3066\u95A2\u6570f\u3092\u9069\u7528\u3059\u308B\n// \u63A2\u7D22\u3059\
    \u308B\u500B\u6570\u306F\u7B2C2\u7A2E\u30B9\u30BF\u30FC\u30EA\u30F3\u30B0\u6570\
    \u3068\u306A\u308B\u306E\u3067\uFF0CO(Stirling2(N, K)) * O(f)\n// insert(i, idx)\u306F\
    i\u756A\u76EE\u306E\u30B0\u30EB\u30FC\u30D7\u306Bidx\u756A\u76EE\u306E\u8981\u7D20\
    \u3092\u8FFD\u52A0\u3059\u308B\u51E6\u7406\n// erase(i, idx)\u306Fi\u756A\u76EE\
    \u306E\u30B0\u30EB\u30FC\u30D7\u304B\u3089idx\u756A\u76EE\u306E\u8981\u7D20\u3092\
    \u524A\u9664\u3059\u308B\u51E6\u7406\nvoid foreach_partition(long long N, long\
    \ long K, function<void(vvll&)> f, function<void(ll, ll)> insert = [](ll, ll){},\
    \ function<void(ll, ll)> erase = [](ll, ll){}) {\n    vector<vector<long long>>\
  ...
  verifiedWith: []
documentation_of: search/foreach-partition.cpp
layout: document
redirect_from:
- /library/search/foreach-partition.cpp
- /library/search/foreach-partition.cpp.html

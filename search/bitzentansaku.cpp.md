...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ x) { return __builtin_popcountll(x); }\n#endif\n#line 2 \"search/bitzentansaku.cpp\"\
  ...
  code: "#include \"../base.cpp\"\n\nstruct ExhaustiveSearch {\n    long long N, M;\n\
    \n    ExhaustiveSearch(long long n) : N(n) {};\n\n    auto operator() () {\n \
    \       long long ret = 0;\n        vector<ll> v(N);\n\n        for (long long\
    \ bit = 0; bit < (1ll << N); ++bit) {\n            ll x = bit;\n            rep(i,\
    \ N) {\n                v[i] = x % 2;\n                x /= M;\n            }\n\
    \n            // sort(v.begin(), v.end());\n            // do {\n            \
  ...
  verifiedWith: []
documentation_of: search/bitzentansaku.cpp
layout: document
redirect_from:
- /library/search/bitzentansaku.cpp
- /library/search/bitzentansaku.cpp.html

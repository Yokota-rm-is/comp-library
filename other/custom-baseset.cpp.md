...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\nstruct CustomBaseset {\n    const\
    ...
    \    long long x;\n\n    CustomBaseset(long long base, long long n, long long\
    \ x = 0) : bases(n, base), N(n), powers(n + 1, 1), x(x) {\n        init();\n \
...
layout: document
redirect_from:
- /library/other/custom-baseset.cpp
- /library/other/custom-baseset.cpp.html

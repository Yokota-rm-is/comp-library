...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate <class T, class S>\nstruct\
    \ RangeMap {\n    map<pair<T, T>, S> mp;\n    S default_val;\n\n    RangeMap(S\
    \ default_val = S()) : default_val(default_val) {\n        init();\n    }\n\n\
    \    void init() {\n        mp.clear();\n        mp[{-inf64, -inf64}] = default_val;\n\
    \        mp[{inf64, inf64}] = default_val;\n    }\n\n    void set(const T l, const\
    \ T r, const S val) {\n        {\n            auto it = prev(mp.upper_bound({l,\
    \ inf64}));\n            pair<T, T> range = it->first;\n            S val = it->second;\n\
    \            if (l < range.second) {\n                mp.erase(it);\n        \
    \        mp[{range.first, l}] = val;\n            }\n        }\n\n        {\n\
...
documentation_of: other/range-map.cpp
layout: document
redirect_from:
- /library/other/range-map.cpp
- /library/other/range-map.cpp.html

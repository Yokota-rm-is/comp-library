...
data:
  ...
  verifiedWith: []
documentation_of: other/cumulative_sum.cpp
layout: document
redirect_from:
- /library/other/cumulative_sum.cpp
- /library/other/cumulative_sum.cpp.html

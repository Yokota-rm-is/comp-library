...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate <typename Key, typename\
    ...
    \    long long H, W;\n    pair<Key, Key> offset_key;\n\n    RotatableMap2D() :\
    \ H(0), W(0), offset_key(0, 0) {}\n    RotatableMap2D(long long h, long long w)\
    \ : H(h), W(w), offset_key(0, 0) {}\n    RotatableMap2D(map<pair<Key, Key>, Value>\
    \ mp, long long h = 0, long long w = 0) : original(mp), H(h), W(w), offset_key(0,\
    \ 0) {}\n\n    // key\u306E\u5024\u3092x\u5897\u3084\u3059\n    // (key_y, key_x)\
    \    : (1, 1), (2, 3), (4, 9), (8, 27), (16, 81), ... -> add_key_x\n    // value:\
    \            :      3,      1,     4,       1,         5, ...\n    //\n    //\
    \ (key_y, key_x + 1): (1, 2), (2, 4), (4, 10), (8, 28), (16, 82), ...\n    //\
...
documentation_of: other/rotatable-map-2d.cpp
layout: document
redirect_from:
- /library/other/rotatable-map-2d.cpp
- /library/other/rotatable-map-2d.cpp.html

...
data:
  ...
  attributes:
    links:
    - https://github.com/kazuma8128/procon-lib/blob/master/Structure/binary_search_tree/red_black_tree/normal/set.cpp
...
documentation_of: mystd/myset.cpp
layout: document
redirect_from:
- /library/mystd/myset.cpp
- /library/mystd/myset.cpp.html

...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate <typename T>\nstruct Tuple\
    \ : public pair<pair<T, T>, pair<T, T>> {\n    using pp = pair<pair<T, T>, pair<T,\
    \ T>>;\n\n    Tuple(T a, T b, T c) : pp({a, b}, {c, 0}) {};\n    Tuple(T a, T\
    \ b, T c, T d) : pp({a, b}, {c, d}) {};\n\n    T& operator[] (size_t i) {\n  \
  ...
  verifiedWith: []
documentation_of: mystd/mytuple.cpp
layout: document
redirect_from:
- /library/mystd/mytuple.cpp
- /library/mystd/mytuple.cpp.html

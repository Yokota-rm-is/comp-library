...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ x) { return __builtin_popcountll(x); }\n#endif\n#line 3 \"mystd/mypair.cpp\"\
    \n\ntemplate <typename T, typename U> struct Pair : public pair<T, U> {\n    using\
    \ pair<T, U>::pair;\n    constexpr Pair<T, U> operator - () const noexcept {return\
    \ {-this->first, -this->second};}\n    template<typename S> constexpr Pair<T,\
    \ U> operator + (const S& r) const noexcept { return Pair<T, U>(*this) += {r,\
    \ r}; }\n    template<typename S> constexpr Pair<T, U> operator - (const S& r)\
    \ const noexcept { return Pair<T, U>(*this) -= {r, r}; }\n    template<typename\
    \ S> constexpr Pair<T, U> operator * (const S& r) const noexcept { return Pair<T,\
    \ U>(*this) *= {r, r}; }\n    template<typename S> constexpr Pair<T, U> operator\
    \ / (const S& r) const noexcept { return Pair<T, U>(*this) /= {r, r}; }\n    constexpr\
    \ Pair<T, U> operator + (const Pair<T, U>& r) const noexcept { return Pair<T,\
    \ U>(*this) += r; }\n    constexpr Pair<T, U> operator - (const Pair<T, U>& r)\
    \ const noexcept { return Pair<T, U>(*this) -= r; }\n    constexpr Pair<T, U>\
    \ operator * (const Pair<T, U>& r) const noexcept { return Pair<T, U>(*this) *=\
    \ r; }\n    constexpr Pair<T, U> operator / (const Pair<T, U>& r) const noexcept\
    \ { return Pair<T, U>(*this) /= r; }\n    template<typename S> constexpr Pair<T,\
    \ U>& operator += (const S& r) noexcept { this->first += r; this->second += r;\
    \ return *this;}\n    template<typename S> constexpr Pair<T, U>& operator -= (const\
    \ S& r) noexcept { this->first -= r; this->second -= r; return *this;}\n    template<typename\
    \ S> constexpr Pair<T, U>& operator *= (const S& r) noexcept { this->first *=\
    \ r; this->second *= r; return *this;}\n    template<typename S> constexpr Pair<T,\
    \ U>& operator /= (const S& r) noexcept { this->first /= r; this->second /= r;\
    \ return *this;}\n    template<typename S> constexpr Pair<T, U>& operator %= (const\
    \ S& r) noexcept { this->first %= r; this->second %= r; return *this;}\n    constexpr\
    \ Pair<T, U>& operator += (const Pair<T, U>& r) noexcept { this->first += r.first;\
    \ this->second += r.second; return *this;}\n    constexpr Pair<T, U>& operator\
    \ -= (const Pair<T, U>& r) noexcept { this->first -= r.first; this->second -=\
    \ r.second; return *this;}\n    constexpr Pair<T, U>& operator *= (const Pair<T,\
    \ U>& r) noexcept { this->first *= r.first; this->second *= r.second; return *this;}\n\
    \    constexpr Pair<T, U>& operator /= (const Pair<T, U>& r) noexcept { this->first\
    \ /= r.first; this->second /= r.second; return *this;}\n    constexpr Pair<T,\
    \ U>& operator %= (const Pair<T, U>& r) noexcept { this->first %= r.first; this->second\
    \ %= r.second; return *this;}\n};\n\nusing mypairll = Pair<ll, ll>;\n"
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate <typename T, typename\
    \ U> struct Pair : public pair<T, U> {\n    using pair<T, U>::pair;\n    constexpr\
    \ Pair<T, U> operator - () const noexcept {return {-this->first, -this->second};}\n\
    \    template<typename S> constexpr Pair<T, U> operator + (const S& r) const noexcept\
    \ { return Pair<T, U>(*this) += {r, r}; }\n    template<typename S> constexpr\
    \ Pair<T, U> operator - (const S& r) const noexcept { return Pair<T, U>(*this)\
    \ -= {r, r}; }\n    template<typename S> constexpr Pair<T, U> operator * (const\
    \ S& r) const noexcept { return Pair<T, U>(*this) *= {r, r}; }\n    template<typename\
    \ S> constexpr Pair<T, U> operator / (const S& r) const noexcept { return Pair<T,\
    \ U>(*this) /= {r, r}; }\n    constexpr Pair<T, U> operator + (const Pair<T, U>&\
    \ r) const noexcept { return Pair<T, U>(*this) += r; }\n    constexpr Pair<T,\
    \ U> operator - (const Pair<T, U>& r) const noexcept { return Pair<T, U>(*this)\
    \ -= r; }\n    constexpr Pair<T, U> operator * (const Pair<T, U>& r) const noexcept\
    \ { return Pair<T, U>(*this) *= r; }\n    constexpr Pair<T, U> operator / (const\
    \ Pair<T, U>& r) const noexcept { return Pair<T, U>(*this) /= r; }\n    template<typename\
    \ S> constexpr Pair<T, U>& operator += (const S& r) noexcept { this->first +=\
    \ r; this->second += r; return *this;}\n    template<typename S> constexpr Pair<T,\
    \ U>& operator -= (const S& r) noexcept { this->first -= r; this->second -= r;\
    \ return *this;}\n    template<typename S> constexpr Pair<T, U>& operator *= (const\
    ...
    \ U>& operator %= (const S& r) noexcept { this->first %= r; this->second %= r;\
    \ return *this;}\n    constexpr Pair<T, U>& operator += (const Pair<T, U>& r)\
    \ noexcept { this->first += r.first; this->second += r.second; return *this;}\n\
    \    constexpr Pair<T, U>& operator -= (const Pair<T, U>& r) noexcept { this->first\
    \ -= r.first; this->second -= r.second; return *this;}\n    constexpr Pair<T,\
    \ U>& operator *= (const Pair<T, U>& r) noexcept { this->first *= r.first; this->second\
    \ *= r.second; return *this;}\n    constexpr Pair<T, U>& operator /= (const Pair<T,\
  ...
  requiredBy: []
  timestamp: '2024-04-18 20:36:55+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: mystd/mypair.cpp
layout: document
redirect_from:
- /library/mystd/mypair.cpp
- /library/mystd/mypair.cpp.html

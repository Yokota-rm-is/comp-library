...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ = calc_mod(calc_mul(hash_rev, base) + c);\n        }\n    }\n\n    bool is_palindrome()\
    \ {\n        return hash == hash_rev;\n    }\n\n    Hash61& operator+= (const\
    \ Hash61 &other) noexcept {\n        hash = calc_mod(calc_mul(hash, other.pow)\
    \ + other.hash);\n        hash_rev = calc_mod(calc_mul(other.hash_rev, pow) +\
    ...
    \    }\n};\n"
  code: "#include \"../base.cpp\"\n\nunsigned long long set_base(unsigned long long\
    \ Max = 127, unsigned long long MOD = (1ULL << 61) - 1, unsigned long long root\
    \ = 37) {\n    random_device rd;\n    mt19937_64 gen(rd());\n    uniform_int_distribution<int>\
    \ dist(1, INF32);\n    unsigned long long ret;\n\n    while (true) {\n       \
    \ int k = dist(gen);\n        ret = binpow(root, (unsigned long long)k, MOD);\n\
    \        if (ret > Max) break;\n    };\n\n    return ret;\n}\n\nstatic const unsigned\
    \ long long base = set_base();\nstatic const unsigned long long MOD = (1ULL <<\
  ...
  verifiedWith: []
documentation_of: hash/hash61.cpp
layout: document
redirect_from:
- /library/hash/hash61.cpp
- /library/hash/hash61.cpp.html

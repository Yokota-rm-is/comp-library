...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\n// \u6574\u6570\u5024 x \u306B\u30CF\
    ...
    \ x) {\n        if constexpr (multi) hash += rng(x);\n        else hash ^= rng(x);\
    \ \n    }\n    void erase(ull x) { \n        if constexpr (multi) hash -= rng(x);\n\
    \        else hash ^= rng(x);\n    }\n\n    ZobristHash operator+(const ZobristHash&\
    \ rhs) const { \n        if constexpr (multi) return ZobristHash<multi>(hash +\
    \ rhs.hash); \n        else return ZobristHash<multi>(hash ^ rhs.hash);\n    }\n\
    \    ZobristHash operator-(const ZobristHash& rhs) const { \n        if constexpr\
    \ (multi) return ZobristHash<multi>(hash - rhs.hash); \n        else return ZobristHash<multi>(hash\
    \ ^ rhs.hash);\n    }\n    ZobristHash operator+(ull h) const { \n        if constexpr\
    \ (multi) return ZobristHash<multi>(hash + rng(h)); \n        else return ZobristHash<multi>(hash\
    \ ^ rng(h));\n    }\n    ZobristHash operator-(ull h) const { \n        if constexpr\
    \ (multi) return ZobristHash<multi>(hash - rng(h)); \n        else return ZobristHash<multi>(hash\
    \ ^ rng(h));\n    }\n    \n    bool operator==(const ZobristHash& rhs) const {\
    \ return hash == rhs.hash; }\n    bool operator!=(const ZobristHash& rhs) const\
...
documentation_of: hash/zobrist-hash.cpp
layout: document
redirect_from:
- /library/hash/zobrist-hash.cpp
- /library/hash/zobrist-hash.cpp.html

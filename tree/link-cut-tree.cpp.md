...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\n// \u53C2\u8003: https://ei1333.hateblo.jp/entry/2018/05/29/011140\n\
    ...
    \ T)>>, \"op must be function<T(T, T)>\");\n    static_assert(is_convertible_v<decltype(e),\
    \ function<T()>>, \"e must be function<T()>\");\n    static_assert(is_convertible_v<decltype(mapping),\
    \ function<T(T, F)>>, \"mapping must be function<T(T, F)>\");\n    static_assert(is_convertible_v<decltype(composition),\
    \ function<F(F, F)>>, \"composition must be function<F(F, F)>\");\n    static_assert(is_convertible_v<decltype(id),\
    \ function<F()>>, \"id must be function<F()>\");\n#endif\n    struct Node {\n\
    \        Node *l, *r, *p;\n        int idx;\n        T value, prod, rprod;\n \
...
documentation_of: tree/link-cut-tree.cpp
layout: document
redirect_from:
- /library/tree/link-cut-tree.cpp
- /library/tree/link-cut-tree.cpp.html

...
documentation_of: tree/euler-tour-subtree-query-with-segment-tree.cpp
layout: document
redirect_from:
- /library/tree/euler-tour-subtree-query-with-segment-tree.cpp
- /library/tree/euler-tour-subtree-query-with-segment-tree.cpp.html

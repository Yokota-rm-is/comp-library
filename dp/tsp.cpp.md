...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ long to;\n    T weight;\n    \n    explicit Edge(long long u, long long v, T\
    ...
    \ T INF = INF64 / 2;\n\n    explicit BitDP(long long V, bool directed) : V(V),\
    \ G(V), directed(directed) {\n        init();\n    }\n\n    void init() {\n  \
    ...
    \ = now;\n                        chmax(max_visit, __builtin_popcountll(next_bit));\n\
    \                    }\n                }\n            }\n        }\n    }\n\n\
    \    T get_dist(long long start, long long goal, long long bit) {\n        if\
    \ (goal != start) {\n            bit ^= (1 << start); \n        }\n        return\
    \ dp[bit][goal];\n    }\n\n    T dist_to(long long goal) {\n        long long\
    \ start;\n        rep(i, V) if (dp.front()[i] == 0) start = i;\n\n        long\
    \ long bit = (1 << V) - 1;\n\n        return get_dist(start, goal, bit);\n   \
    \ }\n\n    vector<long long> path(long long goal) {\n        long long start;\n\
    \        rep(i, V) if (dp.front()[i] == 0) start = i;\n\n        long long bit\
    \ = (1 << V) - 1;\n        if (start != goal) {\n            bit ^= (1 << start);\n\
    \        }\n\n        vector<long long> p;\n        p.push_back(goal);\n\n   \
    \     long long to = goal;\n        while (true) {\n            long long from\
  ...
  code: "#include \"../base.cpp\"\n\n\ntemplate<typename T = long long>\nstruct Edge\
    ...
    \ Graph G{};\n    vector<vector<T>> dp{};\n    vector<vector<long long>> prev{};\n\
    \    int max_visit = 0;\n\n    T INF = INF64 / 2;\n\n    explicit BitDP(long long\
    \ V, bool directed) : V(V), G(V), directed(directed) {\n        init();\n    }\n\
    \n    void init() {\n        dp.assign((1 << V), vector<T>(V, INF));\n       \
    ...
    \     chmax(max_visit, __builtin_popcountll(next_bit));\n                    }\n\
    \                }\n            }\n        }\n    }\n\n    T get_dist(long long\
    \ start, long long goal, long long bit) {\n        if (goal != start) {\n    \
    \        bit ^= (1 << start); \n        }\n        return dp[bit][goal];\n   \
    \ }\n\n    T dist_to(long long goal) {\n        long long start;\n        rep(i,\
    \ V) if (dp.front()[i] == 0) start = i;\n\n        long long bit = (1 << V) -\
    \ 1;\n\n        return get_dist(start, goal, bit);\n    }\n\n    vector<long long>\
    \ path(long long goal) {\n        long long start;\n        rep(i, V) if (dp.front()[i]\
    \ == 0) start = i;\n\n        long long bit = (1 << V) - 1;\n        if (start\
    \ != goal) {\n            bit ^= (1 << start);\n        }\n\n        vector<long\
    \ long> p;\n        p.push_back(goal);\n\n        long long to = goal;\n     \
  ...
  verifiedWith: []
documentation_of: dp/tsp.cpp
layout: document
redirect_from:
- /library/dp/tsp.cpp
- /library/dp/tsp.cpp.html
title: dp/tsp.cpp
---

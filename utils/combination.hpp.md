...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ x) { return __builtin_popcountll(x); }\n#endif\n#line 2 \"utils/combination.hpp\"\
    \n\n// \u914D\u5217\u306E\u8981\u7D20\u304B\u3089K\u500B\u9078\u3076\u7D44\u307F\
    \u5408\u308F\u305B\u3092\u5217\u6319\u3059\u308B\n// grobal\u306Bnext_combination\u3092\
    \u7F6E\u304F\u3053\u3068\nlong long K = ${2};\nsort(${1}.begin(), ${1}.end());\n\
    do {\n\n} while (next_combination(${1}.begin(), ${1}.begin() + K, ${1}.end()));\n"
  code: "#include \"../base.cpp\"\n\n// \u914D\u5217\u306E\u8981\u7D20\u304B\u3089\
    K\u500B\u9078\u3076\u7D44\u307F\u5408\u308F\u305B\u3092\u5217\u6319\u3059\u308B\
    \n// grobal\u306Bnext_combination\u3092\u7F6E\u304F\u3053\u3068\nlong long K =\
    \ ${2};\nsort(${1}.begin(), ${1}.end());\ndo {\n\n} while (next_combination(${1}.begin(),\
    \ ${1}.begin() + K, ${1}.end()));"
  dependsOn:
  - base.cpp
  ...
  verifiedWith: []
documentation_of: utils/combination.hpp
layout: document
redirect_from:
- /library/utils/combination.hpp
- /library/utils/combination.hpp.html

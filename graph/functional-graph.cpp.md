...
data:
  ...
  requiredBy: []
  timestamp: '2025-03-23 18:25:24+09:00'
  verificationStatus: LIBRARY_ALL_WA
  verifiedWith:
  - test/graph/functional-graph/atcoder-abc387-f.test.cpp
  - test/graph/functional-graph/atcoder-abc357-e.test.cpp
documentation_of: graph/functional-graph.cpp
layout: document
redirect_from:
- /library/graph/functional-graph.cpp
- /library/graph/functional-graph.cpp.html

...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\nstruct BFS {\n    struct Edge {\n\
    \        long long from;\n        long long to;\n        bool different;\n   \
    \     \n        explicit Edge(long long u = -1, long long v = -1, bool d = true)\
    \ : from(u), to(v), different(d) {};\n\n        bool operator < (const Edge& other)\
    \ const {\n            if (from == other.from) {\n                return to <\
...
documentation_of: graph/bfs-bipartite.cpp
layout: document
redirect_from:
- /library/graph/bfs-bipartite.cpp
- /library/graph/bfs-bipartite.cpp.html

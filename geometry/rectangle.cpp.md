...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ x) { return __builtin_popcountll(x); }\n#endif\n#line 2 \"geometry/rectangle.cpp\"\
    \n\ntemplate<typename T>\nstruct Rectangle {\n    T left, right, top, bottom;\n\
    \n    Rectangle(T l, T r, T t, T b) : left(l), right(r), top(t), bottom(b) {};\n\
    \n    bool is_overlapped(const Rectangle& other) {\n        return !is_not_overlapped(other);\n\
    \    }\n\n    bool is_not_overlapped(const Rectangle& other) {\n        return\
    \ right <= other.left or other.right <= left or bottom <= other.top or other.bottom\
    \ <= top;\n    }\n};\n"
  code: "#include \"../base.cpp\"\n\ntemplate<typename T>\nstruct Rectangle {\n  \
    \  T left, right, top, bottom;\n\n    Rectangle(T l, T r, T t, T b) : left(l),\
    \ right(r), top(t), bottom(b) {};\n\n    bool is_overlapped(const Rectangle& other)\
    \ {\n        return !is_not_overlapped(other);\n    }\n\n    bool is_not_overlapped(const\
    \ Rectangle& other) {\n        return right <= other.left or other.right <= left\
    \ or bottom <= other.top or other.bottom <= top;\n    }\n};"
  dependsOn:
  - base.cpp
  ...
  verifiedWith: []
documentation_of: geometry/rectangle.cpp
layout: document
redirect_from:
- /library/geometry/rectangle.cpp
- /library/geometry/rectangle.cpp.html

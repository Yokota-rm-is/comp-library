...
data:
  ...
  verifiedWith: []
documentation_of: math/binomial_coeff.cpp
layout: document
redirect_from:
- /library/math/binomial_coeff.cpp
- /library/math/binomial_coeff.cpp.html

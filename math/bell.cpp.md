...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate <long long MOD = -1>\n\
    ...
    \ {\n        assert(n <= 26 or MOD != -1);\n        init();\n    }\n\n    Bell(long\
    \ long n, long long k) : N(n), K(min(k, n)) {\n        assert(n <= 26 or MOD !=\
    \ -1);\n        init();\n    }\n\n    void init() {\n        if (N * K <= 1e7)\
    \ {\n            dp = vector<vector<long long>>(N + 1, vector<long long>(K + 1,\
    \ 0));\n            cum = vector<vector<long long>>(N + 1, vector<long long>(1,\
    \ 0));\n            dp[0][0] = 1;\n            rep(i, 1, N + 1) {\n          \
    ...
    \            }\n            return cum[n][k];\n        }\n        else {\n   \
    \         long long ret = 0;\n            rep(i, k + 1) {\n                ret\
    \ += (pow(i, n) * fact_inv[i] % MOD) * table[k - i] % MOD;\n                ret\
    \ %= MOD;\n            }\n            return ret;\n        }\n    }\n\n    long\
    \ long operator()(long long k) {\n        return get(N, k);\n    }\n\n    long\

...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash-on-segment-tree/yukicoder-2761.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"string/rolling-hash-on-segment-tree.cpp\"\n\n\
    ...
    \    vector<Hash61> node;\n\n    RollingHashonSegmentTree() {}\n    RollingHashonSegmentTree(string&\
    \ S) { \n        init(S);\n    }\n\n    void init(string& S) {\n        _N = S.size();\n\
    \        N = 1;\n        height = 1;\n        while (N < (_N + 1)) {\n       \
    \     N *= 2;\n            ++height;\n        }\n        \n        node.assign(2\
    \ * N, Hash61());\n\n        rep(i, _N) {\n            node[i + N].set(S[i]);\n\
    ...
    \      node[k] = node[k * 2] + node[k * 2 + 1];\n    }\n};\n#line 4 \"test/string/rolling-hash-on-segment-tree/yukicoder-2761.test.cpp\"\
    \n\nint main() {\n    ll N, L, Q;\n    cin >> N >> L >> Q;\n    \n    vector<string>\
    \ S(N);\n    rep(i, N) cin >> S[i];\n    \n    vector<RollingHashonSegmentTree>\
    \ R(N);\n    rep(i, N) {\n        R[i].init(S[i]);\n    }\n\n    while (Q--) {\n\
    \        ll q;\n        cin >> q;\n\n        if (q == 1) {\n            ll k;\n\
    \            char c, d;\n            cin >> k >> c >> d;\n            --k;\n\n\
    \            rep(i, N) {\n                if (S[i][k] != c) continue;\n      \
  ...
  requiredBy: []
  timestamp: '2025-04-29 23:14:07+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/string/rolling-hash-on-segment-tree/yukicoder-2761.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash-on-segment-tree/yukicoder-2761.test.cpp
- /verify/test/string/rolling-hash-on-segment-tree/yukicoder-2761.test.cpp.html

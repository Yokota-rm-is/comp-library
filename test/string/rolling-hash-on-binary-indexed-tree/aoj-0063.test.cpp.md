...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0063
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0063
  bundledCode: "#line 1 \"test/string/rolling-hash-on-binary-indexed-tree/aoj-0063.test.cpp\"\
    ...
    #line 4 \"test/string/rolling-hash-on-binary-indexed-tree/aoj-0063.test.cpp\"\n\
    \nint main() {\n    string S;\n\n    ll ans = 0;\n    while (cin >> S) {\n   \
    \     ll N = S.size();\n        RollingHashonBinaryIndexedTree bit(S);\n\n   \
    \     if (bit.get(0, N).is_palindrome()) ans++;\n    }\n\n    cout << ans << endl;\n\
    \n    return 0;\n} \n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0063\"\
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash-on-binary-indexed-tree/aoj-0063.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash-on-binary-indexed-tree/aoj-0063.test.cpp
- /verify/test/string/rolling-hash-on-binary-indexed-tree/aoj-0063.test.cpp.html

...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2234
    links:
    - https://yukicoder.me/problems/no/2234
  bundledCode: "#line 1 \"test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2234.test.cpp\"\
    ...
    #line 4 \"test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2234.test.cpp\"\
    \n\nint main() {\n    string S;\n    cin >> S;\n\n    ll N = S.size();\n    RollingHashonBinaryIndexedTree\
    \ rh(S);\n\n    ll idx = N - 1;\n\n    rep(i, N) {\n        auto hash = rh.get(i,\
    \ N);\n        if (hash.is_palindrome()) {\n            idx = i;\n           \
    \ break;\n        }\n    }\n\n    string ans = S;\n    repd(i, idx) ans += S[i];\n\
    \n    cout << ans << endl;\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/2234\"\n\n#include \"\
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2234.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2234.test.cpp
- /verify/test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2234.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash-on-binary-indexed-tree/aoj-alds1-14-b.test.cpp\"\
    ...
    #line 4 \"test/string/rolling-hash-on-binary-indexed-tree/aoj-alds1-14-b.test.cpp\"\
    \n\nint main() {\n    string T, P;\n    cin >> T >> P;\n\n    RollingHashonBinaryIndexedTree\
    \ rht(T), rhp(P);\n    rep(i, T.size() - P.size() + 1) {\n        if (rht.get(i,\
    \ i + P.size()) == rhp.get(0, P.size())) {\n            cout << i << endl;\n \
    \       }\n    }\n\n    return 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash-on-binary-indexed-tree/aoj-alds1-14-b.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash-on-binary-indexed-tree/aoj-alds1-14-b.test.cpp
- /verify/test/string/rolling-hash-on-binary-indexed-tree/aoj-alds1-14-b.test.cpp.html

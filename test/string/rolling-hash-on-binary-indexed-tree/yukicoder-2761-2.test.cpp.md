...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2761-2.test.cpp\"\
    ...
    #line 4 \"test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2761-2.test.cpp\"\
    \n\nint main() {\n    ll N, L, Q;\n    cin >> N >> L >> Q;\n    \n    vector<string>\
    \ S(N);\n    rep(i, N) cin >> S[i];\n    \n    vector<RollingHashonBinaryIndexedTree>\
    ...
    \       }\n        else {\n            string t;\n            cin >> t;\n\n  \
    \          Hash61 hs(t);\n            ll ans = 0;\n\n            rep(i, N) {\n\
    \                if (bit[i].get(0, t.size()).hash_rev == hs.hash_rev) ++ans;\n\
    \            }\n\n            cout << ans << endl;\n        }\n    }\n    \n \
    \   return 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2761-2.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2761-2.test.cpp
- /verify/test/string/rolling-hash-on-binary-indexed-tree/yukicoder-2761-2.test.cpp.html

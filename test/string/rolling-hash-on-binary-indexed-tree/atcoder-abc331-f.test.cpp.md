...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash-on-binary-indexed-tree/atcoder-abc331-f.test.cpp\"\
    ...
    #line 6 \"test/string/rolling-hash-on-binary-indexed-tree/atcoder-abc331-f.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    string S;\n    cin >>\
    ...
    \ >> c;\n\n            bit.set(x, c);\n        }\n        else {\n           \
    \ ll L, R;\n            cin >> L >> R;\n            --L;\n\n            cout <<\
    \ YesNo(bit.get(L, R).is_palindrome()) << endl;\n        }\n    }\n\n    return\
    \ 0;\n} \n"
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/abc331/tasks/abc331_f\"\
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash-on-binary-indexed-tree/atcoder-abc331-f.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash-on-binary-indexed-tree/atcoder-abc331-f.test.cpp
- /verify/test/string/rolling-hash-on-binary-indexed-tree/atcoder-abc331-f.test.cpp.html

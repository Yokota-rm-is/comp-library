...
data:
  ...
  bundledCode: "#line 1 \"test/string/suffix-array/aoj-alds1-14-d.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_14_D\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ {\n        rep(i, lcp.size()) {\n            os << i << \": \" << lcp[i] <<\
    \ endl;\n        }\n        return os;\n    }\n};\n#line 4 \"test/string/suffix-array/aoj-alds1-14-d.test.cpp\"\
    \n\n\nint main() {\n    string S;\n    cin >> S;\n    ll Q;\n    cin >> Q;\n\n\
    \    SuffixArray sa(S);\n    while (Q--) {\n        string T;\n        cin >>\
  ...
  verifiedWith: []
documentation_of: test/string/suffix-array/aoj-alds1-14-d.test.cpp
layout: document
redirect_from:
- /verify/test/string/suffix-array/aoj-alds1-14-d.test.cpp
- /verify/test/string/suffix-array/aoj-alds1-14-d.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/string/aho-corasick/yukicoder-430.test.cpp\"\n#define\
    \ PROBLEM \"https://yukicoder.me/problems/no/430\"\n\n#line 2 \"base.cpp\"\n\n\
    ...
    \ add(const string &str, int id) { add(str, 0, 0, id); }\n\n  void add(const string\
    \ &str) { add(str, nodes[0].exist); }\n\n  void query(const string &str, const\
    \ function<void(int)> &f, int str_index,\n             int node_index) {\n   \
    ...
    \    return result;\n  }\n\n  pair<int64_t, int> move(const char &c, int now =\
    \ 0) {\n    now = this->nodes[now].nxt[c - margin];\n    return {correct[now],\
    \ now};\n  }\n\n  pair<int64_t, int> move(const string &str, int now = 0) {\n\
    \    int64_t sum = 0;\n    for (auto &c : str) {\n      auto nxt = move(c, now);\n\
    \      sum += nxt.first;\n      now = nxt.second;\n    }\n    return {sum, now};\n\
    \  }\n};\n#line 4 \"test/string/aho-corasick/yukicoder-430.test.cpp\"\n\nint main()\
    \ {\n    string S;\n    cin >> S;\n\n    ll M;\n    cin >> M;\n    \n    vector<string>\
  ...
  requiredBy: []
  timestamp: '2025-11-16 21:57:01+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/string/aho-corasick/yukicoder-430.test.cpp
layout: document
redirect_from:
- /verify/test/string/aho-corasick/yukicoder-430.test.cpp
- /verify/test/string/aho-corasick/yukicoder-430.test.cpp.html

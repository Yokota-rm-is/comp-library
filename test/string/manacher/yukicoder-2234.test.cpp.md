...
data:
  ...
  bundledCode: "#line 1 \"test/string/manacher/yukicoder-2234.test.cpp\"\n#define\
    \ PROBLEM \"https://yukicoder.me/problems/no/2234\"\n\n#line 2 \"base.cpp\"\n\n\
    ...
    \ >= (r - l + 1) / 2;\n    }\n};\n#line 4 \"test/string/manacher/yukicoder-2234.test.cpp\"\
    \n\nint main() {\n    string S;\n    cin >> S;\n\n    ll N = S.size();\n    Manacher<>\
    \ manacher(S);\n\n    ll idx = N - 1;\n\n    rep(i, N) {\n        if (manacher.is_palindrome(i,\
    \ N)) {\n            idx = i;\n            break;\n        }\n    }\n\n    string\
    \ ans = S;\n    repd(i, idx) ans += S[i];\n\n    cout << ans << endl;\n\n    return\
    \ 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/string/manacher/yukicoder-2234.test.cpp
layout: document
redirect_from:
- /verify/test/string/manacher/yukicoder-2234.test.cpp
- /verify/test/string/manacher/yukicoder-2234.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/string/string-table/atcoder-abc381-e.test.cpp\"\n#define\
    ...
    };\n#line 5 \"test/string/string-table/atcoder-abc381-e.test.cpp\"\n\nint main()\
    \ {\n    ll N, Q;\n    cin >> N >> Q;\n\n    string S;\n    cin >> S;\n\n    vll\
    \ slashes(N, 0);\n    rep(i, N) {\n        if (S[i] == '/') slashes[i] = 1;\n\
    \    }\n\n    vll A(N);\n    rep(i, N) {\n        if (S[i] == '1') A[i] = 1;\n\
    \        else if (S[i] == '2') A[i] = 2;\n        else A[i] = 0;\n    }\n\n  \
    ...
    \ binary_search = [&](ll ok, ll ng, ll eps) {\n            if (!is_ok(ok)) return\
  ...
  verifiedWith: []
documentation_of: test/string/string-table/atcoder-abc381-e.test.cpp
layout: document
redirect_from:
- /verify/test/string/string-table/atcoder-abc381-e.test.cpp
- /verify/test/string/string-table/atcoder-abc381-e.test.cpp.html

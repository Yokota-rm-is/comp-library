...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc346/tasks/abc346_f
    links:
    - https://atcoder.jp/contests/abc346/tasks/abc346_f
  bundledCode: "#line 1 \"test/string/string-table/atcoder-abc346-f-2.test.cpp\"\n\
    ...
    \    return result;\n}\n#line 3 \"string/string-table.cpp\"\n\ntemplate <int char_size\
    \ = 128, int base = 0>\nstruct StringTable {\n    string S;\n    vector<vector<long\
    \ long>> indices, counts;\n\n    StringTable() : indices(char_size), counts(char_size,\
    \ vector<long long>(1, 0)) {}\n\n    StringTable(const vector<char>& s) : indices(char_size),\
    \ counts(char_size, vector<long long>(1, 0)) {\n        init(s);\n    }\n\n  \
    \  StringTable(const string& s) : indices(char_size), counts(char_size, vector<long\
    ...
    \n            rep(j, char_size) {\n                counts[j].emplace_back(counts[j].back()\
    \ + (S[i] == (j + base)));\n            }\n        }\n    }\n\n    void push_back(char\
    ...
    \ counts[c - base][r] - counts[c - base][l];\n    }\n\n    // \u533A\u9593[l,\
    \ N)\u3067\u6700\u521D\u306B\u6587\u5B57c\u304C\u73FE\u308C\u308B\u30A4\u30F3\u30C7\
    \u30C3\u30AF\u30B9\u3092\u8FD4\u3059\n    // \u5B58\u5728\u3057\u306A\u3044\u5834\
    ...
    \u3044\u3053\u3068\u3092\u8003\u616E */\n    rep(i, 64) {\n        double mid\
    \ = (ok + ng) / 2;\n\n        if (is_ok(mid)) ok = mid;\n        else ng = mid;\n\
    \    }\n    return ok;\n}\n#line 5 \"test/string/string-table/atcoder-abc346-f-2.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    string S;\n    cin >> S;\n\n\
    \    string T;\n    cin >> T;\n\n    StringTable<26, 'a'> st(S);\n\n    auto is_ok\
    \ = [&](ll x) {\n        ll idx = 0;\n        ll M = 0;\n\n        if (x == 0)\
    \ return true;\n\n        fore(t, T) {\n            ll y = x;\n            ll\
    \ cnt1 = st.count(t, idx, S.size());\n            if (y > cnt1) {\n          \
    \      idx = 0;\n                ++M;\n                y -= cnt1;\n          \
    \  }\n\n            ll cnt2 = st.count(t, 0, S.size());\n            if (cnt2\
    \ == 0) return false;\n\n            if (y > cnt2) {\n                M += ceil(y,\
    \ cnt2) - 1;\n                y -= cnt2 * (ceil(y, cnt2) - 1);\n            }\n\
    \n            if (y > 0) {\n                idx = st.index(t, y, idx, S.size())\
    \ + 1;\n            }\n        }\n\n        return M < N;\n    };\n\n    ll ans\
    \ = binary_search<ll>(is_ok, 0, S.size() * N / T.size() + 1);\n\n    // cout <<\
    \ fixed << setprecision(10);  // \u5C0F\u6570\u70B9\u4EE5\u4E0B\u309210\u6841\u8868\
    \u793A\uFF0C\u8A31\u5BB9\u8AA4\u5DEE\u304C1e-N\u4EE5\u4E0B\u306E\u6642\u306FN+1\u306B\
    \u5909\u66F4\u3059\u308B\u3053\u3068(16\u6841\u4EE5\u4E0A\u306Flong double)\n\
    \    cout << ans << endl;\n    // cout << YesNo(ans) << endl;\n    // rep(i, N)\
    \ cout << (ans[i] < inf64 ? ans[i] : -1) << endl;\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc346/tasks/abc346_f\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/string/string-table/atcoder-abc346-f-2.test.cpp
layout: document
redirect_from:
- /verify/test/string/string-table/atcoder-abc346-f-2.test.cpp
- /verify/test/string/string-table/atcoder-abc346-f-2.test.cpp.html

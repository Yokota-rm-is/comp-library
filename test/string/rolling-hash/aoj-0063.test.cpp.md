...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash/aoj-0063.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0063\"\n\n#line\
    ...
    \    }\n};\n#line 4 \"test/string/rolling-hash/aoj-0063.test.cpp\"\n\nint main()\
    \ {\n    string S;\n\n    ll ans = 0;\n    while (cin >> S) {\n        ll N =\
    \ S.size();\n        RollingHash rh(S);\n\n        if (rh.is_palindrome(0, N))\
    \ ans++;\n    }\n\n    cout << ans << endl;\n\n    return 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash/aoj-0063.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash/aoj-0063.test.cpp
- /verify/test/string/rolling-hash/aoj-0063.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash/atcoder-abc284-f.test.cpp\"\n#define\
    ...
    \    }\n};\n#line 6 \"test/string/rolling-hash/atcoder-abc284-f.test.cpp\"\n\n\
    int main() {\n    ll N;\n    cin >> N;\n\n    string T;\n    cin >> T;\n\n   \
    \ RollingHash rh(T);\n    rep(i, N + 1) {\n        Hash61 S = rh.erase(i, i +\
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash/atcoder-abc284-f.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash/atcoder-abc284-f.test.cpp
- /verify/test/string/rolling-hash/atcoder-abc284-f.test.cpp.html

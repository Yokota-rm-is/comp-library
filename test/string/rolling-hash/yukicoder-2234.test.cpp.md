...
data:
  ...
  bundledCode: "#line 1 \"test/string/rolling-hash/yukicoder-2234.test.cpp\"\n#define\
    \ PROBLEM \"https://yukicoder.me/problems/no/2234\"\n\n#line 2 \"base.cpp\"\n\n\
    ...
    \    }\n};\n#line 4 \"test/string/rolling-hash/yukicoder-2234.test.cpp\"\n\nint\
    \ main() {\n    string S;\n    cin >> S;\n\n    ll N = S.size();\n    RollingHash\
    \ rh(S);\n\n    ll idx = N - 1;\n\n    rep(i, N) {\n        auto hash = rh.get(i,\
  ...
  verifiedWith: []
documentation_of: test/string/rolling-hash/yukicoder-2234.test.cpp
layout: document
redirect_from:
- /verify/test/string/rolling-hash/yukicoder-2234.test.cpp
- /verify/test/string/rolling-hash/yukicoder-2234.test.cpp.html

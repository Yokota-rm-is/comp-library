...
data:
  ...
  bundledCode: "#line 1 \"test/string/trie/atcoder-abc377-g.test.cpp\"\n#define IGNORE\n\
    ...
    \    }\n\n    // Trie\u6728\u306E\u30CE\u30FC\u30C9\u6570\n    long long size()\
    \ const {\n        return A.size();\n    }\n};\n#line 6 \"test/string/trie/atcoder-abc377-g.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vector<string> S(N);\n    rep(i,\
    \ N) cin >> S[i];\n\n    Trie trie(inf64);\n\n    auto f = [&](auto node, const\
    \ string& word) {\n        chmin(node->data, (ll)word.size());\n    };\n\n   \
    \ rep(i, N) {\n        ll ans = S[i].size();\n        auto pn = trie.search(S[i]);\n\
    \n        while (true) {\n            chmin(ans, ll(pn->data + S[i].size() - 2\
  ...
  verifiedWith: []
documentation_of: test/string/trie/atcoder-abc377-g.test.cpp
layout: document
redirect_from:
- /verify/test/string/trie/atcoder-abc377-g.test.cpp
- /verify/test/string/trie/atcoder-abc377-g.test.cpp.html

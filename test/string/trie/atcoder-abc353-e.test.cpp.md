...
data:
  ...
  bundledCode: "#line 1 \"test/string/trie/atcoder-abc353-e.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc353/tasks/abc353_e\"\n\n#line 2 \"base.cpp\"\
    ...
    \    }\n\n    // Trie\u6728\u306E\u30CE\u30FC\u30C9\u6570\n    long long size()\
    \ const {\n        return A.size();\n    }\n};\n#line 4 \"test/string/trie/atcoder-abc353-e.test.cpp\"\
    \n\n\nint main() {\n    ll N;\n    cin >> N;\n\n    vector<string> S(N);\n   \
    \ rep(i, N) cin >> S[i];\n\n    Trie trie;\n    rep(i, N) {\n        trie.insert(S[i]);\n\
    \    }\n\n    ll ans = 0;\n    rep(i, N) {\n        ll used = 1;\n\n        auto\
    \ pn = trie.search(S[i]);\n\n        while (pn != trie.root) {\n            ans\
    \ += pn->depth * (pn->common - used);\n            used = pn->common;\n      \
    \      pn = pn->p;\n        }\n    }\n\n    cout << ans / 2 << endl;\n\n    return\
    \ 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/string/trie/atcoder-abc353-e.test.cpp
layout: document
redirect_from:
- /verify/test/string/trie/atcoder-abc353-e.test.cpp
- /verify/test/string/trie/atcoder-abc353-e.test.cpp.html

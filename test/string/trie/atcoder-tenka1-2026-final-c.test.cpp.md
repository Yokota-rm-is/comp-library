...
data:
  ...
  bundledCode: "#line 1 \"test/string/trie/atcoder-tenka1-2026-final-c.test.cpp\"\n\
    ...
    \    }\n\n    // Trie\u6728\u306E\u30CE\u30FC\u30C9\u6570\n    long long size()\
    \ const {\n        return A.size();\n    }\n};\n#line 6 \"test/string/trie/atcoder-tenka1-2026-final-c.test.cpp\"\
    \n\nint main() {\n    string S;\n    cin >> S;\n\n    ll M;\n    cin >> M;\n\n\
    \    vector<string> P(M);\n    rep(i, M) cin >> P[i];\n\n    vll W(M);\n    rep(i,\
    \ M) cin >> W[i];\n\n\n    Trie<ll> trie(0);\n    rep(i, M) {\n        auto pn\
    \ = trie.insert(P[i]);\n        chmax(pn->data, W[i]);\n    }\n\n    vll dp(S.size()\
  ...
  verifiedWith: []
documentation_of: test/string/trie/atcoder-tenka1-2026-final-c.test.cpp
layout: document
redirect_from:
- /verify/test/string/trie/atcoder-tenka1-2026-final-c.test.cpp
- /verify/test/string/trie/atcoder-tenka1-2026-final-c.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/string/trie/atcoder-utpc2014-e.test.cpp\"\n#define\
    ...
    \    }\n\n    // Trie\u6728\u306E\u30CE\u30FC\u30C9\u6570\n    long long size()\
    \ const {\n        return A.size();\n    }\n};\n#line 6 \"test/string/trie/atcoder-utpc2014-e.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vector<string> A(N);\n    vll\
    \ B(N);\n    rep(i, N) cin >> A[i] >> B[i];\n\n    Trie<pll> trie({0, 0});\n\n\
  ...
  verifiedWith: []
documentation_of: test/string/trie/atcoder-utpc2014-e.test.cpp
layout: document
redirect_from:
- /verify/test/string/trie/atcoder-utpc2014-e.test.cpp
- /verify/test/string/trie/atcoder-utpc2014-e.test.cpp.html

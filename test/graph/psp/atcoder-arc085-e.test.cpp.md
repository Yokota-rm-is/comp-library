...
data:
  ...
  bundledCode: "#line 1 \"test/graph/psp/atcoder-arc085-e.test.cpp\"\n#define IGNORE\n\
  ...
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/arc085/tasks/arc085_c\"\
    ...
    \ >> a[i];\n\n    // false: \u5272\u3089\u306A\u3044\n    // true: \u5272\u308B\
    \n    PSP<ll> flow(N);\n\n    rep(i, N) {\n        flow.set_gain_if_false(i, a[i]);\n\
    \n        for (ll j = 2 * i + 1; j < N; j += i + 1) {\n            flow.set_inf_cost_if_true_false(i,\
    \ j);\n        }\n    }\n\n    ll ans = -flow.solve();\n    cout << ans << endl;\n\
    \n    return 0;\n}"
  dependsOn:
  - graph/psp.cpp
  ...
  verifiedWith: []
documentation_of: test/graph/psp/atcoder-arc085-e.test.cpp
layout: document
redirect_from:
- /verify/test/graph/psp/atcoder-arc085-e.test.cpp
- /verify/test/graph/psp/atcoder-arc085-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/graph/bfs-bipartite/atcoder-abc396-e.test.cpp\"\n#define\
    ...
    \ != -1) {\n                        if (colors[next].first != colors[i].first\
    \ + next_color) return is_bipartite = false;\n                        continue;\n\
    \                    }\n\n                    colors[next] = {colors[i].first\
    \ + next_color, colors[i].second};\n                    cc.back()[next_color].push_back(next);\n\
    \n                    que.push(next);\n                }\n            }\n    \
    \    }\n\n        return is_bipartite = true;\n    }\n};\n#line 6 \"test/graph/bfs-bipartite/atcoder-abc396-e.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vll X(M), Y(M), Z(M);\n\
  ...
  requiredBy: []
  timestamp: '2025-03-23 19:54:50+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/graph/bfs-bipartite/atcoder-abc396-e.test.cpp
layout: document
redirect_from:
- /verify/test/graph/bfs-bipartite/atcoder-abc396-e.test.cpp
- /verify/test/graph/bfs-bipartite/atcoder-abc396-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/graph/dfs-bipartite/atcoder-abc327-d.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc327/tasks/abc327_d\"\n\n#line 2 \"\
    ...
    \n                    st.push(next);\n                }\n            }\n     \
    \   }\n\n        return is_bipartite = true;\n    }\n};\n#line 4 \"test/graph/dfs-bipartite/atcoder-abc327-d.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vector<ll> A(M), B(M);\n\
    \    rep(i, M) {\n        ll a;\n        cin >> a;\n        --a;\n        A[i]\
    \ = a;\n    }\n    rep(i, M) {\n        ll b;\n        cin >> b;\n        --b;\n\
    \        B[i] = b;\n    }\n\n    DFS dfs(N, false);\n    rep(i, M) {\n       \
  ...
  verifiedWith: []
documentation_of: test/graph/dfs-bipartite/atcoder-abc327-d.test.cpp
layout: document
redirect_from:
- /verify/test/graph/dfs-bipartite/atcoder-abc327-d.test.cpp
- /verify/test/graph/dfs-bipartite/atcoder-abc327-d.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/graph/dfs-bipartite/atcoder-abc396-e.test.cpp\"\n#define\
    ...
    \    return result;\n}\n#line 3 \"graph/dfs-bipartite.cpp\"\n\nstruct DFS {\n\
    \    struct Edge {\n        long long from;\n        long long to;\n        bool\
    ...
    \     init();\n    };\n    \n    void init() {\n        colors.assign(V, -1);\n\
    \    }\n    \n    void connect(long long from, long long to, bool different_color\
    ...
    \        ll now = st.top();\n                st.pop();\n\n                ll color\
    \ = colors[now] % 2;\n\n                fore(edge, G[now]) {\n               \
    \     long long next = edge.to;\n                    long long next_color = color\
    \ ^ edge.different;\n\n                    if (colors[next] != -1) {\n       \
    \                 if (colors[next] != colors[i] + next_color) return is_bipartite\
    \ = false;\n                        continue;\n                    }\n\n     \
    \               colors[next] = colors[i] + next_color;\n                    cc.back()[next_color].push_back(next);\n\
    \n                    st.push(next);\n                }\n            }\n     \
    \   }\n\n        return is_bipartite = true;\n    }\n};\n#line 6 \"test/graph/dfs-bipartite/atcoder-abc396-e.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vll X(M), Y(M), Z(M);\n\
  ...
  verifiedWith: []
documentation_of: test/graph/dfs-bipartite/atcoder-abc396-e.test.cpp
layout: document
redirect_from:
- /verify/test/graph/dfs-bipartite/atcoder-abc396-e.test.cpp
- /verify/test/graph/dfs-bipartite/atcoder-abc396-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/graph/bfs01/atcoder-abc176-d.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc176/tasks/abc176_d\"\n\n#line 2 \"base.cpp\"\
    ...
    \ p.end());\n\n        return p;\n    }\n};\n#line 4 \"test/graph/bfs01/atcoder-abc176-d.test.cpp\"\
    \n\nstruct ABC176D : BFS01 {\n    using BFS01::BFS01;\n    ll H, W;\n\n    ABC176D(ll\
    \ h, ll w) : BFS01(h * w, false), H(h), W(w) {}\n\n    void connect(ll h1, ll\
    \ w1, ll h2, ll w2, ll weight) {\n        BFS01::connect(h1 * W + w1, h2 * W +\
    ...
    \ = bfs.cost[dh * W + dw];\n    if (ans == inf64) ans = -1;\n\n    cout << ans\
    \ << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc176/tasks/abc176_d\"\n\n\
    ...
    \ --ch, --cw, --dh, --dw;\n\n    vector<string> grid(H);\n    rep(i, H) cin >>\
    \ grid[i];\n\n    ABC176D bfs(H, W);\n\n    rep(i, H) rep(j, W) {\n        if\
    \ (grid[i][j] == '#') continue;\n\n        vector<pll> dirs = {{0, 1}, {0, -1},\
    \ {1, 0}, {-1, 0}};\n\n        fore(d, dirs) {\n            auto [dx, dy] = d;\n\
    \n            ll ni = i + dx;\n            ll nj = j + dy;\n\n            if (ni\
    \ < 0 or ni >= H or nj < 0 or nj >= W) continue;\n            if (grid[ni][nj]\
    \ == '#') continue;\n\n            bfs.connect(i, j, ni, nj, 0);\n        }\n\n\
    \        rep(dx, -2, 3) {\n            rep(dy, -2, 3) {\n                if (dx\
    \ == 0 and dy == 0) continue;\n\n                ll ni = i + dx;\n           \
    \     ll nj = j + dy;\n\n                if (ni < 0 or ni >= H or nj < 0 or nj\
  ...
  requiredBy: []
  timestamp: '2025-03-23 18:08:53+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/graph/bfs01/atcoder-abc176-d.test.cpp
layout: document
redirect_from:
- /verify/test/graph/bfs01/atcoder-abc176-d.test.cpp
- /verify/test/graph/bfs01/atcoder-abc176-d.test.cpp.html

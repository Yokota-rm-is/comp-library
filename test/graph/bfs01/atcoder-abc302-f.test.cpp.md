...
data:
  ...
  bundledCode: "#line 1 \"test/graph/bfs01/atcoder-abc302-f.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc302/tasks/abc302_f\"\n\n#line 2 \"base.cpp\"\
    ...
    };\n#line 4 \"test/graph/bfs01/atcoder-abc302-f.test.cpp\"\n\nint main() {\n \
    \   ll N, M;\n    cin >> N >> M;\n\n    vll A(N);\n    vvll S(N);\n\n    rep(i,\
    \ N) {\n        cin >> A[i];\n        S[i].resize(A[i]);\n        rep(j, A[i])\
    \ cin >> S[i][j];\n        --S[i];\n    }\n\n    vvll B(M);\n    rep(i, N) fore(s,\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc302/tasks/abc302_f\"\n\n\
  ...
  requiredBy: []
  timestamp: '2024-09-28 16:25:57+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/graph/bfs01/atcoder-abc302-f.test.cpp
layout: document
redirect_from:
- /verify/test/graph/bfs01/atcoder-abc302-f.test.cpp
- /verify/test/graph/bfs01/atcoder-abc302-f.test.cpp.html

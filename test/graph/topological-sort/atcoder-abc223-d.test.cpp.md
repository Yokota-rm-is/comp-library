...
data:
  ...
  bundledCode: "#line 1 \"test/graph/topological-sort/atcoder-abc223-d.test.cpp\"\n\
...
layout: document
redirect_from:
- /verify/test/graph/topological-sort/atcoder-abc223-d.test.cpp
- /verify/test/graph/topological-sort/atcoder-abc223-d.test.cpp.html

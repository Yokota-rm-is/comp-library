...
data:
  ...
  bundledCode: "#line 1 \"test/graph/tsp-cycle/aoj-dpl-2-a.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_2_A\"\n\n#line\
    ...
    \    return get_path(goal, bit);\n    }\n};\n#line 4 \"test/graph/tsp-cycle/aoj-dpl-2-a.test.cpp\"\
    \n\nint main() {\n    ll V, E;\n    cin >> V >> E;\n\n    TSP tsp(V, true);\n\
    \    rep(i, E) {\n        ll s, t, d;\n        cin >> s >> t >> d;\n\n       \
  ...
  verifiedWith: []
documentation_of: test/graph/tsp-cycle/aoj-dpl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/graph/tsp-cycle/aoj-dpl-2-a.test.cpp
- /verify/test/graph/tsp-cycle/aoj-dpl-2-a.test.cpp.html

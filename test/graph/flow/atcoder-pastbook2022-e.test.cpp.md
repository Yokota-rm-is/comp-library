...
data:
  ...
  bundledCode: "#line 1 \"test/graph/flow/atcoder-pastbook2022-e.test.cpp\"\n#define\
    ...
    \ * cost));\n        }\n\n        cur_flow += flow;\n        cur_cost += flow\
    \ * cost;\n        pre_cost = cost;\n    }\n};\n#line 6 \"test/graph/flow/atcoder-pastbook2022-e.test.cpp\"\
    \n\nint main() {\n    ll V, E;\n    cin >> V >> E;\n\n    MinCostFlow<ll, ll>\
    \ mcf(V);\n    rep(i, E) {\n        ll u, v, c;\n        cin >> u >> v >> c;\n\
    \        --u, --v;\n        mcf.connect(u, v, c);\n    }\n\n    cout << mcf.max_flow(0,\
    \ V - 1) << endl;\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/graph/flow/atcoder-pastbook2022-e.test.cpp
layout: document
redirect_from:
- /verify/test/graph/flow/atcoder-pastbook2022-e.test.cpp
- /verify/test/graph/flow/atcoder-pastbook2022-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/graph/flow/atcoder-abc239-g.test.cpp\"\n#define IGNORE\n\
    ...
    \ * cost));\n        }\n\n        cur_flow += flow;\n        cur_cost += flow\
    \ * cost;\n        pre_cost = cost;\n    }\n};\n#line 6 \"test/graph/flow/atcoder-abc239-g.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    MinCostFlow<ll, ll>\
    \ mcf(N * 2);\n    rep(i, M) {\n        ll a, b;\n        cin >> a >> b;\n   \
  ...
  verifiedWith: []
documentation_of: test/graph/flow/atcoder-abc239-g.test.cpp
layout: document
redirect_from:
- /verify/test/graph/flow/atcoder-abc239-g.test.cpp
- /verify/test/graph/flow/atcoder-abc239-g.test.cpp.html

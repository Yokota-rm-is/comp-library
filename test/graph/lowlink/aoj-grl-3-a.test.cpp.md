...
data:
  ...
  bundledCode: "#line 1 \"test/graph/lowlink/aoj-grl-3-a.test.cpp\"\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_3_A\"\n\n#line\
    ...
    \                }\n            }\n        }\n\n        return bcc.size();\n \
    \   }\n};\n#line 4 \"test/graph/lowlink/aoj-grl-3-a.test.cpp\"\n\nint main() {\n\
  ...
  verifiedWith: []
documentation_of: test/graph/lowlink/aoj-grl-3-a.test.cpp
layout: document
redirect_from:
- /verify/test/graph/lowlink/aoj-grl-3-a.test.cpp
- /verify/test/graph/lowlink/aoj-grl-3-a.test.cpp.html

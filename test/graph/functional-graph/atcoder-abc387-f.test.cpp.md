...
data:
  ...
  bundledCode: "#line 1 \"test/graph/functional-graph/atcoder-abc387-f.test.cpp\"\n\
    ...
    \    return result;\n}\n#line 3 \"graph/functional-graph.cpp\"\n\n// \u53C2\u8003\
    ...
    using mint007 = Fp<1000000007>;\n// using mint = mint998;\n#line 8 \"test/graph/functional-graph/atcoder-abc387-f.test.cpp\"\
    \n\nusing mint = mint998;\n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n\
...
layout: document
redirect_from:
- /verify/test/graph/functional-graph/atcoder-abc387-f.test.cpp
- /verify/test/graph/functional-graph/atcoder-abc387-f.test.cpp.html

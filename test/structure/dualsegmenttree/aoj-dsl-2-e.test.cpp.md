...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dualsegmenttree/aoj-dsl-2-e.test.cpp\"\n\
    ...
    \ 4 \"test/structure/dualsegmenttree/aoj-dsl-2-e.test.cpp\"\n\nint main() {\n\
...
layout: document
redirect_from:
- /verify/test/structure/dualsegmenttree/aoj-dsl-2-e.test.cpp
- /verify/test/structure/dualsegmenttree/aoj-dsl-2-e.test.cpp.html

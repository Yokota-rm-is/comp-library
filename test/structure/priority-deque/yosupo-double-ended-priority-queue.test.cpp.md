...
data:
  ...
  bundledCode: "#line 1 \"test/structure/priority-deque/yosupo-double-ended-priority-queue.test.cpp\"\
    ...
    \       }\n\n        int p;\n        while (root < k && heap[p=parent(k)] < heap[k])\
    \ { // max heap\n            swap(heap[p], heap[k]);\n            k = p;\n   \
    \     }\n        while (root < k && heap[k] < heap[p=parent(k)|1]) { // min heap\n\
    \            swap(heap[p], heap[k]);\n            k = p;\n        }\n        return\
    \ k;\n    }\n};\n#line 4 \"test/structure/priority-deque/yosupo-double-ended-priority-queue.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll S(N);\n    rep(i,\
  ...
  requiredBy: []
  timestamp: '2025-03-23 19:38:09+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/structure/priority-deque/yosupo-double-ended-priority-queue.test.cpp
layout: document
redirect_from:
- /verify/test/structure/priority-deque/yosupo-double-ended-priority-queue.test.cpp
- /verify/test/structure/priority-deque/yosupo-double-ended-priority-queue.test.cpp.html

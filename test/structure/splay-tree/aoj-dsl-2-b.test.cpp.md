...
data:
  ...
  bundledCode: "#line 1 \"test/structure/splay-tree/aoj-dsl-2-b.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_B&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ = SplayTreeByIdx<T, F, Set, Max>;\n#line 4 \"test/structure/splay-tree/aoj-dsl-2-b.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    RangeAddRangeSum<ll,\
    \ ll> tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n   \
    \     if (t == 0) {\n            ll x, y;\n            cin >> x >> y;\n      \
    \      tree.apply(x - 1, y);\n        }\n        else {\n            ll x, y;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/splay-tree/aoj-dsl-2-b.test.cpp
layout: document
redirect_from:
- /verify/test/structure/splay-tree/aoj-dsl-2-b.test.cpp
- /verify/test/structure/splay-tree/aoj-dsl-2-b.test.cpp.html

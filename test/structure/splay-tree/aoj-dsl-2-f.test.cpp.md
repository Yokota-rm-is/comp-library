...
data:
  ...
  bundledCode: "#line 1 \"test/structure/splay-tree/aoj-dsl-2-f.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_F&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ = SplayTreeByIdx<T, F, Set, Max>;\n#line 4 \"test/structure/splay-tree/aoj-dsl-2-f.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    RangeSetRangeMin<ll,\
    \ ll> tree(n, (1ll << 31) - 1);\n    while (q--) {\n        ll t;\n        cin\
    \ >> t;\n\n        if (t == 0) {\n            ll s, t, x;\n            cin >>\
    \ s >> t >> x;\n            tree.apply(s, t + 1, x);\n        }\n        else\
  ...
  verifiedWith: []
documentation_of: test/structure/splay-tree/aoj-dsl-2-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/splay-tree/aoj-dsl-2-f.test.cpp
- /verify/test/structure/splay-tree/aoj-dsl-2-f.test.cpp.html

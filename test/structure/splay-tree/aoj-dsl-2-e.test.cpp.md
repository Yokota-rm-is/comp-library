...
data:
  ...
  bundledCode: "#line 1 \"test/structure/splay-tree/aoj-dsl-2-e.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_E&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ = SplayTreeByIdx<T, F, Set, Max>;\n#line 4 \"test/structure/splay-tree/aoj-dsl-2-e.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    RangeAddRangeSum<ll,\
    \ ll> tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n   \
    \     if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n\
    \            tree.apply(s - 1, t, x);\n        }\n        else {\n           \
  ...
  verifiedWith: []
documentation_of: test/structure/splay-tree/aoj-dsl-2-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/splay-tree/aoj-dsl-2-e.test.cpp
- /verify/test/structure/splay-tree/aoj-dsl-2-e.test.cpp.html

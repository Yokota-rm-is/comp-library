...
data:
  ...
  bundledCode: "#line 1 \"test/structure/bit/aoj-dsl-2-e.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_E&\"\n\n#line\
    ...
    \ = true;\n        break;\n    }\n\n    return ret;\n}\n#line 4 \"test/structure/bit/aoj-dsl-2-e.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    BIT<ll> tree(n, 0);\n\
    \    while (q--) {\n        ll t;\n        cin >> t;\n\n        if (t == 0) {\n\
    \            ll s, t, x;\n            cin >> s >> t >> x;\n            tree.add(s\
    \ - 1, t, x);\n        }\n        else {\n            ll i;\n            cin >>\
...
layout: document
redirect_from:
- /verify/test/structure/bit/aoj-dsl-2-e.test.cpp
- /verify/test/structure/bit/aoj-dsl-2-e.test.cpp.html

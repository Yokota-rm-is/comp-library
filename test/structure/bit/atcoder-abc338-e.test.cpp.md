...
data:
  ...
  bundledCode: "#line 1 \"test/structure/bit/atcoder-abc338-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc338/tasks/abc338_e\"\n\n#line 2 \"\
    ...
    \        }\n    }\n};\n#line 4 \"test/structure/bit/atcoder-abc338-e.test.cpp\"\
    \n\nint main() {\n    long long N;\n    cin >> N;\n    vector<pll> A;\n    for(int\
    \ i = 0 ; i < N ; ++i){\n        ll a, b;\n        cin >> a >> b;\n        if\
...
layout: document
redirect_from:
- /verify/test/structure/bit/atcoder-abc338-e.test.cpp
- /verify/test/structure/bit/atcoder-abc338-e.test.cpp.html

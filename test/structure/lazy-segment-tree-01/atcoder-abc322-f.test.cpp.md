...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-01/atcoder-abc322-f.test.cpp\"\
    ...
    \ lazy_set[k]);\n        lazy_set[k] = -1;\n    }\n};\n#line 6 \"test/structure/lazy-segment-tree-01/atcoder-abc322-f.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    string S;\n    cin >>\
    \ S;\n\n    vector<bool> A(N);\n    rep(i, N) A[i] = (S[i] == '1');\n\n    LazySegmentTree01\
    \ tree(A);\n\n    while (Q--) {\n        ll c, L, R;\n        cin >> c >> L >>\
    \ R;\n        --L;\n\n        if (c == 1) {\n            tree.apply_flip(L, R);\n\
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-01/atcoder-abc322-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-01/atcoder-abc322-f.test.cpp
- /verify/test/structure/lazy-segment-tree-01/atcoder-abc322-f.test.cpp.html

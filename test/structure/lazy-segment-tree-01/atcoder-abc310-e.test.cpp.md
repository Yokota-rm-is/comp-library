...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-01/atcoder-abc310-e.test.cpp\"\
    ...
    \ lazy_set[k]);\n        lazy_set[k] = -1;\n    }\n};\n#line 6 \"test/structure/lazy-segment-tree-01/atcoder-abc310-e.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n    \n    string S;\n    cin >> S;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-01/atcoder-abc310-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-01/atcoder-abc310-e.test.cpp
- /verify/test/structure/lazy-segment-tree-01/atcoder-abc310-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/wavelet-matrix/atcoder-abc351-f.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/wavelet-matrix/atcoder-abc351-f.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    rep(i, N) cin\
    \ >> A[i];\n\n    ll maxA = *max_element(A) + 1;\n\n    WaveletMatrix<ll> wm(A);\n\
    \    ll ans = 0;\n    rep(i, N) {\n        ll a = A[i];\n        ll num = wm.count_in_range(i\
...
layout: document
redirect_from:
- /verify/test/structure/wavelet-matrix/atcoder-abc351-f.test.cpp
- /verify/test/structure/wavelet-matrix/atcoder-abc351-f.test.cpp.html

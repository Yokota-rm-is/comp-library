...
data:
  ...
  bundledCode: "#line 1 \"test/structure/wavelet-matrix/atcoder-abc381-e.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 5 \"test/structure/wavelet-matrix/atcoder-abc381-e.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    string S;\n    cin >>\
    \ S;\n\n    vll slashes(N, 0);\n    rep(i, N) {\n        if (S[i] == '/') slashes[i]\
    \ = 1;\n    }\n\n    vll A(N);\n    rep(i, N) {\n        if (S[i] == '1') A[i]\
    \ = 1;\n        else if (S[i] == '2') A[i] = 2;\n        else A[i] = 0;\n    }\n\
  ...
  verifiedWith: []
documentation_of: test/structure/wavelet-matrix/atcoder-abc381-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/wavelet-matrix/atcoder-abc381-e.test.cpp
- /verify/test/structure/wavelet-matrix/atcoder-abc381-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/wavelet-matrix/yosupo-static-rmq.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/wavelet-matrix/yosupo-static-rmq.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
  ...
  verifiedWith: []
documentation_of: test/structure/wavelet-matrix/yosupo-static-rmq.test.cpp
layout: document
redirect_from:
- /verify/test/structure/wavelet-matrix/yosupo-static-rmq.test.cpp
- /verify/test/structure/wavelet-matrix/yosupo-static-rmq.test.cpp.html

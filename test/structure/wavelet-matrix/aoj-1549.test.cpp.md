...
data:
  ...
  bundledCode: "#line 1 \"test/structure/wavelet-matrix/aoj-1549.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=1549\"\n\
    \n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/wavelet-matrix/aoj-1549.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll a(N);\n    rep(i, N) cin\
  ...
  verifiedWith: []
documentation_of: test/structure/wavelet-matrix/aoj-1549.test.cpp
layout: document
redirect_from:
- /verify/test/structure/wavelet-matrix/aoj-1549.test.cpp
- /verify/test/structure/wavelet-matrix/aoj-1549.test.cpp.html

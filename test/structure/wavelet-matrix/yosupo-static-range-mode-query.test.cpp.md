...
data:
  ...
  bundledCode: "#line 1 \"test/structure/wavelet-matrix/yosupo-static-range-mode-query.test.cpp\"\
    ...
    #line 6 \"test/structure/wavelet-matrix/yosupo-static-range-mode-query.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
    \ N) cin >> a[i];\n\n    Compressor<ll> comp(a);\n    vll b = comp.compressed;\n\
    \n    vll d;\n    rep(i, N) d.push_back(comp.retrieve(b[i]));\n    \n    WaveletMatrix<ll>\
    \ wm(b);\n\n    auto c = [](const tuple<ull, ull, ull, ull, ll> &left, const tuple<ull,\
    \ ull, ull, ull, ll> &right) {\n        // width\n        if (get<0>(left) !=\
    \ get<0>(right)) {\n            return get<0>(left) < get<0>(right);\n       \
    \ }\n        // depth\n        if (get<3>(left) != get<3>(right)) {\n        \
    \    return get<3>(left) > get<3>(right);\n        }\n        // left\n      \
  ...
  verifiedWith: []
documentation_of: test/structure/wavelet-matrix/yosupo-static-range-mode-query.test.cpp
layout: document
redirect_from:
- /verify/test/structure/wavelet-matrix/yosupo-static-range-mode-query.test.cpp
- /verify/test/structure/wavelet-matrix/yosupo-static-range-mode-query.test.cpp.html

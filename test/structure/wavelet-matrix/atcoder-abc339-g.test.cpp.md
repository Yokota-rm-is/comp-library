...
data:
  ...
  bundledCode: "#line 1 \"test/structure/wavelet-matrix/atcoder-abc339-g.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/wavelet-matrix/atcoder-abc339-g.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    rep(i, N) cin\
    \ >> A[i];\n\n    WaveletMatrix<ll> wm(A);\n\n    ll Q;\n    cin >> Q;\n\n   \
    \ ll B = 0;\n\n    while (Q--) {\n        ll alpha, beta, gamma;\n        cin\
    \ >> alpha >> beta >> gamma;\n\n        ll L = alpha ^ B;\n        ll R = beta\
    \ ^ B;\n        ll X = gamma ^ B;\n\n        --L;\n        \n        ll ans =\
    \ wm.sum_less_than(L, R, X) + wm.count(L, R, X) * X;\n        cout << ans << endl;\n\
    \        B = ans;\n    }\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc339/tasks/abc339_g\"\n\n\
    ...
    \     ll L = alpha ^ B;\n        ll R = beta ^ B;\n        ll X = gamma ^ B;\n\
    \n        --L;\n        \n        ll ans = wm.sum_less_than(L, R, X) + wm.count(L,\
    \ R, X) * X;\n        cout << ans << endl;\n        B = ans;\n    }\n\n    return\
    \ 0;\n} \n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/structure/wavelet-matrix/atcoder-abc339-g.test.cpp
layout: document
redirect_from:
- /verify/test/structure/wavelet-matrix/atcoder-abc339-g.test.cpp
- /verify/test/structure/wavelet-matrix/atcoder-abc339-g.test.cpp.html

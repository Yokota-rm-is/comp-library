...
data:
  ...
  bundledCode: "#line 1 \"test/structure/linear-set-lazy-segment-tree/atcoder-abc177-f.test.cpp\"\
    ...
    \ lazy[k]);\n\n        lazy[k] = mapping.id();\n    }\n};\n#line 4 \"test/structure/linear-set-lazy-segment-tree/atcoder-abc177-f.test.cpp\"\
    \n\nint main() {\n    ll H, W;\n    cin >> H >> W;\n\n    LazySegmentTree<ll,\
    \ ll> tree(W, 0);\n\n    rep(i, H) {\n        ll l, r;\n        cin >> l >> r;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/linear-set-lazy-segment-tree/atcoder-abc177-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/linear-set-lazy-segment-tree/atcoder-abc177-f.test.cpp
- /verify/test/structure/linear-set-lazy-segment-tree/atcoder-abc177-f.test.cpp.html

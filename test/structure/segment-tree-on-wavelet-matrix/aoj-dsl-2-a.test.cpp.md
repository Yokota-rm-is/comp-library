...
data:
  ...
  bundledCode: "#line 1 \"test/structure/segment-tree-on-wavelet-matrix/aoj-dsl-2-a.test.cpp\"\
    ...
    \ long w) {\n        return count(h, 0, w);\n    }\n};\n#line 4 \"test/structure/segment-tree-on-wavelet-matrix/aoj-dsl-2-a.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    SegmentTreeonWaveletMatrix<ll,\
    \ ll, Set, Min> wm;\n    vll A(n, (1ll << 31) - 1);\n\n    rep(i, n) wm.add_point(A[i],\
    \ i);\n\n    vll T(q), X(q), Y(q);\n\n    rep(i, q) {\n        cin >> T[i] >>\
    \ X[i] >> Y[i];\n\n        if (T[i] == 0) {\n            A[X[i]] = Y[i];\n   \
  ...
  verifiedWith: []
documentation_of: test/structure/segment-tree-on-wavelet-matrix/aoj-dsl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/segment-tree-on-wavelet-matrix/aoj-dsl-2-a.test.cpp
- /verify/test/structure/segment-tree-on-wavelet-matrix/aoj-dsl-2-a.test.cpp.html

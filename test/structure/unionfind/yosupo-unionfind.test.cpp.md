...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/yosupo-unionfind.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/unionfind\"\n\n#line 2 \"base.cpp\"\
    ...
    \    }\n};\n#line 4 \"test/structure/unionfind/yosupo-unionfind.test.cpp\"\n\n\
    int main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    UnionFind tree(N);\n   \
    \ while (Q--) {\n        ll t;\n        cin >> t;\n\n        if (t == 0) {\n \
    \           ll u, v;\n            cin >> u >> v;\n            tree.unite(u, v);\n\
    \        }\n        else {\n            ll u, v;\n            cin >> u >> v;\n\
...
layout: document
redirect_from:
- /verify/test/structure/unionfind/yosupo-unionfind.test.cpp
- /verify/test/structure/unionfind/yosupo-unionfind.test.cpp.html

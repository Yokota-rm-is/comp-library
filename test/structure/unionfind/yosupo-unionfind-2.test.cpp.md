...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/yosupo-unionfind-2.test.cpp\"\n\
    ...
    \    }\n};\n#line 4 \"test/structure/unionfind/yosupo-unionfind-2.test.cpp\"\n\
    \nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    UnionFind<false, false,\
    \ true> tree(N);\n    while (Q--) {\n        ll t;\n        cin >> t;\n\n    \
    \    if (t == 0) {\n            ll u, v;\n            cin >> u >> v;\n       \
    \     tree.unite(u, v);\n        }\n        else {\n            ll u, v;\n   \
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/unionfind\"\n\n#include\
    ...
    \ >> N >> Q;\n\n    UnionFind<false, false, true> tree(N);\n    while (Q--) {\n\
    \        ll t;\n        cin >> t;\n\n        if (t == 0) {\n            ll u,\
    \ v;\n            cin >> u >> v;\n            tree.unite(u, v);\n        }\n \
    \       else {\n            ll u, v;\n            cin >> u >> v;\n           \
    \ cout << tree.is_same(u, v) << endl;\n        }\n    }\n\n    return 0;\n}"
  ...
  verifiedWith: []
documentation_of: test/structure/unionfind/yosupo-unionfind-2.test.cpp
layout: document
redirect_from:
- /verify/test/structure/unionfind/yosupo-unionfind-2.test.cpp
- /verify/test/structure/unionfind/yosupo-unionfind-2.test.cpp.html

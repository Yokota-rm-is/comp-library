...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/atcoder-past10-h-3.test.cpp\"\n\
    ...
    \    }\n};\n#line 4 \"test/structure/unionfind/atcoder-past10-h-3.test.cpp\"\n\
    \nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    UnionFind<true, true,\
    \ false> tree(N);\n    \n    while (Q--) {\n        ll t;\n        cin >> t;\n\
    \n        if (t == 1) {\n            ll u, v;\n            cin >> u >> v;\n  \
    \          --u, --v;\n\n            tree.unite(u, v);\n        }\n        else\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/past202203-open/tasks/past202203_h\"\
    ...
    \    cin >> N >> Q;\n\n    UnionFind<true, true, false> tree(N);\n    \n    while\
    \ (Q--) {\n        ll t;\n        cin >> t;\n\n        if (t == 1) {\n       \
    \     ll u, v;\n            cin >> u >> v;\n            --u, --v;\n\n        \
    \    tree.unite(u, v);\n        }\n        else {\n            ll u;\n       \
    \     cin >> u;\n            --u;\n\n            auto members = tree.members(u);\n\
  ...
  verifiedWith: []
documentation_of: test/structure/unionfind/atcoder-past10-h-3.test.cpp
layout: document
redirect_from:
- /verify/test/structure/unionfind/atcoder-past10-h-3.test.cpp
- /verify/test/structure/unionfind/atcoder-past10-h-3.test.cpp.html

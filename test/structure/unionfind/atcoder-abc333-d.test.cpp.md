...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/atcoder-abc333-d.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc333/tasks/abc333_d\"\n\n#line 2 \"\
    ...
    \        }\n\n        return ret;\n    }\n};\n#line 4 \"test/structure/unionfind/atcoder-abc333-d.test.cpp\"\
    \n\nint main() {\n    long long N;\n    cin >> N;\n\n    vll A;\n\n    UnionFind\
    \ tree(N);\n    rep(i, N - 1) {\n        long long u, v;\n        cin >> u >>\
    \ v;\n        --u, --v;\n\n        if (u == 0) A.push_back(v);\n        else if\
    \ (v == 0) A.push_back(u);\n        else tree.unite(u, v);\n    }\n\n    ll ans\
    \ = 1;\n    if (A.size() > 1) {\n        vll sizes;\n        for (auto x : A)\
    \ sizes.push_back(tree.size(x));\n\n        sort(sizes.begin(), sizes.end());\n\
  ...
  verifiedWith: []
documentation_of: test/structure/unionfind/atcoder-abc333-d.test.cpp
layout: document
redirect_from:
- /verify/test/structure/unionfind/atcoder-abc333-d.test.cpp
- /verify/test/structure/unionfind/atcoder-abc333-d.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/atcoder-abc277-c-3.test.cpp\"\n\
    ...
    #line 5 \"test/structure/unionfind/atcoder-abc277-c-3.test.cpp\"\n\nint main()\
    \ {\n    long long N;\n    cin >> N;\n\n    vll A(N), B(N);\n    rep(i, N) cin\
    \ >> A[i] >> B[i];\n\n    vll X;\n    X.push_back(1);\n    rep(i, N) {\n     \
    \   X.emplace_back(A[i]);\n        X.emplace_back(B[i]);\n    }\n\n    Compressor<long\
  ...
  verifiedWith: []
documentation_of: test/structure/unionfind/atcoder-abc277-c-3.test.cpp
layout: document
redirect_from:
- /verify/test/structure/unionfind/atcoder-abc277-c-3.test.cpp
- /verify/test/structure/unionfind/atcoder-abc277-c-3.test.cpp.html

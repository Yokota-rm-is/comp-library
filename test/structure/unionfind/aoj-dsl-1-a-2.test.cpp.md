...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/aoj-dsl-1-a-2.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_1_A&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \    }\n};\n#line 4 \"test/structure/unionfind/aoj-dsl-1-a-2.test.cpp\"\n\nint\
    \ main() {\n    ll n, q;\n    cin >> n >> q;\n\n    UnionFind<false, false, true>\
    \ tree(n);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if\
    \ (t == 0) {\n            ll x, y;\n            cin >> x >> y;\n            tree.unite(x,\
    \ y);\n        }\n        else {\n            ll x, y;\n            cin >> x >>\
  ...
  verifiedWith: []
documentation_of: test/structure/unionfind/aoj-dsl-1-a-2.test.cpp
layout: document
redirect_from:
- /verify/test/structure/unionfind/aoj-dsl-1-a-2.test.cpp
- /verify/test/structure/unionfind/aoj-dsl-1-a-2.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/unionfind/atcoder-abc277-c.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc277/tasks/abc277_c\"\n\n#line 2 \"\
    ...
    #line 5 \"test/structure/unionfind/atcoder-abc277-c.test.cpp\"\n\nint main() {\n\
    \    long long N;\n    cin >> N;\n\n    vll A(N), B(N);\n    rep(i, N) cin >>\
    \ A[i] >> B[i];\n\n    vll X;\n    X.push_back(1);\n    rep(i, N) {\n        X.emplace_back(A[i]);\n\
  ...
  verifiedWith: []
documentation_of: test/structure/unionfind/atcoder-abc277-c.test.cpp
layout: document
redirect_from:
- /verify/test/structure/unionfind/atcoder-abc277-c.test.cpp
- /verify/test/structure/unionfind/atcoder-abc277-c.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/bit-on-wavelet-matrix/yosupo-rectangle-sum.test.cpp\"\
    ...
    \            }\n        }\n        return res;\n    }\n\n    // [l, r)\u306E\u7DCF\
    \u548C\u3092\u6C42\u3081\u308B\n    T sum(long long l, long long r) {\n      \
    \  return sum(l, r, inf64);\n    }\n};\n#line 4 \"test/structure/bit-on-wavelet-matrix/yosupo-rectangle-sum.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll x(N), y(N), w(N);\n\
  ...
  verifiedWith: []
documentation_of: test/structure/bit-on-wavelet-matrix/yosupo-rectangle-sum.test.cpp
layout: document
redirect_from:
- /verify/test/structure/bit-on-wavelet-matrix/yosupo-rectangle-sum.test.cpp
- /verify/test/structure/bit-on-wavelet-matrix/yosupo-rectangle-sum.test.cpp.html

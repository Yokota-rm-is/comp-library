...
data:
  ...
  bundledCode: "#line 1 \"test/structure/bit-on-wavelet-matrix/yosupo-point-add-rectangle-sum.test.cpp\"\
    ...
    \            }\n        }\n        return res;\n    }\n\n    // [l, r)\u306E\u7DCF\
    \u548C\u3092\u6C42\u3081\u308B\n    T sum(long long l, long long r) {\n      \
    \  return sum(l, r, inf64);\n    }\n};\n#line 4 \"test/structure/bit-on-wavelet-matrix/yosupo-point-add-rectangle-sum.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll X(N), Y(N), W(N);\n\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_rectangle_sum\"\
    ...
    \    }\n\n    wm.build();\n    rep(i, N) {\n        wm.add(X[i], Y[i], W[i]);\n\
    \    }\n\n    rep(i, Q) {\n        if (query[i][0] == 0) {\n            ll x =\
    \ query[i][1], y = query[i][2], w = query[i][3];\n            wm.add(x, y, w);\n\
    \        }\n        else {\n            ll l = query[i][1], d = query[i][2], r\
...
layout: document
redirect_from:
- /verify/test/structure/bit-on-wavelet-matrix/yosupo-point-add-rectangle-sum.test.cpp
- /verify/test/structure/bit-on-wavelet-matrix/yosupo-point-add-rectangle-sum.test.cpp.html

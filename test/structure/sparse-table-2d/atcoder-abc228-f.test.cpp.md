...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sparse-table-2d/atcoder-abc228-f.test.cpp\"\
    ...
    \        }\n\n        return os;\n    }\n};\n#line 3 \"structure/sparse-table-2d.cpp\"\
    \n\n// Sparse Table 2D\n// \u7D50\u5408\u6027\u3068\u51AA\u7B49\u6027\u3092\u6E80\
    \u305F\u3059\u5FC5\u8981\u304C\u3042\u308B\n// \u7D50\u5408\u5247 (A \u2295\u3000\
    B) \u2295 C = A \u2295 (B \u2295 C)\n// \u51AA\u7B49\u6027 (A \u2295 A = A)\n\
  ...
  requiredBy: []
  timestamp: '2025-11-16 21:59:33+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/structure/sparse-table-2d/atcoder-abc228-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sparse-table-2d/atcoder-abc228-f.test.cpp
- /verify/test/structure/sparse-table-2d/atcoder-abc228-f.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-i.test.cpp\"\
    ...
    \        lazy[k] = id();\n    }\n};\n#line 4 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-i.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = pll;\n   \
    \ auto op = [](S a, S b) { return S(a.first + b.first, a.second + b.second); };\n\
    \    auto e = []() { return S(0, 0); };\n    using F = ll;\n    auto mapping =\
    \ [](S a, F b) { return (b != inf64) ? S(b * a.second, a.second) : a; };\n   \
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_I&\"\
    ...
    \ {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = pll;\n    auto op = [](S\
    \ a, S b) { return S(a.first + b.first, a.second + b.second); };\n    auto e =\
    \ []() { return S(0, 0); };\n    using F = ll;\n    auto mapping = [](S a, F b)\
    \ { return (b != inf64) ? S(b * a.second, a.second) : a; };\n    auto composition\
    \ = [](F& a, F b) { if (b != inf64) a = b; };\n    auto id = []() { return inf64;\
    \ };\n    LazySegmentTree<S, op, e, F, mapping, composition, id> tree(n, S(0,\
    \ 1));\n\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if (t\
    \ == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n        \
    \    tree.apply(s, t + 1, x);\n        }\n        else {\n            ll s, t;\n\
    \            cin >> s >> t;\n            cout << tree.prod(s, t + 1).first <<\
    \ endl;\n        }\n    }\n\n    return 0;\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-abstract/aoj-dsl-2-i.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-i.test.cpp
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-i.test.cpp.html

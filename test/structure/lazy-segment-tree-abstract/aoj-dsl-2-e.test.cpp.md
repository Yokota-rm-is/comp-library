...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-e.test.cpp\"\
    ...
    \        lazy[k] = id();\n    }\n};\n#line 4 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-e.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    auto\
    \ op = [](S a, S b) { return a + b; };\n    auto e = []() { return 0; };\n   \
    \ using F = ll;\n    auto mapping = [](S a, F b) { return a + b; };\n    auto\
    \ composition = [](F& a, F b) { a += b; };\n    auto id = []() { return 0; };\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_E&\"\
    ...
    \ ll;\n    auto mapping = [](S a, F b) { return a + b; };\n    auto composition\
    \ = [](F& a, F b) { a += b; };\n    auto id = []() { return 0; };\n    LazySegmentTree<S,\
    \ op, e, F, mapping, composition, id> tree(n, 0);\n\n    while (q--) {\n     \
    \   ll t;\n        cin >> t;\n\n        if (t == 0) {\n            ll s, t, x;\n\
    \            cin >> s >> t >> x;\n            tree.apply(s - 1, t, x);\n     \
    \   }\n        else {\n            ll i;\n            cin >> i;\n            cout\
    \ << tree.get(i - 1) << endl;\n        }\n    }\n\n    return 0;\n}"
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-abstract/aoj-dsl-2-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-e.test.cpp
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-e.test.cpp.html

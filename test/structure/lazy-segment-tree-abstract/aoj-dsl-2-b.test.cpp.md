...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-b.test.cpp\"\
    ...
    \        lazy[k] = id();\n    }\n};\n#line 4 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-b.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    auto\
    \ op = [](S a, S b) { return a + b; };\n    auto e = []() { return 0; };\n   \
    \ using F = ll;\n    auto mapping = [](S a, F b) { return a + b; };\n    auto\
    \ composition = [](F& a, F b) { return a += b; };\n    auto id = []() { return\
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-abstract/aoj-dsl-2-b.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-b.test.cpp
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-b.test.cpp.html

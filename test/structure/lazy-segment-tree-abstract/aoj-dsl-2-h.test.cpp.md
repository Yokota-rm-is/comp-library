...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-h.test.cpp\"\
    ...
    \        lazy[k] = id();\n    }\n};\n#line 4 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-h.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    auto\
    \ op = [](S a, S b) { return min(a, b); };\n    auto e = []() { return inf64;\
    \ };\n    using F = ll;\n    auto mapping = [](S a, F b) { return a + b; };\n\
    \    auto composition = [](F& a, F b) { return a += b; };\n    auto id = []()\
    \ { return 0; };\n    LazySegmentTree<S, op, e, F, mapping, composition, id> tree(n,\
    \ 0);\n\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if (t\
    \ == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n        \
    \    tree.apply(s, t + 1, x);\n        }\n        else {\n            ll s, t;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-abstract/aoj-dsl-2-h.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-h.test.cpp
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-h.test.cpp.html

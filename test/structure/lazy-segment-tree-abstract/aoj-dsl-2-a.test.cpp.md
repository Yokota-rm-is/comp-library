...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-a.test.cpp\"\
    ...
    \        lazy[k] = id();\n    }\n};\n#line 4 \"test/structure/lazy-segment-tree-abstract/aoj-dsl-2-a.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    auto\
    \ op = [](S a, S b) { return min(a, b); };\n    auto e = []() { return inf64;\
    \ };\n    using F = ll;\n    auto mapping = [](S a, F b) { return (b != inf64)\
    \ ? b : a; };\n    auto composition = [](F& a, F b) { if (b != inf64) a = b; };\n\
    \    auto id = []() { return inf64; };\n    LazySegmentTree<S, op, e, F, mapping,\
    \ composition, id> tree(n, (1ll << 31) - 1);\n\n    while (q--) {\n        ll\
    \ t;\n        cin >> t;\n\n        if (t == 0) {\n            ll x, y;\n     \
    \       cin >> x >> y;\n            tree.apply(x, y);\n        }\n        else\
    \ {\n            ll x, y;\n            cin >> x >> y;\n            cout << tree.prod(x,\
    \ y + 1) << endl;\n        }\n    }\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-abstract/aoj-dsl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-a.test.cpp
- /verify/test/structure/lazy-segment-tree-abstract/aoj-dsl-2-a.test.cpp.html

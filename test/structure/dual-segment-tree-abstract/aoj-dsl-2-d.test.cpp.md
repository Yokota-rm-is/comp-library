...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dual-segment-tree-abstract/aoj-dsl-2-d.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"structure/dual-segment-tree-abstract.cpp\"\n\
    ...
    \ && r <= _N);\n\n        l += N;\n        r += N;\n\n        while (l < r) {\n\
    \            if (l & 1) composition(node[l++], f);\n            if (r & 1) composition(node[--r],\
    \ f);\n            l >>= 1;\n            r >>= 1;\n        }\n    }\n\n    S get(long\
    \ long p) {\n        assert(0 <= p and p < _N);\n\n        long long k = p + N;\n\
    \n        S ret = value[p];\n        repd(i, height) ret = mapping(ret, node[k\
    \ >> i]);\n        return ret;\n    }\n\n    S get(long long p, auto mapping_i)\
    \ {\n#if __cplusplus >= 201703L\n        static_assert(is_convertible_v<decltype(mapping_i),\
    \ function<S(S, F)>>, \"mapping must be function<S(S, F)>\");\n#endif\n\n    \
    \    assert(0 <= p and p < _N);\n\n        long long k = p + N;\n\n        S ret\
    ...
    \       }\n        os << endl;\n\n        os << \"value\" << endl;\n        rep(i,\
    \ seg._N) {\n            os << seg.get(i) << \" \";\n        }\n        os <<\
    \ endl;\n\n        return os;\n    }\n};\n#line 4 \"test/structure/dual-segment-tree-abstract/aoj-dsl-2-d.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = pll;\n   \
    \ using F = pll;\n    auto mapping = [](S x, F f) { return (x.first > f.first)\
    \ ? x : f; };\n    auto composition = [](F& f, F s) { if (s.first > f.first) f\
    \ = s; };\n    auto id = []() { return F(-1, 0); };\n\n    DualSegmentTree<S,\
    \ F, mapping, composition, id> tree(n, S(0, (1ll << 31) - 1));\n\n    rep(i, q)\
    \ {\n        ll t;\n        cin >> t;\n\n        if (t == 0) {\n            ll\
    \ s, t, x;\n            cin >> s >> t >> x;\n            tree.apply(s, t + 1,\
    \ {i, x});\n        }\n        else {\n            ll i;\n            cin >> i;\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_D&\"\
    ...
    \ id> tree(n, S(0, (1ll << 31) - 1));\n\n    rep(i, q) {\n        ll t;\n    \
    \    cin >> t;\n\n        if (t == 0) {\n            ll s, t, x;\n           \
    \ cin >> s >> t >> x;\n            tree.apply(s, t + 1, {i, x});\n        }\n\
    \        else {\n            ll i;\n            cin >> i;\n            cout <<\
    \ tree.get(i).second << endl;\n        }\n    }\n\n    return 0;\n}"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2025-11-16 17:52:01+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/structure/dual-segment-tree-abstract/aoj-dsl-2-d.test.cpp
layout: document
redirect_from:
- /verify/test/structure/dual-segment-tree-abstract/aoj-dsl-2-d.test.cpp
- /verify/test/structure/dual-segment-tree-abstract/aoj-dsl-2-d.test.cpp.html

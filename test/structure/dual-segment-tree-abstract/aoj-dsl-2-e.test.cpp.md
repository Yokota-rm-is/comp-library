...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dual-segment-tree-abstract/aoj-dsl-2-e.test.cpp\"\
    ...
    \       }\n        os << endl;\n\n        os << \"value\" << endl;\n        rep(i,\
    \ seg._N) {\n            os << seg.get(i) << \" \";\n        }\n        os <<\
    \ endl;\n\n        return os;\n    }\n};\n#line 4 \"test/structure/dual-segment-tree-abstract/aoj-dsl-2-e.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    using\
    \ F = ll;\n    auto mapping = [](S x, F f) { return x + f; };\n    auto composition\
    \ = [](F& f, F s) { f += s; };\n    auto id = []() { return 0ll; };\n    DualSegmentTree<S,\
    \ F, mapping, composition, id> tree(n, 0);\n\n    // RangeAddPointGet<ll, ll>\
    \ tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n       \
    \ if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n  \
    \          tree.apply(s - 1, t, x);\n        }\n        else {\n            ll\
  ...
  verifiedWith: []
documentation_of: test/structure/dual-segment-tree-abstract/aoj-dsl-2-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/dual-segment-tree-abstract/aoj-dsl-2-e.test.cpp
- /verify/test/structure/dual-segment-tree-abstract/aoj-dsl-2-e.test.cpp.html

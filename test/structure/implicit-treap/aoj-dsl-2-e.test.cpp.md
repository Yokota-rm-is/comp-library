...
data:
  ...
  bundledCode: "#line 1 \"test/structure/implicit-treap/aoj-dsl-2-e.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_E&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ x, offset, false);\n    //     }\n    // }\n};\n#line 4 \"test/structure/implicit-treap/aoj-dsl-2-e.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    using\
  ...
  verifiedWith: []
documentation_of: test/structure/implicit-treap/aoj-dsl-2-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/implicit-treap/aoj-dsl-2-e.test.cpp
- /verify/test/structure/implicit-treap/aoj-dsl-2-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/implicit-treap/aoj-dsl-2-i.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_I&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ x, offset, false);\n    //     }\n    // }\n};\n#line 4 \"test/structure/implicit-treap/aoj-dsl-2-i.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = pll;\n   \
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_I&\"\
    ...
    \    if (s == inf64) return;\n        f = s; \n    };\n    auto id = []() { return\
    \ inf64; };\n    ImplicitTreap<S, F, op, e, mapping, composition, id> tree(n,\
    \ {0ll, 1ll});\n\n    while (q--) {\n        ll t;\n        cin >> t;\n\n    \
    \    if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n\
    \            tree.apply(s, t + 1, x);\n        }\n        else {\n           \
  ...
  verifiedWith: []
documentation_of: test/structure/implicit-treap/aoj-dsl-2-i.test.cpp
layout: document
redirect_from:
- /verify/test/structure/implicit-treap/aoj-dsl-2-i.test.cpp
- /verify/test/structure/implicit-treap/aoj-dsl-2-i.test.cpp.html

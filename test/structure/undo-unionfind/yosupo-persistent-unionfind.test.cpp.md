...
data:
  ...
  bundledCode: "#line 1 \"test/structure/undo-unionfind/yosupo-persistent-unionfind.test.cpp\"\
    ...
    \    long long V;\n    vector<long long> par; // par[i]: i\u306E\u89AA\u306E\u756A\
    \u53F7 or \u30B5\u30A4\u30BA (i\u304C\u89AA\u306E\u6642)\n    stack<pair<long\
    ...
    \ return true;\n    }\n\n    // 2\u3064\u306E\u30C7\u30FC\u30BFx, y\u304C\u5C5E\
    \u3059\u308B\u6728\u304C\u540C\u3058\u306A\u3089true\u3092\u8FD4\u3059\n    bool\
    \ is_same(long long x, long long y) { \n        return find(x) == find(y);\n \
    ...
    \ size(long long x) {\n        long long rx = find(x);\n        return -par[rx];\n\
    \    }\n\n    bool is_connected() {\n        long long rx = find(0);\n       \
    \ return -par[rx] == V;\n    }\n};\n#line 4 \"test/structure/undo-unionfind/yosupo-persistent-unionfind.test.cpp\"\
    \n\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vector<array<ll, 4>>\
    \ A;\n    rep(i, Q) {\n        ll t, k, u, v;\n        cin >> t >> k >> u >> v;\n\
    \        A.push_back({t, k + 1, u, v});\n    }\n\n    vector<vector<array<ll,\
    \ 5>>> G(Q + 1);\n    rep(i, Q) {\n        auto [t, k, u, v] = A[i];\n       \
  ...
  verifiedWith: []
documentation_of: test/structure/undo-unionfind/yosupo-persistent-unionfind.test.cpp
layout: document
redirect_from:
- /verify/test/structure/undo-unionfind/yosupo-persistent-unionfind.test.cpp
- /verify/test/structure/undo-unionfind/yosupo-persistent-unionfind.test.cpp.html

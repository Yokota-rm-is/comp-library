...
data:
  ...
  bundledCode: "#line 1 \"test/structure/undo-unionfind/aoj-dsl-1-a.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_1_A&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ cc_size;\n    }\n\n    bool is_connected() {\n        return cc_size == 1;\n\
    \    }\n};\n#line 4 \"test/structure/undo-unionfind/aoj-dsl-1-a.test.cpp\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/structure/undo-unionfind/aoj-dsl-1-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/undo-unionfind/aoj-dsl-1-a.test.cpp
- /verify/test/structure/undo-unionfind/aoj-dsl-1-a.test.cpp.html

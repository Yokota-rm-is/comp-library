...
data:
  ...
  bundledCode: "#line 1 \"test/structure/weighted-unionfind/yosupo-unionfind-with-potential-3.test.cpp\"\
    ...
    \ 5 \"test/structure/weighted-unionfind/yosupo-unionfind-with-potential-3.test.cpp\"\
    \n\nusing mint = mint998;\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n\
  ...
  verifiedWith: []
documentation_of: test/structure/weighted-unionfind/yosupo-unionfind-with-potential-3.test.cpp
layout: document
redirect_from:
- /verify/test/structure/weighted-unionfind/yosupo-unionfind-with-potential-3.test.cpp
- /verify/test/structure/weighted-unionfind/yosupo-unionfind-with-potential-3.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/weighted-unionfind/atcoder-abc277-c.test.cpp\"\
    ...
    \ <typename T, bool MergeCC = false, bool UnionBySize = true, bool PathCompression\
    \ = true>\nstruct WeightedUnionFind {\n    long long V;\n    vector<long long>\
    \ par; // par[i]: i\u306E\u89AA\u306E\u756A\u53F7 or \u30B5\u30A4\u30BA (i\u304C\
    \u89AA\u306E\u6642)\n    vector<vector<long long>> cc;\n    long long cc_size;\n\
    \    \n    vector<pair<long long, long long>> edges;\n    vector<vector<long long>>\
    \ cc_edge;\n\n    vector<T> diff_weight;\n\n    WeightedUnionFind(long long V)\
    \ : V(V) {\n        init();\n    }\n\n    void init() {\n        par.assign(V,\
    ...
    \ y, w, [](long long, long long){});\n    }\n\n    // x\u3068y\u3092\u9023\u7D50\
    \n    // w = weight(y) - weight(x)\n    bool unite(long long x, long long y, T\
    ...
    #line 5 \"test/structure/weighted-unionfind/atcoder-abc277-c.test.cpp\"\n\nint\
    \ main() {\n    long long N;\n    cin >> N;\n\n    vll A(N), B(N);\n    rep(i,\
    \ N) cin >> A[i] >> B[i];\n\n    vll X;\n    X.push_back(1);\n    rep(i, N) {\n\
    \        X.emplace_back(A[i]);\n        X.emplace_back(B[i]);\n    }\n\n    Compressor<long\
    \ long> comp(X);\n\n    WeightedUnionFind<ll, true> tree(comp.size());\n    rep(i,\
    \ N) {\n        tree.unite(comp(A[i]), comp(B[i]), 0);\n    }\n\n    auto members\
    \ = tree.members(comp(1));\n    long long ans = 1;\n    for (auto x : members)\
    \ {\n        chmax(ans, comp.retrieve(x));\n    }\n\n    cout << ans << endl;\n\
    \    \n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc277/tasks/abc277_c\"\n\n\
  ...
  requiredBy: []
  timestamp: '2025-03-23 20:11:41+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/structure/weighted-unionfind/atcoder-abc277-c.test.cpp
layout: document
redirect_from:
- /verify/test/structure/weighted-unionfind/atcoder-abc277-c.test.cpp
- /verify/test/structure/weighted-unionfind/atcoder-abc277-c.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/weighted-unionfind/aoj-dsl-1-b-2.test.cpp\"\
    ...
    \    }\n};\n#line 4 \"test/structure/weighted-unionfind/aoj-dsl-1-b-2.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    WeightedUnionFind<ll,\
    \ false, false, true> tree(n);\n    while (q--) {\n        ll t;\n        cin\
    \ >> t;\n\n        if (t == 0) {\n            ll x, y, z;\n            cin >>\
    \ x >> y >> z;\n            tree.unite(x, y, z);\n        }\n        else {\n\
    \            ll x, y;\n            cin >> x >> y;\n            if (tree.is_same(x,\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_1_B&\"\
    ...
    \   ll n, q;\n    cin >> n >> q;\n\n    WeightedUnionFind<ll, false, false, true>\
    \ tree(n);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if\
    \ (t == 0) {\n            ll x, y, z;\n            cin >> x >> y >> z;\n     \
    \       tree.unite(x, y, z);\n        }\n        else {\n            ll x, y;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/weighted-unionfind/aoj-dsl-1-b-2.test.cpp
layout: document
redirect_from:
- /verify/test/structure/weighted-unionfind/aoj-dsl-1-b-2.test.cpp
- /verify/test/structure/weighted-unionfind/aoj-dsl-1-b-2.test.cpp.html

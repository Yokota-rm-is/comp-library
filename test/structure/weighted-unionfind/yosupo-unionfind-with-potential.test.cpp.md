...
data:
  ...
  bundledCode: "#line 1 \"test/structure/weighted-unionfind/yosupo-unionfind-with-potential.test.cpp\"\
    ...
    \ 5 \"test/structure/weighted-unionfind/yosupo-unionfind-with-potential.test.cpp\"\
    \n\nusing mint = mint998;\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n\
    \    WeightedUnionFind<mint> tree(N);\n    while (Q--) {\n        ll t;\n    \
    \    cin >> t;\n\n        if (t == 0) {\n            ll u, v, x;\n           \
    \ cin >> u >> v >> x;\n            if (!tree.is_same(u, v)) {\n              \
  ...
  verifiedWith: []
documentation_of: test/structure/weighted-unionfind/yosupo-unionfind-with-potential.test.cpp
layout: document
redirect_from:
- /verify/test/structure/weighted-unionfind/yosupo-unionfind-with-potential.test.cpp
- /verify/test/structure/weighted-unionfind/yosupo-unionfind-with-potential.test.cpp.html

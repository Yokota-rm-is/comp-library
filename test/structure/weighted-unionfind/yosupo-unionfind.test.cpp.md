...
data:
  ...
  bundledCode: "#line 1 \"test/structure/weighted-unionfind/yosupo-unionfind.test.cpp\"\
    ...
    \    }\n};\n#line 4 \"test/structure/weighted-unionfind/yosupo-unionfind.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/structure/weighted-unionfind/yosupo-unionfind.test.cpp
layout: document
redirect_from:
- /verify/test/structure/weighted-unionfind/yosupo-unionfind.test.cpp
- /verify/test/structure/weighted-unionfind/yosupo-unionfind.test.cpp.html

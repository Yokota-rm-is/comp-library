...
data:
  ...
  bundledCode: "#line 1 \"test/structure/binary-indexed-tree/atcoder-abc407-f.test.cpp\"\
    ...
    \ index, size, coeff;\n\n    Node(T v, long long l = -1, long long r = -1, long\
    \ long i = -1, long long s = 0, long long c = 1) : value(v), left(l), right(r),\
    ...
    \ (y == e()) return x;\n\n        T value = x.value;\n        long long left =\
    \ (x.left != -1 ? x.left : y.left);\n        long long right = (y.right != -1\
    \ ? y.right : x.right);\n        long long index = -1;\n        long long size\
    \ = x.size + y.size;\n        long long coeff = 1;\n\n        S ret(value, left,\
    \ right, index, size, coeff);\n\n        return ret;\n    }\n\nprivate:\n    T\
    ...
    \ = SegmentTree<T, F, Chmax, Max>;\n\n#line 7 \"test/structure/binary-indexed-tree/atcoder-abc407-f.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    rep(i, N) cin\
    \ >> A[i];\n    PointAddRangeMax<ll, ll> tree(A);\n    BinaryIndexedTree<> bit(N,\
    \ 0);\n\n    rep(i, N) {\n        ll a = A[i];\n\n        auto F = [&](Node<ll>\
    \ node) {\n            return node.value <= a;\n        };\n        ll r = tree.max_right(i,\
    \ F);\n\n        auto G = [&](Node<ll> node) {\n            return node.value\
  ...
  verifiedWith: []
documentation_of: test/structure/binary-indexed-tree/atcoder-abc407-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/binary-indexed-tree/atcoder-abc407-f.test.cpp
- /verify/test/structure/binary-indexed-tree/atcoder-abc407-f.test.cpp.html

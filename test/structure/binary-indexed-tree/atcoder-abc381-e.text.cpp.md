...
data:
  ...
  bundledCode: "#line 1 \"test/structure/binary-indexed-tree/atcoder-abc381-e.text.cpp\"\
    ...
    \ - 1 ? \" \" : \"\");\n        return os;\n    }\n};\n#line 6 \"test/structure/binary-indexed-tree/atcoder-abc381-e.text.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    string S;\n    cin >>\
    \ S;\n\n    vll slashes(N, 0);\n    rep(i, N) {\n        if (S[i] == '/') slashes[i]\
    ...
    \n        if (n == 0) {\n            cout << 1 << endl;\n            continue;\n\
    \        }\n\n        auto is_ok = [&](ll x){\n            ll l = bit1.find_lower_right(x,\
    \ L);\n            ll r = bit2.find_lower_left(x, R);\n\n            if (l ==\
    \ N or r == -1) return false;\n            return r - l >= 0 and cs.sum(l, r)\
  ...
  requiredBy: []
  timestamp: '2025-03-23 20:09:50+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: test/structure/binary-indexed-tree/atcoder-abc381-e.text.cpp
layout: document
redirect_from:
- /library/test/structure/binary-indexed-tree/atcoder-abc381-e.text.cpp
- /library/test/structure/binary-indexed-tree/atcoder-abc381-e.text.cpp.html

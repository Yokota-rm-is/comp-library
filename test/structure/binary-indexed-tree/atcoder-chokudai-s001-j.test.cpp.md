...
data:
  ...
  bundledCode: "#line 1 \"test/structure/binary-indexed-tree/atcoder-chokudai-s001-j.test.cpp\"\
    ...
    \        break;\n    }\n\n    return ret;\n}\n#line 5 \"test/structure/binary-indexed-tree/atcoder-chokudai-s001-j.test.cpp\"\
    \n\nint main() {\n    long long N;\n    cin >> N;\n\n    vll A(N);\n    rep(i,\
  ...
  verifiedWith: []
documentation_of: test/structure/binary-indexed-tree/atcoder-chokudai-s001-j.test.cpp
layout: document
redirect_from:
- /verify/test/structure/binary-indexed-tree/atcoder-chokudai-s001-j.test.cpp
- /verify/test/structure/binary-indexed-tree/atcoder-chokudai-s001-j.test.cpp.html

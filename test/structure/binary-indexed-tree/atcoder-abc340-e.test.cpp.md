...
data:
  ...
  bundledCode: "#line 1 \"test/structure/binary-indexed-tree/atcoder-abc340-e.test.cpp\"\
    ...
    \        break;\n    }\n\n    return ret;\n}\n#line 4 \"test/structure/binary-indexed-tree/atcoder-abc340-e.test.cpp\"\
    \n\nint main() {\n    long long N;\n    cin >> N;\n    long long M;\n    cin >>\
  ...
  verifiedWith: []
documentation_of: test/structure/binary-indexed-tree/atcoder-abc340-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/binary-indexed-tree/atcoder-abc340-e.test.cpp
- /verify/test/structure/binary-indexed-tree/atcoder-abc340-e.test.cpp.html

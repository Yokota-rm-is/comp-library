...
data:
  ...
  bundledCode: "#line 1 \"test/structure/binary-indexed-tree/aoj-alds1-5-d.test.cpp\"\
    ...
    \    }\n\n    rep(i, A.size()) {\n        auto [l, r] = A[i];\n        if (tree.sum(l,\
    \ r + 1) == 0) continue;\n\n        ret = true;\n        break;\n    }\n\n   \
    \ return ret;\n}\n#line 4 \"test/structure/binary-indexed-tree/aoj-alds1-5-d.test.cpp\"\
    \n\nint main() {\n    ll n;\n    cin >> n;\n\n    vll a(n);\n    rep(i, n) cin\
...
layout: document
redirect_from:
- /verify/test/structure/binary-indexed-tree/aoj-alds1-5-d.test.cpp
- /verify/test/structure/binary-indexed-tree/aoj-alds1-5-d.test.cpp.html

...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3165
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3165
  bundledCode: "#line 1 \"test/structure/binary-indexed-tree/aoj-3165.test.cpp\"\n\
    ...
    \ = true;\n        break;\n    }\n\n    return ret;\n}\n#line 4 \"test/structure/binary-indexed-tree/aoj-3165.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    BinaryIndexedTree<ll>\
    \ bit(N, 0);\n    while (Q--) {\n        ll l, k;\n        cin >> l >> k;\n  \
    \      --l;\n\n        bit.add(l, l + k, 1, 1);\n    }\n\n    rep(i, N) {\n  \
    \      cout << bit.get(i);\n        if (i < N - 1) cout << \" \";\n    }\n   \
    \ cout << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3165\"\
  ...
  verifiedWith: []
documentation_of: test/structure/binary-indexed-tree/aoj-3165.test.cpp
layout: document
redirect_from:
- /verify/test/structure/binary-indexed-tree/aoj-3165.test.cpp
- /verify/test/structure/binary-indexed-tree/aoj-3165.test.cpp.html

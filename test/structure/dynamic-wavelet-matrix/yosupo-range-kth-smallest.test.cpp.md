...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dynamic-wavelet-matrix/yosupo-range-kth-smallest.test.cpp\"\
    ...
    \ retrieve(long long k) {\n        return values[k];\n    }\n};\n#line 5 \"test/structure/dynamic-wavelet-matrix/yosupo-range-kth-smallest.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
    \ N) cin >> a[i];\n\n    Compressor<ll> comp(a);\n    vll b = comp.compressed;\n\
    \n    DynamicWaveletMatrix<ll> wm(max(b), b);\n\n    rep(i, Q) {\n        ll l,\
    \ r, k;\n        cin >> l >> r >> k;\n\n        ll ans = wm.kth_min(l, r, k +\
  ...
  verifiedWith: []
documentation_of: test/structure/dynamic-wavelet-matrix/yosupo-range-kth-smallest.test.cpp
layout: document
redirect_from:
- /verify/test/structure/dynamic-wavelet-matrix/yosupo-range-kth-smallest.test.cpp
- /verify/test/structure/dynamic-wavelet-matrix/yosupo-range-kth-smallest.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp\"\
    ...
    \ retrieve(long long k) {\n        return values[k];\n    }\n};\n#line 5 \"test/structure/dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
    \ N) cin >> a[i];\n\n    if (N == 0) {\n        rep(i, Q) cout << 0 << endl;\n\
  ...
  requiredBy: []
  timestamp: '2024-08-17 04:59:54+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/structure/dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp
layout: document
redirect_from:
- /verify/test/structure/dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp
- /verify/test/structure/dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dynamic-wavelet-matrix/aoj-1549.test.cpp\"\
    ...
    \      }\n\n        return intersection;\n    }\n};\n#line 4 \"test/structure/dynamic-wavelet-matrix/aoj-1549.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll a(N);\n    rep(i, N) cin\
  ...
  verifiedWith: []
documentation_of: test/structure/dynamic-wavelet-matrix/aoj-1549.test.cpp
layout: document
redirect_from:
- /verify/test/structure/dynamic-wavelet-matrix/aoj-1549.test.cpp
- /verify/test/structure/dynamic-wavelet-matrix/aoj-1549.test.cpp.html

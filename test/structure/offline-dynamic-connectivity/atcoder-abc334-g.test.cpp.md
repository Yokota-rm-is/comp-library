...
data:
  ...
  bundledCode: "#line 1 \"test/structure/offline-dynamic-connectivity/atcoder-abc334-g.test.cpp\"\
    ...
    \ * W + j, (i - 1) * W + j);\n        }\n        if (j - 1 >= 0 and S[i][j - 1]\
    \ == '#') {\n            odc.link(i * W + j, i * W + j - 1);\n        }\n    }\n\
    \n    odc.build();\n    vll cc = odc.run([](UndoUnionFind<T, op, inv>& uf, int\
    \ v) {\n        return uf.cc_size;\n    });\n\n    ll MOD = 998244353;\n    ll\
    \ base = modinv(green, MOD);\n\n    ll ans = 0;\n    rep(i, cc.size()) {\n   \
    \     ans += (cc[i] - red - 1) * base;\n        ans %= MOD;\n    }\n\n    cout\
    \ << ans << endl;\n\n    return 0;\n} \n"
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/abc334/tasks/abc334_g\"\
  ...
  verifiedWith: []
documentation_of: test/structure/offline-dynamic-connectivity/atcoder-abc334-g.test.cpp
layout: document
redirect_from:
- /verify/test/structure/offline-dynamic-connectivity/atcoder-abc334-g.test.cpp
- /verify/test/structure/offline-dynamic-connectivity/atcoder-abc334-g.test.cpp.html

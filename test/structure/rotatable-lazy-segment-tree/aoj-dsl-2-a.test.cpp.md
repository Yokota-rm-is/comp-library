...
data:
  ...
  bundledCode: "#line 1 \"test/structure/rotatable-lazy-segment-tree/aoj-dsl-2-a.test.cpp\"\
    ...
    \    }\n};\n#line 4 \"test/structure/rotatable-lazy-segment-tree/aoj-dsl-2-a.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_A&\"\
    ...
    \ {\n    ll n, q;\n    cin >> n >> q;\n\n    RotatableLazySegmentTree<ll> tree(n,\
    \ (1ll << 31) - 1);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n \
    \       if (t == 0) {\n            ll x, y;\n            cin >> x >> y;\n    \
    \        tree.apply_set(x, y);\n        }\n        else {\n            ll x, y;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/rotatable-lazy-segment-tree/aoj-dsl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/rotatable-lazy-segment-tree/aoj-dsl-2-a.test.cpp
- /verify/test/structure/rotatable-lazy-segment-tree/aoj-dsl-2-a.test.cpp.html

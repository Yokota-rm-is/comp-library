...
data:
  ...
  bundledCode: "#line 1 \"test/structure/rotatable-lazy-segment-tree/yukicoder-151.test.cpp\"\
    ...
    \    }\n};\n#line 4 \"test/structure/rotatable-lazy-segment-tree/yukicoder-151.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    RotatableLazySegmentTree<ll>\
    \ to_left(N, 0), to_right(N, 0);\n    while (Q--) {\n        char t;\n       \
    \ ll y, z;\n        cin >> t >> y >> z;\n\n        if (t == 'L') {\n         \
    \   to_left.apply_add(y, z);\n        } \n        else if (t == 'R') {\n     \
    \       to_right.apply_add(y, z);\n        }\n        else {\n            ll ans\
    \ = to_left.prod_sum(y, z) + to_right.prod_sum(y, z);\n            cout << ans\
    \ << endl;\n        }\n\n        ll l = to_left.get(0);\n        to_left.apply_set(0,\
  ...
  verifiedWith: []
documentation_of: test/structure/rotatable-lazy-segment-tree/yukicoder-151.test.cpp
layout: document
redirect_from:
- /verify/test/structure/rotatable-lazy-segment-tree/yukicoder-151.test.cpp
- /verify/test/structure/rotatable-lazy-segment-tree/yukicoder-151.test.cpp.html

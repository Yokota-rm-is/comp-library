...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sortable-segment-tree/yosupo-point-set-range-sort-range-composite.test.cpp\"\
    ...
    #line 5 \"test/structure/sortable-segment-tree/yosupo-point-set-range-sort-range-composite.test.cpp\"\
    \n\nusing mint = mint998;\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n\
  ...
  verifiedWith: []
documentation_of: test/structure/sortable-segment-tree/yosupo-point-set-range-sort-range-composite.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sortable-segment-tree/yosupo-point-set-range-sort-range-composite.test.cpp
- /verify/test/structure/sortable-segment-tree/yosupo-point-set-range-sort-range-composite.test.cpp.html

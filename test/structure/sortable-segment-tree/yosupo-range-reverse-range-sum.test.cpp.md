...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sortable-segment-tree/yosupo-range-reverse-range-sum.test.cpp\"\
    ...
    \        return res;\n    }\n};\n#line 4 \"test/structure/sortable-segment-tree/yosupo-range-reverse-range-sum.test.cpp\"\
    \n\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vector<ull> a(N);\n\
    \    rep(i, N) cin >> a[i];\n\n    using Key = ll;\n    using S = ll;\n    auto\
    \ op = [](S a, S b) { return a + b; };\n    auto e = []() { return 0; };\n   \
    \ using F = bool;\n    auto mapping = [](S a, F b) { return a; };\n\n    SegmentTree<Key,\
    \ S, op, e, F, mapping> tree;\n\n    rep(i, N) tree.insert(i, i, a[i]);\n\n  \
    \  while (Q--) {\n        ll t;\n        cin >> t;\n\n        if (t == 0) {\n\
    \            ll l, r;\n            cin >> l >> r;\n            tree.reverse(l,\
    \ r);\n        }\n        else {\n            ll l, r;\n            cin >> l >>\
  ...
  verifiedWith: []
documentation_of: test/structure/sortable-segment-tree/yosupo-range-reverse-range-sum.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sortable-segment-tree/yosupo-range-reverse-range-sum.test.cpp
- /verify/test/structure/sortable-segment-tree/yosupo-range-reverse-range-sum.test.cpp.html

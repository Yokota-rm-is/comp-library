...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sortable-segment-tree/aoj-dsl-2-b.test.cpp\"\
    ...
    \        return res;\n    }\n};\n#line 4 \"test/structure/sortable-segment-tree/aoj-dsl-2-b.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using Key = ll;\n  \
    \  using S = ll;\n    auto op = [](S a, S b) { return a + b; };\n    auto e =\
    \ []() { return 0; };\n    using F = ll;\n    auto mapping = [](S a, F b) { return\
  ...
  verifiedWith: []
documentation_of: test/structure/sortable-segment-tree/aoj-dsl-2-b.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sortable-segment-tree/aoj-dsl-2-b.test.cpp
- /verify/test/structure/sortable-segment-tree/aoj-dsl-2-b.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-g.test.cpp\"\
    ...
    \        os << \"rotated: \" << endl;\n        rep(i, tree.bit._N) {\n       \
    \     os << tree.get<false>(i) << \" \";\n        }\n        return os;\n    }\n\
    };\n#line 4 \"test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-g.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-g.test.cpp
layout: document
redirect_from:
- /verify/test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-g.test.cpp
- /verify/test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-g.test.cpp.html

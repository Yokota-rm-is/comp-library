...
data:
  ...
  attributes:
    ...
    links:
    - https://yukicoder.me/problems/no/151
  bundledCode: "#line 1 \"test/structure/rotatable-binary-indexed-tree/yukicoder-151.test.cpp\"\
    ...
    \        os << \"rotated: \" << endl;\n        rep(i, tree.bit._N) {\n       \
    \     os << tree.get<false>(i) << \" \";\n        }\n        return os;\n    }\n\
    };\n#line 4 \"test/structure/rotatable-binary-indexed-tree/yukicoder-151.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    RotatableBinaryIndexedTree<ll>\
    \ to_left(N, 0), to_right(N, 0);\n    while (Q--) {\n        char t;\n       \
    \ ll y, z;\n        cin >> t >> y >> z;\n\n        if (t == 'L') {\n         \
    \   to_left.add(y, z);\n        } \n        else if (t == 'R') {\n           \
    \ to_right.add(y, z);\n        }\n        else {\n            ll ans = to_left.sum(y,\
    \ z) + to_right.sum(y, z);\n            cout << ans << endl;\n        }\n\n  \
    \      ll l = to_left.get(0);\n        to_left.set(0, 0);\n        to_left.rotate_left(1);\n\
    \n        ll r = to_right.get(N - 1);\n        to_right.set(N - 1, 0);\n     \
    \   to_right.rotate_right(1);\n\n        to_left.add(N - 1, r);\n        to_right.add(0,\
    \ l);\n    }\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/151\"\n\n#include \"../../../structure/rotatable-binary-indexed-tree.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    RotatableBinaryIndexedTree<ll>\
    \ to_left(N, 0), to_right(N, 0);\n    while (Q--) {\n        char t;\n       \
    \ ll y, z;\n        cin >> t >> y >> z;\n\n        if (t == 'L') {\n         \
    \   to_left.add(y, z);\n        } \n        else if (t == 'R') {\n           \
  ...
  verifiedWith: []
documentation_of: test/structure/rotatable-binary-indexed-tree/yukicoder-151.test.cpp
layout: document
redirect_from:
- /verify/test/structure/rotatable-binary-indexed-tree/yukicoder-151.test.cpp
- /verify/test/structure/rotatable-binary-indexed-tree/yukicoder-151.test.cpp.html

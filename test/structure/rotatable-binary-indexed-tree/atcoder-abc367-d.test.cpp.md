...
data:
  ...
  bundledCode: "#line 1 \"test/structure/rotatable-binary-indexed-tree/atcoder-abc367-d.test.cpp\"\
    ...
    \ - 1 ? \" \" : \"\");\n        return os;\n    }\n};\n#line 5 \"test/structure/rotatable-binary-indexed-tree/atcoder-abc367-d.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vll A(N);\n    rep(i,\
...
layout: document
redirect_from:
- /verify/test/structure/rotatable-binary-indexed-tree/atcoder-abc367-d.test.cpp
- /verify/test/structure/rotatable-binary-indexed-tree/atcoder-abc367-d.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-e.test.cpp\"\
    ...
    \        os << \"rotated: \" << endl;\n        rep(i, tree.bit._N) {\n       \
    \     os << tree.get<false>(i) << \" \";\n        }\n        return os;\n    }\n\
    };\n#line 4 \"test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-e.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_E&\"\
    ...
    \ {\n    ll n, q;\n    cin >> n >> q;\n\n    RotatableBinaryIndexedTree<ll> tree(n,\
    \ 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if (t ==\
    \ 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n           \
    \ tree.add(s - 1, t, x);\n        }\n        else {\n            ll i;\n     \
    \       cin >> i;\n            cout << tree.get(i - 1) << endl;\n        }\n \
  ...
  verifiedWith: []
documentation_of: test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-e.test.cpp
- /verify/test/structure/rotatable-binary-indexed-tree/aoj-dsl-2-e.test.cpp.html

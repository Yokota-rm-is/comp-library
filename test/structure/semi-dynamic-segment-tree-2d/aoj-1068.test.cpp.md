...
data:
  ...
  bundledCode: "#line 1 \"test/structure/semi-dynamic-segment-tree-2d/aoj-1068.test.cpp\"\
    ...
    \  }\n\n        return op(sml, smr);\n    }\n};\n#line 5 \"test/structure/semi-dynamic-segment-tree-2d/aoj-1068.test.cpp\"\
    \n\nint main() {\n    while (true) {\n        ll r, c, q;\n        cin >> r >>\
    \ c >> q;\n\n        if (r == 0) break;\n\n        vector<vector<ll>> grid(r,\
    \ vector<ll>(c, 0));\n        rep(i, r) rep(j, c) cin >> grid[i][j]; \n\n    \
    \    SemiDynamicSegmentTree2D<ll, ll, Set, Min> tree(r, c);\n        rep(i, r)\
    \ rep(j, c) tree.add_point(i, j);\n\n        tree.build();\n        rep(i, r)\
    \ rep(j, c) tree.apply(i, j, grid[i][j]);\n\n        while (q--) {\n         \
    \   ll r1, c1, r2, c2;\n            cin >> r1 >> c1 >> r2 >> c2;\n\n         \
  ...
  verifiedWith: []
documentation_of: test/structure/semi-dynamic-segment-tree-2d/aoj-1068.test.cpp
layout: document
redirect_from:
- /verify/test/structure/semi-dynamic-segment-tree-2d/aoj-1068.test.cpp
- /verify/test/structure/semi-dynamic-segment-tree-2d/aoj-1068.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-plain/aoj-dsl-2-f.test.cpp\"\
    ...
    \  }\n};\n#line 4 \"test/structure/lazy-segment-tree-plain/aoj-dsl-2-f.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    LazySegmentTree<ll>\
    \ tree(n, (1ll << 31) - 1);\n    while (q--) {\n        ll t;\n        cin >>\
    \ t;\n\n        if (t == 0) {\n            ll s, t, x;\n            cin >> s >>\
    \ t >> x;\n            tree.apply_set(s, t + 1, x);\n        }\n        else {\n\
    \            ll s, t;\n            cin >> s >> t;\n            cout << tree.prod_min(s,\
    \ t + 1) << endl;\n        }\n    }\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-plain/aoj-dsl-2-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-plain/aoj-dsl-2-f.test.cpp
- /verify/test/structure/lazy-segment-tree-plain/aoj-dsl-2-f.test.cpp.html

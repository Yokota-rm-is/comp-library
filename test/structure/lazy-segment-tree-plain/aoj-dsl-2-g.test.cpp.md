...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree-plain/aoj-dsl-2-g.test.cpp\"\
    ...
    \  }\n};\n#line 4 \"test/structure/lazy-segment-tree-plain/aoj-dsl-2-g.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    LazySegmentTree<ll>\
    \ tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n       \
    \ if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n  \
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree-plain/aoj-dsl-2-g.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree-plain/aoj-dsl-2-g.test.cpp
- /verify/test/structure/lazy-segment-tree-plain/aoj-dsl-2-g.test.cpp.html

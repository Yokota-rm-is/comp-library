...
data:
  ...
  bundledCode: "#line 1 \"test/structure/segment-tree-beats/aoj-dsl-2-e.test.cpp\"\
    ...
    \    }\n};\n#line 4 \"test/structure/segment-tree-beats/aoj-dsl-2-e.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    SegmentTreeBeats<ll>\
    \ tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n       \
    \ if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n  \
  ...
  verifiedWith: []
documentation_of: test/structure/segment-tree-beats/aoj-dsl-2-e.test.cpp
layout: document
redirect_from:
- /verify/test/structure/segment-tree-beats/aoj-dsl-2-e.test.cpp
- /verify/test/structure/segment-tree-beats/aoj-dsl-2-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sqrt-decomposition/aoj-dsl-2-b.test.cpp\"\
    ...
    \  rep(i, max(l, lk), min(r, rk)) {\n                    sm = op(sm, node[i]);\n\
    \                }\n                update(k);\n            }\n        }\n\n \
    \       return sm;\n    }\n};\n#line 4 \"test/structure/sqrt-decomposition/aoj-dsl-2-b.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/structure/sqrt-decomposition/aoj-dsl-2-b.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-b.test.cpp
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-b.test.cpp.html

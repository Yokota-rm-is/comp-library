...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sqrt-decomposition/aoj-dsl-2-a.test.cpp\"\
    ...
    \ {\n                    chmax(ret, data[i]);\n                }\n           \
    \     update(k);\n            }\n        }\n\n        return ret;\n    }\n};\n\
    #line 4 \"test/structure/sqrt-decomposition/aoj-dsl-2-a.test.cpp\"\n\nint main()\
  ...
  verifiedWith: []
documentation_of: test/structure/sqrt-decomposition/aoj-dsl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-a.test.cpp
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-a.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sqrt-decomposition/aoj-dsl-2-f.test.cpp\"\
    ...
    \ {\n                    chmax(ret, data[i]);\n                }\n           \
    \     update(k);\n            }\n        }\n\n        return ret;\n    }\n};\n\
    #line 4 \"test/structure/sqrt-decomposition/aoj-dsl-2-f.test.cpp\"\n\nint main()\
  ...
  requiredBy: []
  timestamp: '2024-05-04 12:06:51+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/structure/sqrt-decomposition/aoj-dsl-2-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-f.test.cpp
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-f.test.cpp.html

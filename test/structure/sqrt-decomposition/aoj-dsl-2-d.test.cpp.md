...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sqrt-decomposition/aoj-dsl-2-d.test.cpp\"\
    ...
    \  rep(i, max(l, lk), min(r, rk)) {\n                    sm = op(sm, node[i]);\n\
    \                }\n                update(k);\n            }\n        }\n\n \
    \       return sm;\n    }\n};\n#line 4 \"test/structure/sqrt-decomposition/aoj-dsl-2-d.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    SqrtDecomposition<ll,\
    \ ll, Set, NoOperation> sd(n, (1ll << 31) - 1);\n    while (q--) {\n        ll\
    \ t;\n        cin >> t;\n\n        if (t == 0) {\n            ll s, t, x;\n  \
    \          cin >> s >> t >> x;\n            sd.apply(s, t + 1, x);\n        }\n\
    \        else {\n            ll i;\n            cin >> i;\n            cout <<\
    \ sd.get(i) << endl;\n        }\n    }\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_D&\"\
    ...
    \   ll n, q;\n    cin >> n >> q;\n\n    SqrtDecomposition<ll, ll, Set, NoOperation>\
    \ sd(n, (1ll << 31) - 1);\n    while (q--) {\n        ll t;\n        cin >> t;\n\
    \n        if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >>\
    \ x;\n            sd.apply(s, t + 1, x);\n        }\n        else {\n        \
    \    ll i;\n            cin >> i;\n            cout << sd.get(i) << endl;\n  \
  ...
  verifiedWith: []
documentation_of: test/structure/sqrt-decomposition/aoj-dsl-2-d.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-d.test.cpp
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-d.test.cpp.html

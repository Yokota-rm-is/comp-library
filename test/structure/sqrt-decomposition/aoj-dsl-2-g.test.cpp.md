...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sqrt-decomposition/aoj-dsl-2-g.test.cpp\"\
    ...
    \  rep(i, max(l, lk), min(r, rk)) {\n                    sm = op(sm, node[i]);\n\
    \                }\n                update(k);\n            }\n        }\n\n \
    \       return sm;\n    }\n};\n#line 4 \"test/structure/sqrt-decomposition/aoj-dsl-2-g.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_G&\"\
    ...
    \   ll n, q;\n    cin >> n >> q;\n\n    SqrtDecomposition<ll, ll, Add, Sum> sd(n,\
    \ 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if (t ==\
    \ 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n           \
    \ sd.apply(s - 1, t, x);\n        }\n        else {\n            ll s, t;\n  \
  ...
  verifiedWith: []
documentation_of: test/structure/sqrt-decomposition/aoj-dsl-2-g.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-g.test.cpp
- /verify/test/structure/sqrt-decomposition/aoj-dsl-2-g.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
    \ N) cin >> a[i];\n\n    if (N == 0) {\n        rep(i, Q) cout << 0 << endl;\n\
  ...
  verifiedWith: []
documentation_of: test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp
layout: document
redirect_from:
- /verify/test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp
- /verify/test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-frequency.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-sum.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-sum.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
  ...
  verifiedWith: []
documentation_of: test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-sum.test.cpp
layout: document
redirect_from:
- /verify/test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-sum.test.cpp
- /verify/test/structure/semi-dynamic-wavelet-matrix/yosupo-static-range-sum.test.cpp.html

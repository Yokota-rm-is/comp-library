...
data:
  ...
  bundledCode: "#line 1 \"test/structure/semi-dynamic-wavelet-matrix/aoj-dsl-2-a.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/semi-dynamic-wavelet-matrix/aoj-dsl-2-a.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    SemiDynamicWaveletMatrix<ll>\
    \ wm(n, (1ll << 31) - 1);\n\n    vll T(q), X(q), Y(q);\n\n    rep(i, q) {\n  \
    \      cin >> T[i] >> X[i] >> Y[i];\n\n        if (T[i] == 0) {\n            wm.simulate_set(X[i],\
    \ Y[i]);\n        }\n    } \n\n    wm.build();\n\n    rep(i, q) {\n        ll\
    \ t = T[i], x = X[i], y = Y[i];\n\n        if (t == 0) {\n            wm.set(x,\
    \ y);\n        }\n        else {\n            cout << wm.kth_min(x, y + 1, 1)\
    \ << endl;\n        }\n\n    }\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/structure/semi-dynamic-wavelet-matrix/aoj-dsl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/semi-dynamic-wavelet-matrix/aoj-dsl-2-a.test.cpp
- /verify/test/structure/semi-dynamic-wavelet-matrix/aoj-dsl-2-a.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/semi-dynamic-wavelet-matrix/aoj-1549.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/semi-dynamic-wavelet-matrix/aoj-1549.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll a(N);\n    rep(i, N) cin\
    \ >> a[i];\n\n    SemiDynamicWaveletMatrix<ll> wm(a);\n    wm.build();\n\n   \
    \ ll Q;\n    cin >> Q;\n\n    while (Q--) {\n        ll l, r, D;\n        cin\
    \ >> l >> r >> D;\n        ++r;\n\n        ll ans = inf64;\n\n        if (wm.count(l,\
    \ r, D) > 0) {\n            ans = 0;\n        }\n        else {\n            ll\
    \ prev = wm.prev_value(l, r, D);\n            if (prev != wm.NOTFOUND) chmin(ans,\
    \ D - prev);\n            ll next = wm.next_value(l, r, D);\n            if (next\
    \ != wm.NOTFOUND) chmin(ans, next - D);\n        }\n        cout << ans << endl;\n\
    \    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/structure/semi-dynamic-wavelet-matrix/aoj-1549.test.cpp
layout: document
redirect_from:
- /verify/test/structure/semi-dynamic-wavelet-matrix/aoj-1549.test.cpp
- /verify/test/structure/semi-dynamic-wavelet-matrix/aoj-1549.test.cpp.html

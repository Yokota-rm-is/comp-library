...
data:
  ...
  bundledCode: "#line 1 \"test/structure/semi-dynamic-wavelet-matrix/yosupo-static-rmq.test.cpp\"\
    ...
    \ + rank1_r, depth + 1, next_val, lower, upper);\n    }\n};\n#line 4 \"test/structure/semi-dynamic-wavelet-matrix/yosupo-static-rmq.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
    \ N) cin >> a[i];\n\n    SemiDynamicWaveletMatrix<ll> wm(a);\n    wm.build();\n\
    \n    rep(i, Q) {\n        ll l, r;\n        cin >> l >> r;\n\n        cout <<\
    \ wm.kth_min(l, r, 1) << endl;\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/structure/semi-dynamic-wavelet-matrix/yosupo-static-rmq.test.cpp
layout: document
redirect_from:
- /verify/test/structure/semi-dynamic-wavelet-matrix/yosupo-static-rmq.test.cpp
- /verify/test/structure/semi-dynamic-wavelet-matrix/yosupo-static-rmq.test.cpp.html

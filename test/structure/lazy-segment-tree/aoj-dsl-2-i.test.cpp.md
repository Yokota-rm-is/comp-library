...
data:
  ...
  bundledCode: "#line 1 \"test/structure/lazy-segment-tree/aoj-dsl-2-i.test.cpp\"\n\
    ...
    \ = LazySegmentTree<T, F, Set, Max>;\n#line 4 \"test/structure/lazy-segment-tree/aoj-dsl-2-i.test.cpp\"\
    \n\nint main() {\n    ll n, q;\n    cin >> n >> q;\n\n    RangeSetRangeSum<ll,\
    \ ll> tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n   \
    \     if (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n\
    \            tree.apply(s, t + 1, x);\n        }\n        else {\n           \
  ...
  verifiedWith: []
documentation_of: test/structure/lazy-segment-tree/aoj-dsl-2-i.test.cpp
layout: document
redirect_from:
- /verify/test/structure/lazy-segment-tree/aoj-dsl-2-i.test.cpp
- /verify/test/structure/lazy-segment-tree/aoj-dsl-2-i.test.cpp.html

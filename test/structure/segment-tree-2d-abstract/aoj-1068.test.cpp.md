...
data:
  ...
  bundledCode: "#line 1 \"test/structure/segment-tree-2d-abstract/aoj-1068.test.cpp\"\
    ...
    \n        return op(sml, smr);\n    }\n};\n#line 4 \"test/structure/segment-tree-2d-abstract/aoj-1068.test.cpp\"\
    \n\nint main() {\n    while (true) {\n        ll r, c, q;\n        cin >> r >>\
    \ c >> q;\n\n        if (r == 0) break;\n\n        vector<vector<ll>> grid(r,\
    \ vector<ll>(c, 0));\n        rep(i, r) rep(j, c) cin >> grid[i][j]; \n\n    \
    \    using S = ll;\n        auto op = [](S a, S b) { return min(a, b); };\n  \
    \      auto e = []() { return inf64; };\n        using F = ll;\n        auto mapping\
    \ = [](S a, F f) { return f; };\n        \n        SegmentTree2D<S, op, e, F,\
    \ mapping> tree(grid);\n\n        while (q--) {\n            ll r1, c1, r2, c2;\n\
    \            cin >> r1 >> c1 >> r2 >> c2;\n            ++r2, ++c2;\n\n       \
  ...
  verifiedWith: []
documentation_of: test/structure/segment-tree-2d-abstract/aoj-1068.test.cpp
layout: document
redirect_from:
- /verify/test/structure/segment-tree-2d-abstract/aoj-1068.test.cpp
- /verify/test/structure/segment-tree-2d-abstract/aoj-1068.test.cpp.html

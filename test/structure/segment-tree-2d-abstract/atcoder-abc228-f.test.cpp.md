...
data:
  ...
  bundledCode: "#line 1 \"test/structure/segment-tree-2d-abstract/atcoder-abc228-f.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"other/cumulative-sum-2d.cpp\"\n\ntemplate <typename\
    \ T>\nstruct CumulativeSum2D {\n    long long H, W;\n    vector<vector<T>> values,\
    \ sums;\n    bool built = false;\n\n    CumulativeSum2D(long long h, long long\
    \ w) : H(h), W(w), values(H, vector<T>(W, 0)), sums(H + 1, vector<T>(W + 1, 0))\
    \ {}\n    CumulativeSum2D(long long h, long long w, T a) : H(h), W(w), values(H,\
    \ vector<T>(W, a)), sums(H + 1, vector<T>(W + 1, 0)) {}\n\n    CumulativeSum2D(const\
    \ vector<vector<T>>& A) : H(A.size()), W(A.front().size()), values(A), sums(H\
    \ + 1, vector<T>(W + 1, 0)) {\n        build(A);\n    };\n\n    void add(long\
    \ long y, long long x, T a) {\n        assert(0 <= y and y < H);\n        assert(0\
    \ <= x and x < W);\n        assert(not built);\n        values[y][x] += a;\n \
    \   }\n\n    void build() {\n        assert(not built);\n        built = true;\n\
    ...
    \        }\n\n        return os;\n    }\n};\n#line 3 \"structure/segment-tree-2d-abstract.cpp\"\
    ...
    \ W, _W;\n    vector<S> node;\n\n    SegmentTree2D(long long h, long long w) :\
    \ _H(h), _W(w) {\n        init();\n        build(vector<vector<S>>(h, vector<S>(w,\
    \ e())));\n    }\n\n    SegmentTree2D(long long h, long long w, S a) : _H(h),\
    ...
    \ {\n        rep(i, seg._H) {\n            rep(j, seg._W) {\n                os\
    \ << seg.get(i, j) << \" \";\n            }\n            os << endl;\n       \
    \ }\n\n        return os;\n    }\n\nprivate:\n    long long id(long long y, long\
    \ long x) {\n        return y * 2 * W + x;\n    }\n\n    // (y, x)\u306E\u30CE\
    \u30FC\u30C9\u306E\u5024\u3092\u5B50\u306E\u5024\u3067\u66F4\u65B0\n    void update(long\
    \ long y, long long x) {\n        y += H, x += W;\n\n        for (long long i\
    \ = y >> 1; i > 0; i >>= 1) {\n            node[id(i, x)] = op(node[id(i * 2,\
    \ x)], node[id(i * 2 + 1, x)]);\n        }\n\n        for (long long i = y; i\
    \ > 0; i >>= 1) {\n            for (long long j = x >> 1; j > 0; j >>= 1) {\n\
    \                node[id(i, j)] = op(node[id(i, j * 2)], node[id(i, j * 2 + 1)]);\n\
    \            }\n        }\n    }\n\n    S prod(long long i, long long j1, long\
    \ long j2) {\n        S sml = e(), smr = e();\n        for (long long l = j1,\
    \ r = j2; l < r; l >>= 1, r >>= 1) {\n            if (l & 1) sml = op(sml, node[id(i,\
    \ l++)]);\n            if (r & 1) smr = op(node[id(i, --r)], smr);\n        }\n\
    \n        return op(sml, smr);\n    }\n};\n#line 7 \"test/structure/segment-tree-2d-abstract/atcoder-abc228-f.test.cpp\"\
    \n\nint main() {\n    ll H, W, h1, w1, h2, w2;\n    cin >> H >> W >> h1 >> w1\
    ...
    \ j, i + h1, j + w1) - seg.prod(i, j, i + h1 - h2 + 1, j + w1 - w2 + 1);\n\n \
    \       chmax(ans, ans_i);\n    }\n\n    cout << ans << endl;\n\n    return 0;\n\
    } \n"
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/abc228/tasks/abc228_f\"\
  ...
  verifiedWith: []
documentation_of: test/structure/segment-tree-2d-abstract/atcoder-abc228-f.test.cpp
layout: document
redirect_from:
- /verify/test/structure/segment-tree-2d-abstract/atcoder-abc228-f.test.cpp
- /verify/test/structure/segment-tree-2d-abstract/atcoder-abc228-f.test.cpp.html

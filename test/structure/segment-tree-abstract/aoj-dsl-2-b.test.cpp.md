...
data:
  ...
  bundledCode: "#line 1 \"test/structure/segment-tree-abstract/aoj-dsl-2-b.test.cpp\"\
    ...
    };\n#line 4 \"test/structure/segment-tree-abstract/aoj-dsl-2-b.test.cpp\"\n\n\
    int main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    auto\
    \ op = [](S a, S b) { return a + b; };\n    auto e = []() { return 0; };\n   \
    \ using F = ll;\n    auto mapping = [](S a, F b) { return a + b; };\n\n    SegmentTree<S,\
    \ op, e, F, mapping> tree(n, 0);\n    while (q--) {\n        ll t;\n        cin\
    \ >> t;\n\n        if (t == 0) {\n            ll x, y;\n            cin >> x >>\
    \ y;\n            tree.apply(x - 1, y);\n        }\n        else {\n         \
    \   ll x, y;\n            cin >> x >> y;\n            cout << tree.prod(x - 1,\
    \ y) << endl;\n        }\n    }\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_B&\"\
    ...
    \ S b) { return a + b; };\n    auto e = []() { return 0; };\n    using F = ll;\n\
    \    auto mapping = [](S a, F b) { return a + b; };\n\n    SegmentTree<S, op,\
    \ e, F, mapping> tree(n, 0);\n    while (q--) {\n        ll t;\n        cin >>\
    \ t;\n\n        if (t == 0) {\n            ll x, y;\n            cin >> x >> y;\n\
    \            tree.apply(x - 1, y);\n        }\n        else {\n            ll\
    \ x, y;\n            cin >> x >> y;\n            cout << tree.prod(x - 1, y) <<\
    \ endl;\n        }\n    }\n\n    return 0;\n}"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2025-11-16 18:15:00+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/structure/segment-tree-abstract/aoj-dsl-2-b.test.cpp
layout: document
redirect_from:
- /verify/test/structure/segment-tree-abstract/aoj-dsl-2-b.test.cpp
- /verify/test/structure/segment-tree-abstract/aoj-dsl-2-b.test.cpp.html

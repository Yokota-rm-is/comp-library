...
data:
  ...
  bundledCode: "#line 1 \"test/structure/segment-tree-abstract/aoj-dsl-2-a.test.cpp\"\
    ...
    };\n#line 4 \"test/structure/segment-tree-abstract/aoj-dsl-2-a.test.cpp\"\n\n\
    int main() {\n    ll n, q;\n    cin >> n >> q;\n\n    using S = ll;\n    auto\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_A&\"\
    ...
    \ S b) { return min(a, b); };\n    auto e = []() { return inf64; };\n    using\
    \ F = ll;\n    auto mapping = [](S a, F b) { return b; };\n\n    SegmentTree<S,\
    \ op, e, F, mapping> tree(n, (1ll << 31) - 1);\n    while (q--) {\n        ll\
    \ t;\n        cin >> t;\n\n        if (t == 0) {\n            ll x, y;\n     \
    \       cin >> x >> y;\n            tree.apply(x, y);\n        }\n        else\
    \ {\n            ll x, y;\n            cin >> x >> y;\n            cout << tree.prod(x,\
    \ y + 1) << endl;\n        }\n    }\n\n    return 0;\n}"
  ...
  verifiedWith: []
documentation_of: test/structure/segment-tree-abstract/aoj-dsl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/structure/segment-tree-abstract/aoj-dsl-2-a.test.cpp
- /verify/test/structure/segment-tree-abstract/aoj-dsl-2-a.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/structure/sqrt-decomposition-plain/aoj-dsl-2-i.test.cpp\"\
    ...
    \ {\n                    chmax(ret, data[i]);\n                }\n           \
    \     update(k);\n            }\n        }\n\n        return ret;\n    }\n};\n\
    #line 4 \"test/structure/sqrt-decomposition-plain/aoj-dsl-2-i.test.cpp\"\n\nint\
    \ main() {\n    ll n, q;\n    cin >> n >> q;\n\n    SqrtDecomposition<ll, ll>\
    \ sd(n, 0);\n    while (q--) {\n        ll t;\n        cin >> t;\n\n        if\
    \ (t == 0) {\n            ll s, t, x;\n            cin >> s >> t >> x;\n     \
    \       sd.apply_set(s, t + 1, x);\n        }\n        else {\n            ll\
    \ s, t;\n            cin >> s >> t;\n            cout << sd.prod_sum(s, t + 1)\
    \ << endl;\n        }\n    }\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/structure/sqrt-decomposition-plain/aoj-dsl-2-i.test.cpp
layout: document
redirect_from:
- /verify/test/structure/sqrt-decomposition-plain/aoj-dsl-2-i.test.cpp
- /verify/test/structure/sqrt-decomposition-plain/aoj-dsl-2-i.test.cpp.html

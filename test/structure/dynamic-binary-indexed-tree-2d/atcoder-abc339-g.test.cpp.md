...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dynamic-binary-indexed-tree-2d/atcoder-abc339-g.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/structure/dynamic-binary-indexed-tree-2d/atcoder-abc339-g.test.cpp
- /verify/test/structure/dynamic-binary-indexed-tree-2d/atcoder-abc339-g.test.cpp.html

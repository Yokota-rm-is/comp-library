...
data:
  ...
  bundledCode: "#line 1 \"test/structure/dynamic-binary-indexed-tree/yukicoder-789.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"structure/dynamic-binary-indexed-tree.cpp\"\n\
    \ntemplate<class T = long long>\nstruct DynamicBinaryIndexedTree {\n    long long\
    \ N, _N;\n    map<long long, T> bit;\n\n    DynamicBinaryIndexedTree(long long\
    \ n): _N(n) {\n        init();\n    }\n\n    void init() {\n        N = _N + 1;\n\
    ...
    \        // os << \"bit\" << endl;\n        // repd(h, bit.height) {\n       \
    \ //     for (long long i = (1 << h); i < (long long)bit.bit.size(); i += (1 <<\
    \ (h + 1))) {\n        //         os << bit.bit[i] << \" \";\n        //     }\n\
    \        //     os << endl;\n        // }\n        // os << endl;\n\n        os\
    \ << \"value\" << endl;\n        rep(i, bit._N) {\n            os << bit.get(i)\
    \ << \" \";\n        }\n        os << endl;\n\n        return os;\n    }\n};\n\
    #line 4 \"test/structure/dynamic-binary-indexed-tree/yukicoder-789.test.cpp\"\n\
    \nint main() {\n    ll n;\n    cin >> n;\n\n    DynamicBinaryIndexedTree<ll> bit(1e9\
    \ + 1);\n\n    ll ans = 0;\n\n    while (n--) {\n        ll t;\n        cin >>\
    \ t;\n\n        if (t == 0) {\n            ll x, y;\n            cin >> x >> y;\n\
    \n            bit.add(x, y);\n        }\n        else {\n            ll l, r;\n\
    \            cin >> l >> r;\n\n            ans += bit.sum(l, r + 1);\n       \
  ...
  requiredBy: []
  timestamp: '2024-08-17 04:56:30+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/structure/dynamic-binary-indexed-tree/yukicoder-789.test.cpp
layout: document
redirect_from:
- /verify/test/structure/dynamic-binary-indexed-tree/yukicoder-789.test.cpp
- /verify/test/structure/dynamic-binary-indexed-tree/yukicoder-789.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/base/atcoder-abc109-c.test.cpp\"\n#define PROBLEM \"\
    https://atcoder.jp/contests/abc109/tasks/abc109_c\"\n\n#line 2 \"base.cpp\"\n\n\
    ...
    \    return result;\n}\n#line 4 \"test/base/atcoder-abc109-c.test.cpp\"\n\nint\
    \ main() {\n    ll N, X;\n    cin >> N >> X;\n\n    vll x(N);\n    rep(i, N) cin\
    \ >> x[i];\n    \n    vll L, R;\n    rep(i, N) {\n        if (x[i] > X) R.push_back(x[i]\
    \ - X);\n        else L.push_back(X - x[i]);\n    }\n\n    ll ans = gcd(gcd(L),\
    \ gcd(R));\n\n    cout << ans << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc109/tasks/abc109_c\"\n\n\
    #include \"../../base.cpp\"\n\nint main() {\n    ll N, X;\n    cin >> N >> X;\n\
    \n    vll x(N);\n    rep(i, N) cin >> x[i];\n    \n    vll L, R;\n    rep(i, N)\
  ...
  verifiedWith: []
documentation_of: test/base/atcoder-abc109-c.test.cpp
layout: document
redirect_from:
- /verify/test/base/atcoder-abc109-c.test.cpp
- /verify/test/base/atcoder-abc109-c.test.cpp.html

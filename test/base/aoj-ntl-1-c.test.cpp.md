...
data:
  ...
  bundledCode: "#line 1 \"test/base/aoj-ntl-1-c.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_C&\"\
    ...
    \ }\n#endif\n#line 4 \"test/base/aoj-ntl-1-c.test.cpp\"\n\nint main() {\n    ll\
    \ n;\n    cin >> n;\n\n    vll A(n);\n    rep(i, n) cin >> A[i];\n\n    cout <<\
    \ lcm(A) << endl;\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/base/aoj-ntl-1-c.test.cpp
layout: document
redirect_from:
- /verify/test/base/aoj-ntl-1-c.test.cpp
- /verify/test/base/aoj-ntl-1-c.test.cpp.html

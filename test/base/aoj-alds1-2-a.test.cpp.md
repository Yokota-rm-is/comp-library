...
data:
  ...
  bundledCode: "#line 1 \"test/base/aoj-alds1-2-a.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_2_A&\"\
    ...
    \    return result;\n}\n#line 4 \"test/base/aoj-alds1-2-a.test.cpp\"\n\nint main()\
    \ {\n    ll n;\n    cin >> n;\n\n    vll A(n);\n    rep(i, n) cin >> A[i];\n\n\
  ...
  verifiedWith: []
documentation_of: test/base/aoj-alds1-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/base/aoj-alds1-2-a.test.cpp
- /verify/test/base/aoj-alds1-2-a.test.cpp.html

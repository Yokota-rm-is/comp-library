...
data:
  ...
  bundledCode: "#line 1 \"test/base/aoj-ntl-1-e.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_E&\"\
    ...
    \ --it;}\n#line 4 \"test/base/aoj-ntl-1-e.test.cpp\"\n\nint main() {\n    ll a,\
  ...
  verifiedWith: []
documentation_of: test/base/aoj-ntl-1-e.test.cpp
layout: document
redirect_from:
- /verify/test/base/aoj-ntl-1-e.test.cpp
- /verify/test/base/aoj-ntl-1-e.test.cpp.html

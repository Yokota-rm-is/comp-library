...
data:
  ...
  bundledCode: "#line 1 \"test/tree/euler-tour-path-query-with-segment-tree/yosupo-lowest-common-ancestor.test.cpp\"\
    ...
    \   }\n};\n#line 4 \"test/tree/euler-tour-path-query-with-segment-tree/yosupo-lowest-common-ancestor.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    using S = ll;\n    auto\
  ...
  verifiedWith: []
documentation_of: test/tree/euler-tour-path-query-with-segment-tree/yosupo-lowest-common-ancestor.test.cpp
layout: document
redirect_from:
- /verify/test/tree/euler-tour-path-query-with-segment-tree/yosupo-lowest-common-ancestor.test.cpp
- /verify/test/tree/euler-tour-path-query-with-segment-tree/yosupo-lowest-common-ancestor.test.cpp.html

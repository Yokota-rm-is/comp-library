...
data:
  ...
  bundledCode: "#line 1 \"test/tree/euler-tour-tree/yosupo-vertex-add-subtree-sum.test.cpp\"\
    ...
    \ 4 \"test/tree/euler-tour-tree/yosupo-vertex-add-subtree-sum.test.cpp\"\n\nint\
    \ main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i, N) {\n\
  ...
  verifiedWith: []
documentation_of: test/tree/euler-tour-tree/yosupo-vertex-add-subtree-sum.test.cpp
layout: document
redirect_from:
- /verify/test/tree/euler-tour-tree/yosupo-vertex-add-subtree-sum.test.cpp
- /verify/test/tree/euler-tour-tree/yosupo-vertex-add-subtree-sum.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/euler-tour-subtree-query-with-segment-tree/atcoder-abc406-f.test.cpp\"\
    ...
    \   post_order[v] = time;\n    }\n};\n#line 6 \"test/tree/euler-tour-subtree-query-with-segment-tree/atcoder-abc406-f.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll U(N), V(N);\n    rep(i,\
    \ N - 1) cin >> U[i] >> V[i];\n    --U, --V;\n\n    using S = ll;\n    auto op\
    \ = [](S a, S b) { return a + b; };\n    auto e = []() { return 0; };\n    using\
    ...
    \ w);\n            W += w;\n        }\n        else {\n            ll y;\n   \
    \         cin >> y;\n            --y;\n\n            ll u = U[y], v = V[y];\n\
    \            \n            ll x;\n            if (tree.pre_order[u] < tree.pre_order[v])\
    \ x = v;\n            else x = u;\n\n            ll w1 = tree.prod(x);\n     \
    \       ll w2 = W - w1;\n            ll ans = w1 - w2;\n            \n       \
    \     if (ans < 0) ans *= -1;\n            cout << ans << endl;\n        }\n \
    \   }\n    return 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/tree/euler-tour-subtree-query-with-segment-tree/atcoder-abc406-f.test.cpp
layout: document
redirect_from:
- /verify/test/tree/euler-tour-subtree-query-with-segment-tree/atcoder-abc406-f.test.cpp
- /verify/test/tree/euler-tour-subtree-query-with-segment-tree/atcoder-abc406-f.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/euler-tour-subtree-query-with-segment-tree/yosupo-vertex-add-subtree-sum.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"tree/euler-tour-subtree-query-with-segment-tree.cpp\"\
    ...
    \        long long from;\n        long long to;\n        long long idx;\n    \
    \    \n        explicit Edge(long long u = -1, long long v = -1, long long i =\
    ...
    \ = op(node[k * 2], node[k * 2 + 1]);\n        }\n    };\n\n    using pll = pair<long\
    \ long, long long>;\n\n    long long V;\n    vector<vector<Edge>> G;\n    vector<bool>\
    \ seen;\n\n    vector<S> weights;\n\n    long long time;\n    vector<long long>\
    \ pre_order, post_order;\n\n    long long edge_index;\n    bool built = false;\n\
    \n    SegmentTree seg;\n\n    EulerTourSubtree(long long N) : V(N), G(V), seg(2\
    \ * V - 1) {\n        init();\n    };\n\n    void init() {\n        time = 0;\n\
    \        seen.assign(V, false);\n\n        weights.resize(2 * V - 1, e());\n \
    \       pre_order.assign(2 * V - 1, -1);\n        post_order.assign(2 * V - 1,\
    \ -1);\n\n        edge_index = 0;\n    }\n\n    void connect(long long from, long\
    \ long to) {\n        connect(from, to, e());\n    }\n\n    void connect(long\
    \ long from, long long to, S weight) {\n        assert(0 <= from and from < V);\n\
    ...
    \   post_order[v] = time;\n    }\n};\n#line 4 \"test/tree/euler-tour-subtree-query-with-segment-tree/yosupo-vertex-add-subtree-sum.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    using S = ll;\n    auto\
    \ op = [](S x, S y) { return x + y; };\n    auto e = []() { return 0ll; };\n \
    \   using F = ll;\n    auto mapping = [](S x, F y) { return x + y; };\n\n    EulerTourSubtree<S,\
    \ op, e, F, mapping> tree(N);\n\n    vll a(N);\n    rep(i, N) {\n        cin >>\
    \ a[i];\n    }\n\n    vll p(N - 1);\n    rep(i, N - 1) {\n        cin >> p[i];\n\
    \    \n        tree.connect(i + 1, p[i]);\n    }\n\n    rep(i, N) {\n        tree.set_vertex_weight(i,\
    \ a[i]);\n    }\n\n    tree.build(0);\n\n    while (Q--) {\n        ll t;\n  \
    \      cin >> t;\n\n        if (t == 0) {\n            ll u, x;\n            cin\
  ...
  requiredBy: []
  timestamp: '2025-11-16 20:41:19+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/tree/euler-tour-subtree-query-with-segment-tree/yosupo-vertex-add-subtree-sum.test.cpp
layout: document
redirect_from:
- /verify/test/tree/euler-tour-subtree-query-with-segment-tree/yosupo-vertex-add-subtree-sum.test.cpp
- /verify/test/tree/euler-tour-subtree-query-with-segment-tree/yosupo-vertex-add-subtree-sum.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-bfs/aoj-grl-5-a.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_5_A&\"\n\n#line\
    ...
    */\ntemplate <typename T = long long>\nstruct TreeBFS {\n    struct Edge {\n \
    ...
    \ 4 \"test/tree/tree-bfs/aoj-grl-5-a.test.cpp\"\n\nint main() {\n    ll n;\n \
    \   cin >> n;\n\n    TreeBFS tree(n);\n    rep(i, n - 1) {\n        ll s, t, w;\n\
    \        cin >> s >> t >> w;\n\n        tree.connect(s, t, w);\n    }\n\n    cout\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-bfs/aoj-grl-5-a.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-bfs/aoj-grl-5-a.test.cpp
- /verify/test/tree/tree-bfs/aoj-grl-5-a.test.cpp.html

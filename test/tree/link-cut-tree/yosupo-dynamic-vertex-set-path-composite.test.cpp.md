...
data:
  ...
  bundledCode: "#line 1 \"test/tree/link-cut-tree/yosupo-dynamic-vertex-set-path-composite.test.cpp\"\
    ...
    #line 5 \"test/tree/link-cut-tree/yosupo-dynamic-vertex-set-path-composite.test.cpp\"\
    \nusing mint = mint998;\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n\
    \    vll a(N), b(N);\n    rep(i, N) {\n        cin >> a[i] >> b[i];\n    }\n\n\
    \    using S = pair<mint, mint>;\n    auto op = [](S a, S b) { return S(b.first\
    \ * a.first, b.first * a.second + b.second); };\n    auto e = []() { return S(1,\
    \ 0); };\n    using F = pair<mint, mint>;\n    auto mapping = [](S a, F f) { return\
    \ f; };\n    auto composition = [](F f1, F f2) { \n        if (f2.first == 0)\
    \ return f1;\n        return f2; \n    };\n    auto id = []() { return F(0, 0);\
    \ };\n    LinkCutTree<S, op, e, F, mapping, composition, id> tree;\n\n    using\
    \ Node = LinkCutTree<S, op, e, F, mapping, composition, id>::Node;\n    vector<Node*>\
  ...
  verifiedWith: []
documentation_of: test/tree/link-cut-tree/yosupo-dynamic-vertex-set-path-composite.test.cpp
layout: document
redirect_from:
- /verify/test/tree/link-cut-tree/yosupo-dynamic-vertex-set-path-composite.test.cpp
- /verify/test/tree/link-cut-tree/yosupo-dynamic-vertex-set-path-composite.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/link-cut-tree/yosupo-vertex-add-path-sum.test.cpp\"\
    ...
    \     evert(x);\n        expose(y);\n        return y->prod;\n    }\n};\n#line\
    \ 4 \"test/tree/link-cut-tree/yosupo-vertex-add-path-sum.test.cpp\"\n\nint main()\
    \ {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i, N) {\n    \
    \    cin >> a[i];\n    }\n\n    using S = ll;\n    auto op = [](S a, S b) { return\
    \ a + b; };\n    auto e = []() { return 0LL; };\n    using F = ll;\n    auto mapping\
    \ = [](S a, F f) { return a + f; };\n    auto composition = [](F f1, F f2) { return\
    \ f1 + f2; };\n    auto id = []() { return F(0); };\n    LinkCutTree<S, op, e,\
    \ F, mapping, composition, id> tree;\n\n    using Node = LinkCutTree<S, op, e,\
    \ F, mapping, composition, id>::Node;\n    vector<Node*> nodes(N);\n    rep(i,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/vertex_add_path_sum\"\n\
    ...
    \   auto e = []() { return 0LL; };\n    using F = ll;\n    auto mapping = [](S\
    \ a, F f) { return a + f; };\n    auto composition = [](F f1, F f2) { return f1\
    \ + f2; };\n    auto id = []() { return F(0); };\n    LinkCutTree<S, op, e, F,\
    \ mapping, composition, id> tree;\n\n    using Node = LinkCutTree<S, op, e, F,\
    \ mapping, composition, id>::Node;\n    vector<Node*> nodes(N);\n    rep(i, N)\
    \ {\n        nodes[i] = tree.make_node(i, a[i]);\n    }\n\n    rep(i, N - 1) {\n\
    \        ll u, v;\n        cin >> u >> v;\n        tree.link(nodes[u], nodes[v]);\n\
    \    }\n\n    while (Q--) {\n        ll t;\n        cin >> t;\n\n        if (t\
    \ == 0) {\n            ll p, x;\n            cin >> p >> x;\n            tree.apply(nodes[p],\
  ...
  verifiedWith: []
documentation_of: test/tree/link-cut-tree/yosupo-vertex-add-path-sum.test.cpp
layout: document
redirect_from:
- /verify/test/tree/link-cut-tree/yosupo-vertex-add-path-sum.test.cpp
- /verify/test/tree/link-cut-tree/yosupo-vertex-add-path-sum.test.cpp.html

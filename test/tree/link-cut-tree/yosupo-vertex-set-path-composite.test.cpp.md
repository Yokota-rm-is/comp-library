...
data:
  ...
  bundledCode: "#line 1 \"test/tree/link-cut-tree/yosupo-vertex-set-path-composite.test.cpp\"\
    ...
    #line 5 \"test/tree/link-cut-tree/yosupo-vertex-set-path-composite.test.cpp\"\n\
    using mint = mint998;\n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n  \
    \  vll a(N), b(N);\n    rep(i, N) {\n        cin >> a[i] >> b[i];\n    }\n\n \
  ...
  verifiedWith: []
documentation_of: test/tree/link-cut-tree/yosupo-vertex-set-path-composite.test.cpp
layout: document
redirect_from:
- /verify/test/tree/link-cut-tree/yosupo-vertex-set-path-composite.test.cpp
- /verify/test/tree/link-cut-tree/yosupo-vertex-set-path-composite.test.cpp.html

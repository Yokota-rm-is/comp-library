...
data:
  ...
  bundledCode: "#line 1 \"test/tree/link-cut-tree/yosupo-lowest-common-ancestor.test.cpp\"\
  ...
  code: "#define IGNORE\n#define PROBLEM \"https://judge.yosupo.jp/problem/lca\"\n\
    ...
    \n    rep(i, 1, N) {\n        ll p;\n        cin >> p;\n        tree.link(nodes[i],\
    \ nodes[p]);\n    }\n\n    tree.evert(nodes[0]);\n\n    while (Q--) {\n      \
    \  ll u, v;\n        cin >> u >> v;\n\n        cout << tree.lca(nodes[u], nodes[v])->idx\
    \ << endl;\n    }\n\n    return 0;\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/tree/link-cut-tree/yosupo-lowest-common-ancestor.test.cpp
layout: document
redirect_from:
- /verify/test/tree/link-cut-tree/yosupo-lowest-common-ancestor.test.cpp
- /verify/test/tree/link-cut-tree/yosupo-lowest-common-ancestor.test.cpp.html

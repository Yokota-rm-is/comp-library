...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dp/atcoder-abc220-f.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc220/tasks/abc220_f\"\n\n#line 2 \"base.cpp\"\
    ...
    \ edge);\n        }\n    }\n};\n#line 4 \"test/tree/tree-dp/atcoder-abc220-f.test.cpp\"\
    \n\n\nint main() {\n    ll n;\n    cin >> n;\n\n    TreeDP<ll, ll, ll, None, AddVTimes,\
    \ Sum> tree(n);\n    rep(i, n - 1) {\n        ll s, t;\n        cin >> s >> t;\n\
    \        --s; --t;\n\n        tree.connect(s, t, 1);\n    }\n\n    tree.build(0);\n\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dp/atcoder-abc220-f.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dp/atcoder-abc220-f.test.cpp
- /verify/test/tree/tree-dp/atcoder-abc220-f.test.cpp.html

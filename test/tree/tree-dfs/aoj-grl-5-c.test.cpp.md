...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dfs/aoj-grl-5-c.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_5_C\"\n\n#line\
    ...
    \n        return {A, edges};\n    }\n};\n#line 4 \"test/tree/tree-dfs/aoj-grl-5-c.test.cpp\"\
    \n\nint main() {\n    ll n;\n    cin >> n;\n    \n    TreeDFS<> tree(n);\n\n \
    \   rep(i, n) {\n        ll k;\n        cin >> k;\n        \n        rep(j, k)\
    \ {\n            ll c;\n            cin >> c;\n\n            tree.connect(i, c);\n\
    \        }\n    }\n\n    tree.build(0);\n\n    ll q;\n    cin >> q;\n\n    while\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dfs/aoj-grl-5-c.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dfs/aoj-grl-5-c.test.cpp
- /verify/test/tree/tree-dfs/aoj-grl-5-c.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dfs/yosupo-lowest-common-ancestor.test.cpp\"\
    ...
    \n        return {A, edges};\n    }\n};\n#line 4 \"test/tree/tree-dfs/yosupo-lowest-common-ancestor.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n    \n    TreeDFS<ll> tree(N);\n\
    \n    rep(i, 1, N) {\n        ll p;\n        cin >> p;\n        tree.connect(p,\
    \ i);\n    }\n\n    tree.build(0);\n\n    while (Q--) {\n        ll u, v;\n  \
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dfs/yosupo-lowest-common-ancestor.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dfs/yosupo-lowest-common-ancestor.test.cpp
- /verify/test/tree/tree-dfs/yosupo-lowest-common-ancestor.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dfs/atcoder-abc202-e.test.cpp\"\n#define\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dfs/atcoder-abc202-e.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dfs/atcoder-abc202-e.test.cpp
- /verify/test/tree/tree-dfs/atcoder-abc202-e.test.cpp.html

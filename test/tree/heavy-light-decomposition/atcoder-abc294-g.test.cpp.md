...
data:
  ...
  bundledCode: "#line 1 \"test/tree/heavy-light-decomposition/atcoder-abc294-g.test.cpp\"\
    ...
    \ l, -x * l);\n        add(bit0, r, x * r);\n        add(bit1, l, x);\n      \
    \  add(bit1, r, -x);\n    }\n\n    // \u534A\u958B\u533A\u9593[l, l+1, l+2, ...,\
    \ r) (0-indexed)\u306B[al, al+d, al+2d, ..., al+d(r-l))\u3092\u52A0\u3048\u308B\
    \n    void add(long long l, long long r, T al, T d) {\n        assert(0 <= l and\
    \ l <= r and r <= _N);\n        if (l == r) return;\n\n        add(bit0, l, d\
    \ * l * l + d * l - 2 * al * l);\n        add(bit0, r, d * r * r + (2 * al - 2\
    ...
    \        assert(0 <= l and l <= _N and 0 <= r and r <= 2 * _N);\n        if (l\
    \ <= r and r <= _N) return sum(l, r);\n        \n        if (r > _N) r -= _N;\n\
    \        \n        return sum(l, _N) + sum(0, r);\n    }\n\n    // \u534A\u958B\
    \u533A\u9593[p, p + 1) (0-indexed)\u306E\u5024\u3092\u6C42\u3081\u308B\n    T\
    \ get(long long p) {\n        assert(0 <= p and p < _N);\n        \n        return\
    \ sum(p + 1) - sum(p);\n    }\n\n    // \u534A\u958B\u533A\u9593[0, r) (0-indexed)\u306E\
    \u7DCF\u548C\u304Cx\u4EE5\u4E0A\u3068\u306A\u308B\u6700\u5C0F\u306Er\u3092\u6C42\
    \u3081\u308B\n    long long lower_bound(T x) {\n        assert(x >= 0);\n\n  \
    \      ll right = 0;\n        T sum0 = 0, sum1 = 0, sum2 = 0;\n\n        for (long\
    \ long len = N; len > 0; len >>= 1) {\n            ll idx = right + len;\n   \
    \         if (idx < _N && sum0 + bit0[idx] + (sum1 + bit1[idx]) * idx + (sum2\
    \ + bit2[idx]) * idx * idx < x * 2) {\n                right += len;\n       \
    \         sum0 += bit0[right];\n                sum1 += bit1[right];\n       \
    \         sum2 += bit2[right];\n            }\n        }\n\n        return right\
    ...
    \ = 0;\n        T sum0 = 0, sum1 = 0, sum2 = 0;\n\n        for (long long len\
    \ = N; len > 0; len >>= 1) {\n            ll idx = right + len;\n            if\
    \ (idx < _N && sum0 + bit0[idx] + (sum1 + bit1[idx]) * idx + (sum2 + bit2[idx])\
    \ * idx * idx <= x * 2) {\n                right += len;\n                sum0\
    \ += bit0[right];\n                sum1 += bit1[right];\n                sum2\
    \ += bit2[right];\n            }\n        }\n\n        return right + 1;\n   \
    \ }\n\n    // \u534A\u958B\u533A\u9593[l, r) (0-indexed)\u306E\u7DCF\u548C\u304C\
    x\u4EE5\u4E0A\u3068\u306A\u308B\u6700\u5C0F\u306Er\u3092\u6C42\u3081\u308B\n \
    ...
    \ = true;\n        break;\n    }\n\n    return ret;\n}\n#line 7 \"test/tree/heavy-light-decomposition/atcoder-abc294-g.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll U(N - 1), V(N - 1), W(N\
    \ - 1);\n    rep(i, N - 1) {\n        cin >> U[i] >> V[i] >> W[i];\n    }\n  \
    \  --U, --V;\n\n    HeavyLightDecomposition hld(N);\n    rep(i, N - 1) {\n   \
    \     hld.connect(U[i], V[i]);\n    }\n\n    hld.build(0);\n\n    BinaryIndexedTree<ll>\
    \ bit(N * 2 - 1);\n    rep(i, N - 1) {\n        bit.add(hld.get_edge_index(i),\
    \ W[i]);\n    }\n\n    ll Q;\n    cin >> Q;\n\n    while (Q--) {\n        ll t;\n\
    \        cin >> t;\n\n        if (t == 1) {\n            ll i, w;\n          \
    \  cin >> i >> w;\n\n            --i;\n            bit.set(hld.get_edge_index(i),\
    \ w);\n        }\n        else {\n            ll u, v;\n            cin >> u >>\
    \ v;\n            --u, --v;\n\n            ll ans = 0;\n            auto prod\
    \ = [&](ll l, ll r) {\n                if (l > r) swap(l, r);\n              \
  ...
  verifiedWith: []
documentation_of: test/tree/heavy-light-decomposition/atcoder-abc294-g.test.cpp
layout: document
redirect_from:
- /verify/test/tree/heavy-light-decomposition/atcoder-abc294-g.test.cpp
- /verify/test/tree/heavy-light-decomposition/atcoder-abc294-g.test.cpp.html

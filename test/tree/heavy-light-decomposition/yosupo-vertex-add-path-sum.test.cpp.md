...
data:
  ...
  bundledCode: "#line 1 \"test/tree/heavy-light-decomposition/yosupo-vertex-add-path-sum.test.cpp\"\
    ...
    \ = true;\n        break;\n    }\n\n    return ret;\n}\n#line 5 \"test/tree/heavy-light-decomposition/yosupo-vertex-add-path-sum.test.cpp\"\
    ...
    \    while (Q--) {\n        ll t;\n        cin >> t;\n\n        if (t == 0) {\n\
    \            ll p, x;\n            cin >> p >> x;\n            bit.add(hld.get_vertex_index(p),\
    \ x);\n        }\n        else {\n            ll u, v;\n            cin >> u >>\
    \ v;\n\n            ll ans = 0;\n            auto prod = [&](ll l, ll r) {\n \
    \               if (l > r) swap(l, r);\n                ans += bit.sum(l, r);\n\
  ...
  verifiedWith: []
documentation_of: test/tree/heavy-light-decomposition/yosupo-vertex-add-path-sum.test.cpp
layout: document
redirect_from:
- /verify/test/tree/heavy-light-decomposition/yosupo-vertex-add-path-sum.test.cpp
- /verify/test/tree/heavy-light-decomposition/yosupo-vertex-add-path-sum.test.cpp.html

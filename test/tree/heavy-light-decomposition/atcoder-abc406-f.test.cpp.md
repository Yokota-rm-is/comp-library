...
data:
  ...
  bundledCode: "#line 1 \"test/tree/heavy-light-decomposition/atcoder-abc406-f.test.cpp\"\
    ...
    \ = true;\n        break;\n    }\n\n    return ret;\n}\n#line 7 \"test/tree/heavy-light-decomposition/atcoder-abc406-f.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll U(N - 1), V(N - 1);\n\n\
    \    rep(i, N - 1) {\n        cin >> U[i] >> V[i];\n    }\n    --U, --V;\n\n \
    ...
    \    }\n\n    ll W = N;\n    \n    ll Q;\n    cin >> Q;\n\n    while (Q--) {\n\
    \        ll t;\n        cin >> t;\n\n        if (t == 1) {\n            ll x,\
    \ w;\n            cin >> x >> w;\n            --x;\n\n            bit.add(hld.get_vertex_index(x),\
    \ w);\n            W += w;\n        }\n        else {\n            ll y;\n   \
    \         cin >> y;\n            --y;\n\n            ll w1 = 0;\n            auto\
    \ prod = [&](ll l, ll r) {\n                w1 += bit.sum(l, r);\n           \
  ...
  verifiedWith: []
documentation_of: test/tree/heavy-light-decomposition/atcoder-abc406-f.test.cpp
layout: document
redirect_from:
- /verify/test/tree/heavy-light-decomposition/atcoder-abc406-f.test.cpp
- /verify/test/tree/heavy-light-decomposition/atcoder-abc406-f.test.cpp.html

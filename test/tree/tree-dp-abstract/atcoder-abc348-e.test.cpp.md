...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dp-abstract/atcoder-abc348-e.test.cpp\"\n\
    ...
    \ 0; }, F, put_vertex, id>;\n#line 4 \"test/tree/tree-dp-abstract/atcoder-abc348-e.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    struct S {\n        ll prod;\n\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dp-abstract/atcoder-abc348-e.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dp-abstract/atcoder-abc348-e.test.cpp
- /verify/test/tree/tree-dp-abstract/atcoder-abc348-e.test.cpp.html

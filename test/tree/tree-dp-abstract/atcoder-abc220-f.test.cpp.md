...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dp-abstract/atcoder-abc220-f.test.cpp\"\n\
    ...
    \ 0; }, F, put_vertex, id>;\n#line 4 \"test/tree/tree-dp-abstract/atcoder-abc220-f.test.cpp\"\
    \n\n\nint main() {\n    ll N;\n    cin >> N;\n\n    struct S {\n        ll prod;\n\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dp-abstract/atcoder-abc220-f.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dp-abstract/atcoder-abc220-f.test.cpp
- /verify/test/tree/tree-dp-abstract/atcoder-abc220-f.test.cpp.html

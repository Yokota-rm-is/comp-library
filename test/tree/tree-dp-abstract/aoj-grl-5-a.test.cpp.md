...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dp-abstract/aoj-grl-5-a.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_5_A&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ 0; }, F, put_vertex, id>;\n#line 4 \"test/tree/tree-dp-abstract/aoj-grl-5-a.test.cpp\"\
    \n\nint main() {\n    ll n;\n    cin >> n;\n\n    using S = ll;\n    auto merge\
    \ = [](S x, S y) -> S {\n        return max(x, y);\n    };\n    auto e = []()\
    \ -> S {\n        return 0;\n    };\n\n    using F = ll;\n    auto put_edge =\
    \ [](S x, F y) -> S {\n        return x + y;\n    };\n    auto id = []() -> F\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dp-abstract/aoj-grl-5-a.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dp-abstract/aoj-grl-5-a.test.cpp
- /verify/test/tree/tree-dp-abstract/aoj-grl-5-a.test.cpp.html

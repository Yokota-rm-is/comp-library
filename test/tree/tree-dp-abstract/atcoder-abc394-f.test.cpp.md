...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dp-abstract/atcoder-abc394-f.test.cpp\"\n\
    ...
    \ 0; }, F, put_vertex, id>;\n#line 5 \"test/tree/tree-dp-abstract/atcoder-abc394-f.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    using S = vll;\n    auto merge\
    \ = [](S x, S y) -> S {\n        vll ret;\n\n        auto px = x.begin();\n  \
    \      auto py = y.begin();\n        \n        while (ret.size() < 3) {\n    \
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dp-abstract/atcoder-abc394-f.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dp-abstract/atcoder-abc394-f.test.cpp
- /verify/test/tree/tree-dp-abstract/atcoder-abc394-f.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/tree/tree-dp-reroot-abstract/aoj-1595.test.cpp\"\n\
    ...
    \ 0; }, F, put_vertex, id>;\n#line 4 \"test/tree/tree-dp-reroot-abstract/aoj-1595.test.cpp\"\
    \n\nint main() {\n    ll n;\n    cin >> n;\n\n    using S = ll;\n    auto merge\
    \ = [](S x, S y) -> S {\n        return max(x, y);\n    };\n\n    auto e = []()\
    \ -> S {\n        return 0;\n    };\n\n    using F = ll;\n    auto put_edge =\
    \ [](S x, F y) -> S {\n        return x + y;\n    };\n\n    auto id_edge = []()\
    \ -> F {\n        return 0;\n    };\n\n    TreeDPEdge<S, merge, e, F, put_edge,\
    \ id_edge> tree(n);\n\n    // TreeDPEdge\n    rep(i, n - 1) {\n        ll s, t;\n\
    \        cin >> s >> t;\n        --s; --t;\n\n        tree.connect(s, t, 1);\n\
  ...
  verifiedWith: []
documentation_of: test/tree/tree-dp-reroot-abstract/aoj-1595.test.cpp
layout: document
redirect_from:
- /verify/test/tree/tree-dp-reroot-abstract/aoj-1595.test.cpp
- /verify/test/tree/tree-dp-reroot-abstract/aoj-1595.test.cpp.html

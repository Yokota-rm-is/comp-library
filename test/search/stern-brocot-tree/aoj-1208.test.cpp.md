...
data:
  ...
  bundledCode: "#line 1 \"test/search/stern-brocot-tree/aoj-1208.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=1208\"\n\
    \n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \uFF0Cr/s: \u6761\u4EF6\u3092\u6E80\u305F\u3055\u306A\u3044\u5206\u6570\n    \
    \    if (is_ok(r, s)) {\n            swap(p, r);\n            swap(q, s);\n  \
    \      }\n\n        return {p, q, r, s};\n    }\n};\n#line 4 \"test/search/stern-brocot-tree/aoj-1208.test.cpp\"\
    \n\nint main() {\n    while (true) {\n        ll p, n;\n        cin >> p >> n;\n\
    \n        if (p == 0 and n == 0) break;\n\n        auto is_ok = [&](ll x, ll y)\
    \ {\n            return y * y * p < x * x;\n        };\n\n        SternBrocotTree<ll>\
    \ sbt;\n        auto [u, v, x, y] = sbt.search(is_ok, n);\n        cout << u <<\
    \ \"/\" << v << \" \" << x << \"/\" << y << endl;\n    }\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=1208\"\
  ...
  verifiedWith: []
documentation_of: test/search/stern-brocot-tree/aoj-1208.test.cpp
layout: document
redirect_from:
- /verify/test/search/stern-brocot-tree/aoj-1208.test.cpp
- /verify/test/search/stern-brocot-tree/aoj-1208.test.cpp.html

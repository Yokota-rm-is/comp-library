...
data:
  ...
  bundledCode: "#line 1 \"test/search/stern-brocot-tree/yosupo-stern-brocot-tree.test.cpp\"\
    ...
    \uFF0Cr/s: \u6761\u4EF6\u3092\u6E80\u305F\u3055\u306A\u3044\u5206\u6570\n    \
    \    if (is_ok(r, s)) {\n            swap(p, r);\n            swap(q, s);\n  \
    \      }\n\n        return {p, q, r, s};\n    }\n};\n#line 4 \"test/search/stern-brocot-tree/yosupo-stern-brocot-tree.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/search/stern-brocot-tree/yosupo-stern-brocot-tree.test.cpp
layout: document
redirect_from:
- /verify/test/search/stern-brocot-tree/yosupo-stern-brocot-tree.test.cpp
- /verify/test/search/stern-brocot-tree/yosupo-stern-brocot-tree.test.cpp.html

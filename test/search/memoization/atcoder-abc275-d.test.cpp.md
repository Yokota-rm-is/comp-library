...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc275/tasks/abc275_d
    links:
    - https://atcoder.jp/contests/abc275/tasks/abc275_d
  bundledCode: "#line 1 \"test/search/memoization/atcoder-abc275-d.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc275/tasks/abc275_d\"\n\n#line 2 \"\
    ...
    \ x) { return __builtin_popcountll(x); }\n#endif\n#line 2 \"search/memoization.cpp\"\
    \n\ntemplate<typename Key, typename Value>\nstruct Memoization {\n    map<Key,\
    \ Value> memo;\n\n    Memoization() {};\n\n    Value get (Key key) {\n       \
    \ if (!memo.contains(key)) {\n            memo[key] = f(key);\n        }\n   \
    \     \n        return memo[key];\n    }\n\n    virtual Value f(Key key) = 0;\
    \ \n};\n#line 4 \"test/search/memoization/atcoder-abc275-d.test.cpp\"\n\nstruct\
    \ F : Memoization<long long, long long> {\n    F() {};\n\n    long long f(long\
    \ long key) {\n        if (key == 0) return 1;\n\n        return get(floor(key,\
    \ 2)) + get(floor(key, 3));\n    }\n};\n\nint main() {\n    ll N;\n    cin >>\
    \ N;\n\n    F f;\n    cout << f.f(N) << endl;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc275/tasks/abc275_d\"\n\n\
    #include \"../../../search/memoization.cpp\"\n\nstruct F : Memoization<long long,\
  ...
  requiredBy: []
  timestamp: '2024-04-24 09:20:03+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/search/memoization/atcoder-abc275-d.test.cpp
layout: document
redirect_from:
- /verify/test/search/memoization/atcoder-abc275-d.test.cpp
- /verify/test/search/memoization/atcoder-abc275-d.test.cpp.html

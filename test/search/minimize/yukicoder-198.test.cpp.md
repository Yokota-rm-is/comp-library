...
data:
  ...
  bundledCode: "#line 1 \"test/search/minimize/yukicoder-198.test.cpp\"\n#define PROBLEM\
    \ \"https://yukicoder.me/problems/no/198\"\n\n#line 2 \"base.cpp\"\n\n#include\
    ...
    \ right)) < f(ret)) ? midpoint(left, right) : ret;\n}\n#line 4 \"test/search/minimize/yukicoder-198.test.cpp\"\
    \n\nint main() {\n    ll B, N;\n    cin >> B >> N;\n\n    vll C(N);\n    rep(i,\
    \ N) cin >> C[i];\n\n    auto f = [&](ll x) {\n        ll ret = 0;\n        rep(i,\
    \ N) {\n            ret += abs(C[i] - x);\n        }\n        return ret;\n  \
  ...
  verifiedWith: []
documentation_of: test/search/minimize/yukicoder-198.test.cpp
layout: document
redirect_from:
- /verify/test/search/minimize/yukicoder-198.test.cpp
- /verify/test/search/minimize/yukicoder-198.test.cpp.html

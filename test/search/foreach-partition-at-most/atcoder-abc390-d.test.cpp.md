...
data:
  ...
  bundledCode: "#line 1 \"test/search/foreach-partition-at-most/atcoder-abc390-d.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"search/foreach-partition-at-most.cpp\"\n\nvoid\
    \ recursive_partition_at_most(vector<vector<long long>>& indices, long long K,\
    \ long long idx, function<void(vvll&)> f, function<void(ll, ll)> insert, function<void(ll,\
    \ ll)> erase) {\n    if (idx == -1) {\n        f(indices);\n        return;\n\
    ...
    \u5168\u63A2\u7D22\u3057\uFF0C\u305D\u308C\u305E\u308C\u306B\u5BFE\u3057\u3066\
    \u95A2\u6570f\u3092\u9069\u7528\u3059\u308B\n// \u63A2\u7D22\u3059\u308B\u500B\
    \u6570\u306F\u30D9\u30EB\u6570\u3068\u306A\u308B\u306E\u3067\uFF0CO(Bell(N, K))\
    \ * O(f)\n// insert(i, idx)\u306Fi\u756A\u76EE\u306E\u30B0\u30EB\u30FC\u30D7\u306B\
    idx\u756A\u76EE\u306E\u8981\u7D20\u3092\u8FFD\u52A0\u3059\u308B\u51E6\u7406\n\
    // erase(i, idx)\u306Fi\u756A\u76EE\u306E\u30B0\u30EB\u30FC\u30D7\u304B\u3089\
    idx\u756A\u76EE\u306E\u8981\u7D20\u3092\u524A\u9664\u3059\u308B\u51E6\u7406\n\
    void foreach_partition_at_most(long long N, long long K, function<void(vvll&)>\
    \ f, function<void(ll, ll)> insert = [](ll, ll){}, function<void(ll, ll)> erase\
    \ = [](ll, ll){}) {\n    vector<vector<long long>> indices;\n    recursive_partition_at_most(indices,\
    \ K, N - 1, f, insert, erase);\n}\n#line 5 \"test/search/foreach-partition-at-most/atcoder-abc390-d.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vector<ll> A(N);\n    rep(i,\
    \ N) cin >> A[i];\n\n    vector<ull> ans;\n    vector<ull> group(N, 0);\n\n  \
    \  auto insert = [&](ll i, ll idx) {\n        group[i] += A[idx];\n    };\n\n\
    \    auto erase = [&](ll i, ll idx) {\n        group[i] -= A[idx];\n    };\n\n\
    \    auto f = [&](vvll& indices) {\n        ull xor_sum = 0;\n        rep(i, indices.size())\
    \ xor_sum ^= group[i];\n        ans.push_back(xor_sum);\n    };\n    \n    foreach_partition_at_most(N,\
  ...
  verifiedWith: []
documentation_of: test/search/foreach-partition-at-most/atcoder-abc390-d.test.cpp
layout: document
redirect_from:
- /verify/test/search/foreach-partition-at-most/atcoder-abc390-d.test.cpp
- /verify/test/search/foreach-partition-at-most/atcoder-abc390-d.test.cpp.html

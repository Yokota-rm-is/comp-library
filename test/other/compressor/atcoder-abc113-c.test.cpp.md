...
data:
  ...
  bundledCode: "#line 1 \"test/other/compressor/atcoder-abc113-c.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc113/tasks/abc113_c\"\n\n#line 2 \"\
    ...
    \u306E\u8981\u7D20\u3068\u3057\u3066\u6271\u3046\n// Accending: \u91CD\u8907\u3059\
    \u308B\u8981\u7D20\u3092\u3069\u3061\u3089\u306E\u65B9\u5411\u306B\u5272\u308A\
    \u5F53\u3066\u308B\u304B\ntemplate <typename T, bool EraseDuplicate = true, bool\
    ...
    #line 4 \"test/other/compressor/atcoder-abc113-c.test.cpp\"\n\nint main() {\n\
    \    ll N, M;\n    cin >> N >> M;\n    \n    vll P(M), Y(M);\n    rep(i, M) cin\
    \ >> P[i] >> Y[i];\n\n    vvll A(N + 1);\n    rep(i, M) {\n        A[P[i]].push_back(Y[i]);\n\
    \    }\n\n    vector<Compressor<ll>> comp(N + 1);\n\n    rep(i, N + 1) {\n   \
    \     comp[i].init(A[i]);\n    }\n\n    rep(i, M) {\n        ll p = P[i];\n  \
    \      ll y = Y[i];\n        ll y_comp = comp[p].compress(y);\n\n        cout\
    \ << zero_padding(p, 6) << zero_padding(y_comp + 1, 6) << endl;\n    }\n\n   \
    \ return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc113/tasks/abc113_c\"\n\n\
    ...
    \n    vector<Compressor<ll>> comp(N + 1);\n\n    rep(i, N + 1) {\n        comp[i].init(A[i]);\n\
    \    }\n\n    rep(i, M) {\n        ll p = P[i];\n        ll y = Y[i];\n      \
    \  ll y_comp = comp[p].compress(y);\n\n        cout << zero_padding(p, 6) << zero_padding(y_comp\
    \ + 1, 6) << endl;\n    }\n\n    return 0;\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/other/compressor/atcoder-abc113-c.test.cpp
layout: document
redirect_from:
- /verify/test/other/compressor/atcoder-abc113-c.test.cpp
- /verify/test/other/compressor/atcoder-abc113-c.test.cpp.html

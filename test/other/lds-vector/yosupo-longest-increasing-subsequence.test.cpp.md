...
data:
  ...
  bundledCode: "#line 1 \"test/other/lds-vector/yosupo-longest-increasing-subsequence.test.cpp\"\
    ...
    \            return it - dp.begin();\n        }\n    }\n\n    // val\u304C\u672B\
    \u5C3E\u306B\u306A\u308BLDS\u306E\u9577\u3055\u3092\u8FD4\u3059\n    long long\
    \ size_lds_fixed_right(T val) {\n        return get_index(val) + 1;\n    }\n};\n\
    #line 4 \"test/other/lds-vector/yosupo-longest-increasing-subsequence.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    fore(a, A) cin\
  ...
  verifiedWith: []
documentation_of: test/other/lds-vector/yosupo-longest-increasing-subsequence.test.cpp
layout: document
redirect_from:
- /verify/test/other/lds-vector/yosupo-longest-increasing-subsequence.test.cpp
- /verify/test/other/lds-vector/yosupo-longest-increasing-subsequence.test.cpp.html

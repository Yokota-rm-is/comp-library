...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc360/tasks/abc360_g
    links:
    - https://atcoder.jp/contests/abc360/tasks/abc360_g
  bundledCode: "#line 1 \"test/other/lds-vector/atcoder-abc360-g.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc360/tasks/abc360_g\"\n\n#line 2 \"\
    ...
    \    return result;\n}\n#line 3 \"other/lis-vector.cpp\"\n\ntemplate <typename\
    \ T = long long, bool strict = true>\nstruct LISVector {\n    vector<T> vals,\
    \ prev, dp;\n    deque<deque<T>> table;\n\n    LISVector() {}\n    LISVector(const\
    \ vector<T>& v) {\n        for (auto& x : v) push_back(x);\n    }\n\n    void\
    \ push_back(T val) {\n        vals.push_back(val);\n\n        if (dp.empty() or\
    \ dp.back() < val or (not strict and dp.back() == val)) {\n            prev.push_back(dp.empty()\
    \ ? -1 : dp.back());\n            dp.push_back(val);\n            table.push_back({val});\n\
    ...
    \   return it - dp.begin();\n        }\n    }\n\n    // val\u304C\u672B\u5C3E\u306B\
    \u306A\u308BLIS\u306E\u9577\u3055\u3092\u8FD4\u3059\n    long long size_lis_fixed_right(T\
    \ val) {\n        return get_index(val) + 1;\n    }\n};\n#line 3 \"other/lds-vector.cpp\"\
    ...
    \        assert(0 < k and k <= vals.size());\n\n        return dp[k - 1];\n  \
    \  }\n\n    // val\u306B\u3088\u308A\u66F4\u65B0\u3055\u308C\u308Bdp\u306Eindex\u3092\
    \u8FD4\u3059\n    // val\u304C\u672B\u5C3E\u306B\u306A\u308BLDS\u306E\u9577\u3055\
    \u306Findex + 1\n    long long get_index(T val) {\n        auto comp = [](T a,\
    \ T b) {\n            return a > b;\n        };\n\n        if constexpr (strict)\
    \ {\n            auto it = lower_bound(dp.begin(), dp.end(), val, comp);\n   \
    \         return it - dp.begin();\n        } \n        else {\n            auto\
    \ it = upper_bound(dp.begin(), dp.end(), val, comp);\n            return it -\
    \ dp.begin();\n        }\n    }\n\n    // val\u304C\u672B\u5C3E\u306B\u306A\u308B\
    LDS\u306E\u9577\u3055\u3092\u8FD4\u3059\n    long long size_lds_fixed_right(T\
    \ val) {\n        return get_index(val) + 1;\n    }\n};\n#line 5 \"test/other/lds-vector/atcoder-abc360-g.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    rep(i, N) cin\
    \ >> A[i];\n\n    LISVector<ll> lis_l;\n    LDSVector<ll> lds_r;\n    repd(i,\
    \ 1, N) lds_r.push_back(A[i]);\n\n    ll ans = lds_r.size_lds() + 1;\n    rep(i,\
    \ N - 2) {\n        lis_l.push_back(A[i]);\n        lds_r.pop_back();\n      \
    ...
    \    return 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc360/tasks/abc360_g\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/other/lds-vector/atcoder-abc360-g.test.cpp
layout: document
redirect_from:
- /verify/test/other/lds-vector/atcoder-abc360-g.test.cpp
- /verify/test/other/lds-vector/atcoder-abc360-g.test.cpp.html

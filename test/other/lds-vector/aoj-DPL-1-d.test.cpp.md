...
data:
  ...
  bundledCode: "#line 1 \"test/other/lds-vector/aoj-DPL-1-d.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_D\"\n\n#line\
    ...
    #line 4 \"test/other/lds-vector/aoj-DPL-1-d.test.cpp\"\n\nint main() {\n    ll\
    \ N;\n    cin >> N;\n\n    vll A(N);\n    fore(a, A) cin >> a;\n\n    LDSVector<ll>\
  ...
  verifiedWith: []
documentation_of: test/other/lds-vector/aoj-DPL-1-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/lds-vector/aoj-DPL-1-d.test.cpp
- /verify/test/other/lds-vector/aoj-DPL-1-d.test.cpp.html

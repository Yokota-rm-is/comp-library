...
data:
  ...
  bundledCode: "#line 1 \"test/other/lis-vector/atcoder-abc354-f.test.cpp\"\n#define\
    ...
    \ val) {\n        return get_index(val) + 1;\n    }\n};\n#line 7 \"test/other/lis-vector/atcoder-abc354-f.test.cpp\"\
    \n\nint main() {\n    ll T;\n    cin >> T;\n\n    while (T--) {\n        ll N;\n\
    \        cin >> N;\n\n        vll A(N);\n        rep(i, N) cin >> A[i];\n\n  \
  ...
  verifiedWith: []
documentation_of: test/other/lis-vector/atcoder-abc354-f.test.cpp
layout: document
redirect_from:
- /verify/test/other/lis-vector/atcoder-abc354-f.test.cpp
- /verify/test/other/lis-vector/atcoder-abc354-f.test.cpp.html

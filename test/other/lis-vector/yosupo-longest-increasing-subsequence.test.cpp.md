...
data:
  ...
  bundledCode: "#line 1 \"test/other/lis-vector/yosupo-longest-increasing-subsequence.test.cpp\"\
    ...
    \ val) {\n        return get_index(val) + 1;\n    }\n};\n#line 4 \"test/other/lis-vector/yosupo-longest-increasing-subsequence.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    fore(a, A) cin\
    \ >> a;\n\n    LISVector<ll> lis(A);\n\n    vll B = lis.get_lis();\n    cout <<\
    \ B.size() << endl;\n\n    auto p = B.begin();\n    rep(i, N) {\n        if (p\
    \ != B.end() and *p == A[i]) {\n            cout << i;\n            if (++p !=\
  ...
  verifiedWith: []
documentation_of: test/other/lis-vector/yosupo-longest-increasing-subsequence.test.cpp
layout: document
redirect_from:
- /verify/test/other/lis-vector/yosupo-longest-increasing-subsequence.test.cpp
- /verify/test/other/lis-vector/yosupo-longest-increasing-subsequence.test.cpp.html

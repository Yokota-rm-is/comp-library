...
data:
  ...
  bundledCode: "#line 1 \"test/other/lis-vector/atcoder-abc360-g.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc360/tasks/abc360_g\"\n\n#line 2 \"\
    ...
    \ val) {\n        return get_index(val) + 1;\n    }\n};\n#line 5 \"test/other/lis-vector/atcoder-abc360-g.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    rep(i, N) cin\
    \ >> A[i];\n\n    LISVector<ll> lis_l;\n    LDSVector<ll> lds_r;\n    rep(i, N\
    \ - 1) lis_l.push_back(A[i]);\n\n    ll ans = lis_l.size_lis() + 1;\n    repd(i,\
    \ 2, N) {\n        lis_l.pop_back();\n        lds_r.push_back(A[i]);\n       \
  ...
  verifiedWith: []
documentation_of: test/other/lis-vector/atcoder-abc360-g.test.cpp
layout: document
redirect_from:
- /verify/test/other/lis-vector/atcoder-abc360-g.test.cpp
- /verify/test/other/lis-vector/atcoder-abc360-g.test.cpp.html

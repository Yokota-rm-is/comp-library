...
data:
  ...
  bundledCode: "#line 1 \"test/other/lis-vector/aoj-DPL-1-d.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_D\"\n\n#line\
    ...
    \ val) {\n        return get_index(val) + 1;\n    }\n};\n#line 4 \"test/other/lis-vector/aoj-DPL-1-d.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    fore(a, A) cin\
  ...
  verifiedWith: []
documentation_of: test/other/lis-vector/aoj-DPL-1-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/lis-vector/aoj-DPL-1-d.test.cpp
- /verify/test/other/lis-vector/aoj-DPL-1-d.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/other/shakutori/atcoder-abc-032-c.test.cpp\"\n#define\
    ...
    \ == left) {\n            insert(value, right);\n            right++;\n      \
    \  }\n        \n        erase(value, left);\n    }\n    \n    return max_range;\n\
    };\n#line 6 \"test/other/shakutori/atcoder-abc-032-c.test.cpp\"\n\nint main()\
    \ {\n    ll N, K;\n    cin >> N >> K;\n\n    vll s(N);\n    rep(i, N) cin >> s[i];\n\
    \    \n    rep(i, N) {\n        if (s[i] == 0) {\n            cout << N << endl;\n\
    \            return 0;\n        }\n    }\n\n    if (K == 0) {\n        cout <<\
    \ 0 << endl;\n        return 0;\n    }\n\n    auto e = [&]() { return 1ll; };\n\
    \    auto insert = [&](ll& value, ll idx) { value *= s[idx]; };\n    auto judge\
    \ = [&](const ll& value) { return value <= K; };\n    auto erase = [&](ll& value,\
    \ ll idx) { value /= s[idx]; };\n\n    cout << shakutori_max_range<ll>(N, e, insert,\
    \ judge, erase) << endl;\n\n    return 0;\n}\n"
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/abc032/tasks/abc032_c\"\
    ...
    \ erase = [&](ll& value, ll idx) { value /= s[idx]; };\n\n    cout << shakutori_max_range<ll>(N,\
  ...
  verifiedWith: []
documentation_of: test/other/shakutori/atcoder-abc-032-c.test.cpp
layout: document
redirect_from:
- /verify/test/other/shakutori/atcoder-abc-032-c.test.cpp
- /verify/test/other/shakutori/atcoder-abc-032-c.test.cpp.html

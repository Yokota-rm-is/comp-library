...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_3_C
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_3_C
  bundledCode: "#line 1 \"test/other/shakutori/aoj-dsl-3-c.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_3_C\"\n\n#line\
    ...
    \    return result;\n}\n#line 3 \"other/shakutori.cpp\"\n\n// judge\u3092\u6E80\
    \u305F\u3059[left, right)\u306E\u7D44\u307F\u5408\u308F\u305B\u306E\u6570\u3092\
    \u6C42\u3081\u308B\n// inner: [left, right)\u304C\u6761\u4EF6\u3092\u6E80\u305F\
    \u3059\u3068\u304D\uFF0C[left, right)\u306E\u90E8\u5206\u533A\u9593\u3082\u6761\
    \u4EF6\u3092\u6E80\u305F\u3059\n// insert(value, idx): idx\u756A\u76EE\u306E\u8981\
    \u7D20\u3092value\u306B\u8FFD\u52A0\u3059\u308B\u51E6\u7406\n// judge(value):\
    \ value\u304C\u6761\u4EF6\u3092\u6E80\u305F\u3059\u304B\u3069\u3046\u304B\u3092\
    \u5224\u5B9A\u3059\u308B\u95A2\u6570\n// erase(value, idx): idx\u756A\u76EE\u306E\
    \u8981\u7D20\u3092value\u304B\u3089\u524A\u9664\u3059\u308B\u51E6\u7406\ntemplate\
    \ <typename T>\nll shakutori_inner_count(ll N, function<T()> e, function<void(T&,\
    \ ll)> insert, function<bool(const T&)> judge, function<void(T&, ll)> erase) {\n\
    ...
    \        }\n\n        if (right == left) {\n            insert(value, right);\n\
    \            right++;\n        }\n        \n        erase(value, left);\n    }\n\
    \    \n    return count;\n};\n\n// judge\u3092\u6E80\u305F\u3059[left, right)\u306E\
    \u7D44\u307F\u5408\u308F\u305B\u306E\u6570\u3092\u6C42\u3081\u308B\n// outer:\
    \ [left, right)\u304C\u6761\u4EF6\u3092\u6E80\u305F\u3059\u3068\u304D\uFF0C[left,\
    \ right)\u3092\u542B\u3080\u533A\u9593\u3082\u6761\u4EF6\u3092\u6E80\u305F\u3059\
    \n// insert(value, idx): idx\u756A\u76EE\u306E\u8981\u7D20\u3092value\u306B\u8FFD\
    \u52A0\u3059\u308B\u51E6\u7406\n// judge(value): value\u304C\u6761\u4EF6\u3092\
    \u6E80\u305F\u3059\u304B\u3069\u3046\u304B\u3092\u5224\u5B9A\u3059\u308B\u95A2\
    \u6570\n// erase(value, idx): idx\u756A\u76EE\u306E\u8981\u7D20\u3092value\u304B\
    \u3089\u524A\u9664\u3059\u308B\u51E6\u7406\ntemplate <typename T>\nll shakutori_outer_count(ll\
    \ N, function<T()> e, function<void(T&, ll)> insert, function<bool(const T&)>\
    \ judge, function<void(T&, ll)> erase) {\n    T value = e();\n    assert(judge(value)\
    \ == false);\n\n    ll count = 0;\n\n    ll right = 0;\n    rep(left, N) {\n \
    \       while (right < N and !judge(value)) {\n            insert(value, right);\n\
    \            right++;\n        }\n\n        count += N - right;\n\n        if\
    \ (right == left) {\n            insert(value, right);\n            right++;\n\
    \        }\n        \n        erase(value, left);\n    }\n    \n    return count;\n\
    };\n\n// judge\u3092\u6E80\u305F\u3059[left, right)\u306E\u3046\u3061\u6700\u5C0F\
    \u306E\u533A\u9593\u9577\u3092\u6C42\u3081\u308B\n// insert(value, idx): idx\u756A\
    \u76EE\u306E\u8981\u7D20\u3092value\u306B\u8FFD\u52A0\u3059\u308B\u51E6\u7406\n\
    // judge(value): value\u304C\u6761\u4EF6\u3092\u6E80\u305F\u3059\u304B\u3069\u3046\
    \u304B\u3092\u5224\u5B9A\u3059\u308B\u95A2\u6570\n// erase(value, idx): idx\u756A\
    \u76EE\u306E\u8981\u7D20\u3092value\u304B\u3089\u524A\u9664\u3059\u308B\u51E6\u7406\
    \ntemplate <typename T>\nll shakutori_min_range(ll N, function<T()> e, function<void(T&,\
    \ ll)> insert, function<bool(const T&)> judge, function<void(T&, ll)> erase) {\n\
    \    T value = e();\n    assert(judge(value) == false);\n\n    ll min_range =\
    \ inf64;\n\n    ll right = 0;\n    rep(left, N) {\n        while (right < N and\
    \ !judge(value)) {\n            insert(value, right);\n            right++;\n\
    \        }\n\n        if (judge(value)) {\n            chmin(min_range, right\
    \ - left);\n        }\n\n        if (right == left) {\n            insert(value,\
    \ right);\n            right++;\n        }\n        \n        erase(value, left);\n\
    \    }\n    \n    return min_range;\n};\n\n// judge\u3092\u6E80\u305F\u3059[left,\
    \ right)\u306E\u3046\u3061\u6700\u5927\u306E\u533A\u9593\u9577\u3092\u6C42\u3081\
    \u308B\n// insert(value, idx): idx\u756A\u76EE\u306E\u8981\u7D20\u3092value\u306B\
    \u8FFD\u52A0\u3059\u308B\u51E6\u7406\n// judge(value): value\u304C\u6761\u4EF6\
    \u3092\u6E80\u305F\u3059\u304B\u3069\u3046\u304B\u3092\u5224\u5B9A\u3059\u308B\
    \u95A2\u6570\n// erase(value, idx): idx\u756A\u76EE\u306E\u8981\u7D20\u3092value\u304B\
    \u3089\u524A\u9664\u3059\u308B\u51E6\u7406\ntemplate <typename T>\nll shakutori_max_range(ll\
    \ N, function<T()> e, function<void(T&, ll)> insert, function<bool(const T&)>\
    \ judge, function<void(T&, ll)> erase) {\n    T value = e();\n    assert(judge(value)\
    \ == true);\n\n    ll max_range = 0;\n\n    ll right = 0;\n    rep(left, N) {\n\
    \        while (right < N and judge(value)) {\n            insert(value, right);\n\
    ...
    \ == left) {\n            insert(value, right);\n            right++;\n      \
    \  }\n        \n        erase(value, left);\n    }\n    \n    return max_range;\n\
    };\n#line 4 \"test/other/shakutori/aoj-dsl-3-c.test.cpp\"\n\nint main() {\n  \
    \  ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i, N) cin >> a[i];\n\
    \n    while (Q--) {\n        ll x;\n        cin >> x;\n\n        auto e = [&]()\
    \ { return 0ll; };\n        auto insert = [&](ll& value, ll idx) { value += a[idx];\
    \ };\n        auto judge = [&](const ll& value) { return value <= x; };\n    \
    \    auto erase = [&](ll& value, ll idx) { value -= a[idx]; };\n\n        cout\
    \ << shakutori_inner_count<ll>(N, e, insert, judge, erase) << endl;\n    }\n\n\
    \    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_3_C\"\
    \n\n#include \"../../../other/shakutori.cpp\"\n\nint main() {\n    ll N, Q;\n\
    \    cin >> N >> Q;\n\n    vll a(N);\n    rep(i, N) cin >> a[i];\n\n    while\
    \ (Q--) {\n        ll x;\n        cin >> x;\n\n        auto e = [&]() { return\
    \ 0ll; };\n        auto insert = [&](ll& value, ll idx) { value += a[idx]; };\n\
    \        auto judge = [&](const ll& value) { return value <= x; };\n        auto\
    \ erase = [&](ll& value, ll idx) { value -= a[idx]; };\n\n        cout << shakutori_inner_count<ll>(N,\
    \ e, insert, judge, erase) << endl;\n    }\n\n    return 0;\n}"
  dependsOn:
  - other/shakutori.cpp
  - base.cpp
  ...
  requiredBy: []
  timestamp: '2025-03-23 19:17:45+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/other/shakutori/aoj-dsl-3-c.test.cpp
layout: document
redirect_from:
- /verify/test/other/shakutori/aoj-dsl-3-c.test.cpp
- /verify/test/other/shakutori/aoj-dsl-3-c.test.cpp.html

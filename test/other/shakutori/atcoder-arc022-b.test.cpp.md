...
data:
  ...
  bundledCode: "#line 1 \"test/other/shakutori/atcoder-arc022-b.test.cpp\"\n#define\
  ...
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/arc022/tasks/arc022_2\"\
    ...
    \ { \n        return !value.contains_multiple_item();\n    };\n    auto erase\
    \ = [&](T& value, ll idx) {\n        value.erase(A[idx]);\n    };\n\n    cout\
    \ << shakutori_max_range<T>(N, e, insert, judge, erase) << endl;\n\n    return\
    \ 0;\n}"
  dependsOn:
  - other/shakutori.cpp
  - base.cpp
  ...
  verifiedWith: []
documentation_of: test/other/shakutori/atcoder-arc022-b.test.cpp
layout: document
redirect_from:
- /verify/test/other/shakutori/atcoder-arc022-b.test.cpp
- /verify/test/other/shakutori/atcoder-arc022-b.test.cpp.html

...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc322/tasks/abc322_e
    links:
    - https://atcoder.jp/contests/abc322/tasks/abc322_e
  bundledCode: "#line 1 \"test/other/custom-baseset/atcoder-abc322-e.test.cpp\"\n\
    ...
    \    return result;\n}\n#line 3 \"other/custom-baseset.cpp\"\n\nstruct CustomBaseset\
    \ {\n    const vector<long long> bases;\n    long long N;\n    vector<long long>\
    \ powers;\n\n    long long x;\n\n    CustomBaseset(long long base, long long n,\
    \ long long x = 0) : bases(n, base), N(n), powers(n + 1, 1), x(x) {\n        init();\n\
    \    }\n    \n    CustomBaseset(vector<long long> bases, long long x = 0) : bases(bases),\
    \ N(bases.size()), powers(N + 1, 1), x(x) {\n        init();\n    }\n\n    void\
    ...
    \ ++x;\n        return *this;\n    }\n\n    CustomBaseset& operator--() { \n \
    \       --x;\n        return *this;\n    }\n\n    bool operator==(CustomBaseset\
    \ other) { return x == other.x; }\n    bool operator!=(CustomBaseset other) {\
    \ return x != other.x; }\n    bool operator<(CustomBaseset other) { return x <\
    ...
    \ x <= other; }\n    bool operator>=(long long other) { return x >= other; }\n\
    \n    friend istream& operator>>(istream& is, CustomBaseset& x) { return is >>\
    \ x.x; }\n    friend ostream& operator<<(ostream& os, CustomBaseset& x) { \n \
    \       rep(i, x.N) {\n            os << x.get(i);\n            if (i < x.N -\
    \ 1) os << \" \";\n        }\n        return os; \n    }\n};\n#line 4 \"test/other/custom-baseset/atcoder-abc322-e.test.cpp\"\
    \n\nint main() {\n    ll N, K, P;\n    cin >> N >> K >> P;\n\n    vll C(N);\n\
    \    vvll A(N, vll(K));\n    rep(i, N) {\n        cin >> C[i];\n        rep(j,\
    \ K) cin >> A[i][j];\n    }\n\n    vvll dp(N + 1, vll(binpow(P + 1, K), inf64));\n\
    \    dp[0][0] = 0;\n\n    rep(i, N) {\n        for (CustomBaseset idx(P + 1, K);\
    ...
    \n    ll ans = dp.back().back();\n    if (ans == inf64) ans = -1;\n\n    cout\
    \ << ans << endl;\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc322/tasks/abc322_e\"\n\n\
    ...
    \            if (dp[i][idx] == inf64) continue;\n            \n            chmin(dp[i\
    \ + 1][idx], dp[i][idx]);\n            \n            CustomBaseset next_idx(idx);\n\
    \            next_idx.add(A[i]);\n            chmin(dp[i + 1][next_idx], dp[i][idx]\
    \ + C[i]);\n        }\n    }\n\n    ll ans = dp.back().back();\n    if (ans ==\
    \ inf64) ans = -1;\n\n    cout << ans << endl;\n\n    return 0;\n} \n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2024-08-18 02:46:10+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/other/custom-baseset/atcoder-abc322-e.test.cpp
layout: document
redirect_from:
- /verify/test/other/custom-baseset/atcoder-abc322-e.test.cpp
- /verify/test/other/custom-baseset/atcoder-abc322-e.test.cpp.html

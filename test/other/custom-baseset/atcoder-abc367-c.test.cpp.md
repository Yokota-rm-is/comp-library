...
data:
  ...
  bundledCode: "#line 1 \"test/other/custom-baseset/atcoder-abc367-c.test.cpp\"\n\
    ...
    \       rep(i, x.N) {\n            os << x.get(i);\n            if (i < x.N -\
    \ 1) os << \" \";\n        }\n        return os; \n    }\n};\n#line 5 \"test/other/custom-baseset/atcoder-abc367-c.test.cpp\"\
    \n\nint main() {\n    long long N, K;\n    input(N, K);\n\n    vll R(N);\n   \
    \ rep(i, N) cin >> R[i];\n\n    vector<vll> ans;\n\n    for(CustomBaseset bs(R);\
    \ bs < bs.end(); ++bs) {\n        vll tmp = bs;\n        ++tmp;\n\n        ll\
    \ sum = accumulate(tmp);\n        if (sum % K == 0) {\n            ans.push_back(tmp);\n\
    \        }\n    }\n\n    sort(ans);\n\n    cout << ans << endl;\n\n    return\
    \ 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/other/custom-baseset/atcoder-abc367-c.test.cpp
layout: document
redirect_from:
- /verify/test/other/custom-baseset/atcoder-abc367-c.test.cpp
- /verify/test/other/custom-baseset/atcoder-abc367-c.test.cpp.html

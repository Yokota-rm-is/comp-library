...
data:
  ...
  bundledCode: "#line 1 \"test/other/static-range-frequency/atcoder-abc248-d.test.cpp\"\
    ...
    \ r);\n        return distance(left, right);\n    }\n};\n#line 4 \"test/other/static-range-frequency/atcoder-abc248-d.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    rep(i, N) cin\
  ...
  verifiedWith: []
documentation_of: test/other/static-range-frequency/atcoder-abc248-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/static-range-frequency/atcoder-abc248-d.test.cpp
- /verify/test/other/static-range-frequency/atcoder-abc248-d.test.cpp.html

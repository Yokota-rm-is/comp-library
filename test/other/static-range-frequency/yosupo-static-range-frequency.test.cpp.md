...
data:
  ...
  bundledCode: "#line 1 \"test/other/static-range-frequency/yosupo-static-range-frequency.test.cpp\"\
    ...
    \ = pow(x, 1.0 / n); if (binpow(ret, n) < x) ++ret; return ret;}\n#line 3 \"other/static-range-frequency.cpp\"\
    \n\ntemplate <typename T> \nstruct StaticRangeFrequency {\n    map<T, vector<long\
    \ long>> mp;\n\n    StaticRangeFrequency(const vector<T>& A) {\n        rep(i,\
    \ A.size()) mp[A[i]].push_back(i);\n    }\n\n    // [l, r) \u306E\u7BC4\u56F2\u306B\
    \ x \u304C\u4F55\u500B\u3042\u308B\u304B\u3092\u8FD4\u3059\n    // \u8A08\u7B97\
    \u91CF: O(log|max(A)|logN)\n    long long count(long long l, long long r, T x)\
    \ {\n        if (!mp.contains(x)) return 0;\n\n        auto left = lower_bound(mp[x].begin(),\
    \ mp[x].end(), l);\n        auto right = lower_bound(mp[x].begin(), mp[x].end(),\
    \ r);\n        return distance(left, right);\n    }\n};\n#line 4 \"test/other/static-range-frequency/yosupo-static-range-frequency.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i,\
  ...
  verifiedWith: []
documentation_of: test/other/static-range-frequency/yosupo-static-range-frequency.test.cpp
layout: document
redirect_from:
- /verify/test/other/static-range-frequency/yosupo-static-range-frequency.test.cpp
- /verify/test/other/static-range-frequency/yosupo-static-range-frequency.test.cpp.html

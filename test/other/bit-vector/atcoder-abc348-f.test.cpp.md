...
data:
  ...
  bundledCode: "#line 1 \"test/other/bit-vector/atcoder-abc348-f.test.cpp\"\n#define\
    ...
    \        return __builtin_popcountull(x); \n#endif\n    }\n};\n#line 6 \"test/other/bit-vector/atcoder-abc348-f.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vvll A(N, vll(M));\n\
    \    rep(i, N) rep(j, M) cin >> A[i][j];\n\n    vector B(M, vector(1000, BitVector<>(N,\
    \ 0)));\n    rep(j, M) rep(i, N) {\n        B[j][A[i][j]].set(i, 1);\n    }\n\n\
    \    ll ans = 0;\n\n    rep(i, 1, N) {\n        BitVector bv(i, 0);\n        \
  ...
  verifiedWith: []
documentation_of: test/other/bit-vector/atcoder-abc348-f.test.cpp
layout: document
redirect_from:
- /verify/test/other/bit-vector/atcoder-abc348-f.test.cpp
- /verify/test/other/bit-vector/atcoder-abc348-f.test.cpp.html

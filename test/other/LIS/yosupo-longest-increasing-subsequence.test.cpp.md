...
data:
  ...
  bundledCode: "#line 1 \"test/other/LIS/yosupo-longest-increasing-subsequence.test.cpp\"\
    ...
    \    return result;\n}\n#line 3 \"other/LIS.cpp\"\n\ntemplate <typename T>\nstruct\
    \ LIS {\n    long long N;\n    vector<T> A, dp;\n    vector<long long> pos;\n\n\
    \    LIS(vector<T> &a) : N(a.size()), A(a), pos(N) {}\n\n    ll solve() {\n  \
    \      rep(i, A.size()) {\n            auto p = find_greater_than_or_equal(dp,\
    \ A[i]);\n            ll idx = distance(dp.begin(), p);\n\n            if (p ==\
    \ dp.end()) dp.emplace_back(A[i]);\n            else dp[idx] = A[i];\n       \
    \     pos[i] = idx;\n        }\n\n        return dp.size();\n    }\n\n    vector<T>\
    \ restore() {\n        vector<T> ret;\n        ll idx = dp.size() - 1;\n     \
    \   \n        repd(i, N) {\n            if (pos[i] == idx) {\n               \
    ...
    \             ret.emplace_back(i);\n                idx--;\n            }\n  \
    \      }\n\n        reverse(ret.begin(), ret.end());\n\n        return ret;\n\
    \    }\n};\n#line 4 \"test/other/LIS/yosupo-longest-increasing-subsequence.test.cpp\"\
    \n\n\nint main() {\n    ll N;\n    cin >> N;\n\n    vll A(N);\n    fore(a, A)\
  ...
  requiredBy: []
  timestamp: '2024-08-03 17:24:38+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/other/LIS/yosupo-longest-increasing-subsequence.test.cpp
layout: document
redirect_from:
- /verify/test/other/LIS/yosupo-longest-increasing-subsequence.test.cpp
- /verify/test/other/LIS/yosupo-longest-increasing-subsequence.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/other/LIS/aoj-DPL-1-d.test.cpp\"\n#define PROBLEM \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_D\"\n\n#line 2\
    ...
    \             ret.emplace_back(i);\n                idx--;\n            }\n  \
    \      }\n\n        reverse(ret.begin(), ret.end());\n\n        return ret;\n\
    \    }\n};\n#line 4 \"test/other/LIS/aoj-DPL-1-d.test.cpp\"\n\nint main() {\n\
    \    ll N;\n    cin >> N;\n\n    vll A(N);\n    fore(a, A) cin >> a;\n\n    LIS<ll>\
    \ lis(A);\n    cout << lis.solve() << endl;\n\n    return 0;\n} \n"
  ...
  verifiedWith: []
documentation_of: test/other/LIS/aoj-DPL-1-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/LIS/aoj-DPL-1-d.test.cpp
- /verify/test/other/LIS/aoj-DPL-1-d.test.cpp.html

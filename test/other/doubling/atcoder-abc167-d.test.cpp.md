...
data:
  ...
  bundledCode: "#line 1 \"test/other/doubling/atcoder-abc167-d.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc167/tasks/abc167_d\"\n\n#line 2 \"\
    ...
    \    return result;\n}\n#line 3 \"other/doubling.cpp\"\n\nstruct Doubling {\n\
    \    vector<vector<long long>> dp{};\n    long long N, maxK;\n    long long logK;\n\
    \    vector<long long> to;\n\n    Doubling(vector<long long> &A, long long maxK):\
    \ N(A.size()), maxK(maxK) {\n        logK = 1;\n        while ((1ll << logK) <=\
  ...
  requiredBy: []
  timestamp: '2024-08-18 03:04:48+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/other/doubling/atcoder-abc167-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/doubling/atcoder-abc167-d.test.cpp
- /verify/test/other/doubling/atcoder-abc167-d.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/other/compress/atcoder-abc036-c.test.cpp\"\n#define\
    ...
    \    return result;\n}\n#line 6 \"test/other/compress/atcoder-abc036-c.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n    \n    vll A(N);\n    rep(i, N)\
  ...
  verifiedWith: []
documentation_of: test/other/compress/atcoder-abc036-c.test.cpp
layout: document
redirect_from:
- /verify/test/other/compress/atcoder-abc036-c.test.cpp
- /verify/test/other/compress/atcoder-abc036-c.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/other/pattern-cumulative-sum/atocoder-abc331-d.test.cpp\"\
    ...
    \ cs) {\n        rep(i, cs.size()) {\n            rep(j, cs.front().size()) {\n\
    \                os << cs[i][j] << \" \";\n            }\n            os << endl;\n\
    \        }\n        return os;\n    }\n};\n#line 4 \"test/other/pattern-cumulative-sum/atocoder-abc331-d.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vvll P(N, vll(N));\n\
    \    rep(i, N) {\n        rep(j, N) {\n            char c;\n            cin >>\
    \ c;\n            if (c == 'B') P[i][j] = 1;\n            else P[i][j] = 0;\n\
    \        }\n    }\n\n    PatternCumulativeSum<ll> pcs(P);\n\n    while (Q--) {\n\
    \        ll y1, x1, y2, x2;\n        cin >> y1 >> x1 >> y2 >> x2;\n\n        cout\
    \ << pcs.sum(x1, y1, x2 + 1, y2 + 1) << endl;\n    }\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc331/tasks/abc331_d\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/other/pattern-cumulative-sum/atocoder-abc331-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/pattern-cumulative-sum/atocoder-abc331-d.test.cpp
- /verify/test/other/pattern-cumulative-sum/atocoder-abc331-d.test.cpp.html

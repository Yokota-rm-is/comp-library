...
data:
  ...
  bundledCode: "#line 1 \"test/other/range-set/atocoder-abc330-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc330/tasks/abc330_e\"\n\n#line 2 \"\
    ...
    \ ? mp::end() : --it;\n    }\n};\n#line 5 \"test/other/range-set/atocoder-abc330-e.test.cpp\"\
    \n\nint main() {\n    ll N, Q;\n    cin >> N >> Q;\n\n    vll A(N);\n    rep(i,\
    \ N) cin >> A[i];\n\n    RangeSet<ll> rs;\n    MultiSet<ll> ms;\n\n    rep(i,\
    \ N) {\n        if (!ms.contains(A[i])) {\n            rs.insert(A[i]);\n    \
    \    }\n        ms.insert(A[i]);\n    }\n\n    while (Q--) {\n        ll i, x;\n\
  ...
  requiredBy: []
  timestamp: '2025-03-23 19:58:00+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/other/range-set/atocoder-abc330-e.test.cpp
layout: document
redirect_from:
- /verify/test/other/range-set/atocoder-abc330-e.test.cpp
- /verify/test/other/range-set/atocoder-abc330-e.test.cpp.html

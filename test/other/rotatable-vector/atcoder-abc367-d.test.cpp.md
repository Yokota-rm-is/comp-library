...
data:
  ...
  bundledCode: "#line 1 \"test/other/rotatable-vector/atcoder-abc367-d.test.cpp\"\n\
    ...
    \ < A.size() - 1 ? \" \" : \"\");\n        return os;\n    }\n};\n#line 5 \"test/other/rotatable-vector/atcoder-abc367-d.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vll A(N);\n    rep(i,\
...
layout: document
redirect_from:
- /verify/test/other/rotatable-vector/atcoder-abc367-d.test.cpp
- /verify/test/other/rotatable-vector/atcoder-abc367-d.test.cpp.html

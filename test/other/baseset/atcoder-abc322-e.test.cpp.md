...
data:
  ...
  bundledCode: "#line 1 \"test/other/baseset/atcoder-abc322-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc322/tasks/abc322_e\"\n\n#line 2 \"\
    ...
    \      while (y > 0) {\n            os << \" \" << y % base;\n            y /=\
    \ base;\n        }\n        return os; \n    }\n};\n#line 4 \"test/other/baseset/atcoder-abc322-e.test.cpp\"\
    \n\nint main() {\n    ll N, K, P;\n    cin >> N >> K >> P;\n\n    vll C(N);\n\
    \    vvll A(N, vll(K));\n    rep(i, N) {\n        cin >> C[i];\n        rep(j,\
    \ K) cin >> A[i][j];\n    }\n\n    vvll dp(N + 1, vll(binpow(P + 1, K), inf64));\n\
    \    dp[0][0] = 0;\n\n    rep(i, N) {\n        for (Baseset idx(P + 1); idx <\
...
layout: document
redirect_from:
- /verify/test/other/baseset/atcoder-abc322-e.test.cpp
- /verify/test/other/baseset/atcoder-abc322-e.test.cpp.html

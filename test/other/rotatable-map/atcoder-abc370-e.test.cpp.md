...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc370/tasks/abc370_e
    links:
    - https://atcoder.jp/contests/abc370/tasks/abc370_e
  bundledCode: "#line 1 \"test/other/rotatable-map/atcoder-abc370-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc370/tasks/abc370_e\"\n\n#line 2 \"\
    ...
    \        ans = ans_i;\n\n        sum += ans_i;\n        rm[0] += ans_i;\n    }\n\
    \n    cout << ans << endl;\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc370/tasks/abc370_e\"\n\n\
...
layout: document
redirect_from:
- /verify/test/other/rotatable-map/atcoder-abc370-e.test.cpp
- /verify/test/other/rotatable-map/atcoder-abc370-e.test.cpp.html

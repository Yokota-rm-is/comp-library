...
data:
  ...
  bundledCode: "#line 1 \"test/other/rotatable-set-2d/atcoder-abc398-d.test.cpp\"\n\
    ...
    #line 6 \"test/other/rotatable-set-2d/atcoder-abc398-d.test.cpp\"\n\nint main()\
    \ {\n    ll N, R, C;\n    cin >> N >> R >> C;\n\n    string S;\n    cin >> S;\n\
    \n    RotatableSet2D<ll> rs;\n    rs.insert(0, 0);\n\n    string ans(N, '0');\n\
    \    rep(i, N) {\n        if (S[i] == 'N') rs.subtract_key_y(1);\n        else\
    \ if (S[i] == 'S') rs.add_key_y(1);\n        else if (S[i] == 'W') rs.subtract_key_x(1);\n\
  ...
  verifiedWith: []
documentation_of: test/other/rotatable-set-2d/atcoder-abc398-d.test.cpp
layout: document
redirect_from:
- /verify/test/other/rotatable-set-2d/atcoder-abc398-d.test.cpp
- /verify/test/other/rotatable-set-2d/atcoder-abc398-d.test.cpp.html

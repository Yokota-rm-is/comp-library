...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2013
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2013
  bundledCode: "#line 1 \"test/other/imos/aoj-2013.test.cpp\"\n#define PROBLEM \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2013\"\n\n#line 2 \"\
    ...
    \     table[i + 1] += table[i];\n        }\n    }\n\n    T get(long long p) {\n\
    \        assert(built);\n        assert(0 <= p and p < N);\n        return A[p]\
    \ + table[p];\n    }\n};\n#line 4 \"test/other/imos/aoj-2013.test.cpp\"\n\nll\
    \ hhmmss2sec(const string &S) {\n    ll h = stoll(S.substr(0, 2));\n    ll m =\
    \ stoll(S.substr(3, 5));\n    ll s = stoll(S.substr(6, 8));\n    return h * 3600\
    \ + m * 60 + s;\n}\n\nint main() {\n    while (true) {\n        ll N;\n      \
    \  cin >> N;\n        if (N == 0) break;\n\n        Imos<ll> imos(24 * 60 * 60,\
    ...
    \  }\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2013\"\
    \n\n#include \"../../../other/imos.cpp\"\n\nll hhmmss2sec(const string &S) {\n\
    \    ll h = stoll(S.substr(0, 2));\n    ll m = stoll(S.substr(3, 5));\n    ll\
    \ s = stoll(S.substr(6, 8));\n    return h * 3600 + m * 60 + s;\n}\n\nint main()\
    \ {\n    while (true) {\n        ll N;\n        cin >> N;\n        if (N == 0)\
  ...
  verifiedWith: []
documentation_of: test/other/imos/aoj-2013.test.cpp
layout: document
redirect_from:
- /verify/test/other/imos/aoj-2013.test.cpp
- /verify/test/other/imos/aoj-2013.test.cpp.html

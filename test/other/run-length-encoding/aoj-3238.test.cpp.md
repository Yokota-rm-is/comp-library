...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3238
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3238
  bundledCode: "#line 1 \"test/other/run-length-encoding/aoj-3238.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3238\"\n\
    \n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ string ret;\n    for (auto [a, b] : S) {\n        rep(i, b) ret.push_back(a);\n\
    \    }\n    return ret;\n}\n#line 4 \"test/other/run-length-encoding/aoj-3238.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    string S;\n    cin >> S;\n\n\
    \    auto s = encode(S);\n\n    ll ans = 0;\n    rep(i, 1, s.size() - 1) {\n \
    \       if (s[i - 1].first == 'N' and s[i].first == 'A' and s[i + 1].first ==\
    \ 'N') ++ans;\n    }\n\n    cout << ans << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3238\"\
    \n\n#include \"../../../other/run-length-encoding.cpp\"\n\nint main() {\n    ll\
    \ N;\n    cin >> N;\n\n    string S;\n    cin >> S;\n\n    auto s = encode(S);\n\
    \n    ll ans = 0;\n    rep(i, 1, s.size() - 1) {\n        if (s[i - 1].first ==\
    \ 'N' and s[i].first == 'A' and s[i + 1].first == 'N') ++ans;\n    }\n\n    cout\
    \ << ans << endl;\n\n    return 0;\n}"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2025-05-21 13:45:57+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/other/run-length-encoding/aoj-3238.test.cpp
layout: document
redirect_from:
- /verify/test/other/run-length-encoding/aoj-3238.test.cpp
- /verify/test/other/run-length-encoding/aoj-3238.test.cpp.html

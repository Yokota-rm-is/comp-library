...
data:
  ...
  bundledCode: "#line 1 \"test/other/run-length-encoding/atcoder-past17-e.test.cpp\"\
    ...
    \ string ret;\n    for (auto [a, b] : S) {\n        rep(i, b) ret.push_back(a);\n\
    \    }\n    return ret;\n}\n#line 5 \"test/other/run-length-encoding/atcoder-past17-e.test.cpp\"\
    \n\nint main() {\n    string S;\n    cin >> S;\n\n    auto comp = encode(S);\n\
  ...
  requiredBy: []
  timestamp: '2025-03-23 20:06:25+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/other/run-length-encoding/atcoder-past17-e.test.cpp
layout: document
redirect_from:
- /verify/test/other/run-length-encoding/atcoder-past17-e.test.cpp
- /verify/test/other/run-length-encoding/atcoder-past17-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/other/run-length-encoding/atcoder-abc259-c.test.cpp\"\
    ...
    \  } \n        else {\n            ret.back().second++;\n        }\n    }\n  \
    \  return ret;\n}\n\ntemplate<typename T>\nvector<T> decode(vector<pair<T, ll>>&\
    \ A) {\n    vector<T> ret;\n    for (auto [a, b] : A) {\n        rep(i, b) ret.push_back(a);\n\
    \    }\n    return ret;\n}\n\nstring decode(vector<pair<char, ll>>& S) {\n   \
    \ string ret;\n    for (auto [a, b] : S) {\n        rep(i, b) ret.push_back(a);\n\
    \    }\n    return ret;\n}\n#line 4 \"test/other/run-length-encoding/atcoder-abc259-c.test.cpp\"\
    \n\nint main() {\n    string S, T;\n    cin >> S >> T;\n\n    auto s = encode(S);\n\
    \    auto t = encode(T);\n\n    string ans = \"Yes\";\n    if (s.size() != t.size())\
    \ {\n        ans = \"No\";\n    }\n    else {\n        rep(i, s.size()) {\n  \
  ...
  requiredBy: []
  timestamp: '2024-09-28 16:28:53+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/other/run-length-encoding/atcoder-abc259-c.test.cpp
layout: document
redirect_from:
- /verify/test/other/run-length-encoding/atcoder-abc259-c.test.cpp
- /verify/test/other/run-length-encoding/atcoder-abc259-c.test.cpp.html

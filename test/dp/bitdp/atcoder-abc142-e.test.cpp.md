...
data:
  ...
  bundledCode: "#line 1 \"test/dp/bitdp/atcoder-abc142-e.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc142/tasks/abc142_e\"\n\n#line 2 \"base.cpp\"\
    ...
    \ dp[(1 << N) - 1];\n};\n#line 4 \"test/dp/bitdp/atcoder-abc142-e.test.cpp\"\n\
    \nint main() {\n    ll N, M;\n    cin >> N >> M;\n\n    vll a(M), b(M);\n    vector<vll>\
    \ c(M);\n\n    rep(i, M) {\n        cin >> a[i] >> b[i];\n        c[i].resize(b[i]);\n\
    \n        rep(j, b[i]) cin >> c[i][j];\n    }\n\n    vll d(M);\n    rep(i, M)\
    \ {\n        long long bit = 0;\n        fore(j, c[i]) {\n            bit |= (1\
    ...
    \ bit | d[i];\n            long long cost = a[i];\n\n            chmin(dp[next_bit],\
    \ dp[bit] + cost);\n        }\n    }\n\n    ll ans = dp[(1 << N) - 1];\n    if\
    \ (ans == inf64) cout << -1 << endl; \n    else cout << ans << endl;\n\n    return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc142/tasks/abc142_e\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/dp/bitdp/atcoder-abc142-e.test.cpp
layout: document
redirect_from:
- /verify/test/dp/bitdp/atcoder-abc142-e.test.cpp
- /verify/test/dp/bitdp/atcoder-abc142-e.test.cpp.html

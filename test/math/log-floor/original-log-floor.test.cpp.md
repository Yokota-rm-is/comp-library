...
data:
  ...
  bundledCode: "#line 1 \"test/math/log-floor/original-log-floor.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \    return result;\n}\n#line 3 \"math/log-floor.cpp\"\n\n// floor(log_n(x)) \u3092\
    \u8A08\u7B97\u3059\u308B\u95A2\u6570\nlong long log_floor(long long x, long long\
    \ base) {\n    // powers[i] = n^(2^i) \u3092\u683C\u7D0D\u3059\u308B\u30D9\u30AF\
    \u30BF\u30FC\n    vector<__int128_t> powers;\n    powers.push_back(base);\n\n\
    \    // powers \u306E\u69CB\u7BC9\uFF1Apowers.back() \u304C x \u3092\u8D85\u3048\
    \u308B\u307E\u3067\u7E70\u308A\u8FD4\u3059\n    while (powers.back() <= x) {\n\
    ...
    \ exponent;\n}\n#line 4 \"test/math/log-floor/original-log-floor.test.cpp\"\n\n\
    string to_string(__int128_t x) {\n    string ret;\n    while (x > 0) {\n     \
    \   ret += (char)('0' + x % 10);\n        x /= 10;\n    }\n    reverse(ret.begin(),\
    \ ret.end());\n    return ret;\n}\n\n// log_floor\u95A2\u6570\u306E\u691C\u8A3C\
    \u95A2\u6570\nbool validate_log_floor(long long x, long long base, long long ret)\
    \ {\n    __int128_t x_ = x;\n\n    // ret^n \u3092\u8A08\u7B97\n    __int128_t\
    \ ret_power_n = binpow<__uint128_t>(base, ret);\n    __int128_t next_power_n =\
    \ binpow<__uint128_t>(base, ret + 1);\n\n    if (ret_power_n <= x_ and x_ < next_power_n)\
    \ return true;\n\n    cout << \"Test failed for x = \" << x << \", base = \" <<\
    \ base << endl;\n    cout << \"Expected: \" << to_string(ret_power_n) << \" <=\
    \ \" << x << \" < \" << to_string(next_power_n) << endl;\n    cout << \"Result:\
    \ \" << ret << endl;\n\n    return false; // \u6761\u4EF6 ret^n <= x < (ret+1)^n\
    \ \u3092\u6E80\u305F\u3059\n}\n\nint main() {\n    // \u30C6\u30B9\u30C8\u30B1\
    \u30FC\u30B9\u306E\u7BC4\u56F2\n    const unsigned long long x_min = 1;\n    const\
    \ unsigned long long x_max = 1e18;\n    const unsigned long long base_min = 10;\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    ...
    }\n\n// log_floor\u95A2\u6570\u306E\u691C\u8A3C\u95A2\u6570\nbool validate_log_floor(long\
    \ long x, long long base, long long ret) {\n    __int128_t x_ = x;\n\n    // ret^n\
    \ \u3092\u8A08\u7B97\n    __int128_t ret_power_n = binpow<__uint128_t>(base, ret);\n\
    \    __int128_t next_power_n = binpow<__uint128_t>(base, ret + 1);\n\n    if (ret_power_n\
    \ <= x_ and x_ < next_power_n) return true;\n\n    cout << \"Test failed for x\
    \ = \" << x << \", base = \" << base << endl;\n    cout << \"Expected: \" << to_string(ret_power_n)\
    \ << \" <= \" << x << \" < \" << to_string(next_power_n) << endl;\n    cout <<\
    \ \"Result: \" << ret << endl;\n\n    return false; // \u6761\u4EF6 ret^n <= x\
    \ < (ret+1)^n \u3092\u6E80\u305F\u3059\n}\n\nint main() {\n    // \u30C6\u30B9\
    \u30C8\u30B1\u30FC\u30B9\u306E\u7BC4\u56F2\n    const unsigned long long x_min\
  ...
  verifiedWith: []
documentation_of: test/math/log-floor/original-log-floor.test.cpp
layout: document
redirect_from:
- /verify/test/math/log-floor/original-log-floor.test.cpp
- /verify/test/math/log-floor/original-log-floor.test.cpp.html

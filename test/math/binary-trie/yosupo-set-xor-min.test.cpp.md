...
data:
  ...
  bundledCode: "#line 1 \"test/math/binary-trie/yosupo-set-xor-min.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/set_xor_min\"\n\n#line 2 \"base.cpp\"\
    ...
    #line 4 \"test/math/binary-trie/yosupo-set-xor-min.test.cpp\"\n\nint main() {\n\
    \    ll Q;\n    cin >> Q;\n\n    BinaryTrie<> trie;\n\n    while (Q--) {\n   \
    \     ll t;\n        cin >> t;\n\n        if (t == 0) {\n            ull x;\n\
  ...
  verifiedWith: []
documentation_of: test/math/binary-trie/yosupo-set-xor-min.test.cpp
layout: document
redirect_from:
- /verify/test/math/binary-trie/yosupo-set-xor-min.test.cpp
- /verify/test/math/binary-trie/yosupo-set-xor-min.test.cpp.html

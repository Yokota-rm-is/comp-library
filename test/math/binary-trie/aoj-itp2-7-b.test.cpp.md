...
data:
  ...
  bundledCode: "#line 1 \"test/math/binary-trie/aoj-itp2-7-b.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP2_7_B&\"\n\n\
    #line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    #line 4 \"test/math/binary-trie/aoj-itp2-7-b.test.cpp\"\n\nint main() {\n    BinaryTrie<>\
    \ trie;\n\n    ll q;\n    cin >> q;\n\n    while (q--) {\n        ll t;\n    \
    \    cin >> t;\n\n        if (t == 0) {\n            ull x;\n            cin >>\
  ...
  verifiedWith: []
documentation_of: test/math/binary-trie/aoj-itp2-7-b.test.cpp
layout: document
redirect_from:
- /verify/test/math/binary-trie/aoj-itp2-7-b.test.cpp
- /verify/test/math/binary-trie/aoj-itp2-7-b.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/math/stirling-second/yosupo-stirling-number-of-the-second-kind.test.cpp\"\
    ...
    \        long long ret = 1;\n        while (n) {\n            if (n & 1) ret =\
    \ ret * x % MOD;\n            x = x * x % MOD;\n            n >>= 1;\n       \
    \ }\n        return ret;\n    }\n};\n#line 5 \"test/math/stirling-second/yosupo-stirling-number-of-the-second-kind.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/math/stirling-second/yosupo-stirling-number-of-the-second-kind.test.cpp
layout: document
redirect_from:
- /verify/test/math/stirling-second/yosupo-stirling-number-of-the-second-kind.test.cpp
- /verify/test/math/stirling-second/yosupo-stirling-number-of-the-second-kind.test.cpp.html

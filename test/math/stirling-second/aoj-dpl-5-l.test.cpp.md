...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_I
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_I
  bundledCode: "#line 1 \"test/math/stirling-second/aoj-dpl-5-l.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_I\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \    return result;\n}\n#line 3 \"math/stirling-second.cpp\"\n\ntemplate <long\
    ...
    \        assert(n <= 26 or MOD != -1);\n        init();\n    }\n\n    void init()\
    \ {\n        if (N * K <= 1e7) {\n            dp = vector<vector<long long>>(N\
    \ + 1, vector<long long>(K + 1, 0));\n            dp[0][0] = 1;\n            rep(i,\
    \ 1, N + 1) {\n                rep(j, 1, N + 1) {\n                    dp[i][j]\
    \ = dp[i - 1][j - 1] + dp[i - 1][j] * j;\n                    if (MOD != -1) dp[i][j]\
    \ %= MOD;\n                }\n            }\n        }\n        else {\n     \
    ...
    \        return get(N, k);\n    }\n\n    long long get(long long n, long long\
    \ k) {\n        assert(n <= N);\n        if (k > n) return 0;\n        assert(k\
    \ <= K);\n\n        if (N * K <= 1e7) {\n            return dp[n][k];\n      \
    \  }\n        else {\n            long long ret = 0;\n            rep(i, k + 1)\
    \ {\n                if ((k - i) % 2 == 0) {\n                    ret += MOD +\
    ...
    \        long long ret = 1;\n        while (n) {\n            if (n & 1) ret =\
    \ ret * x % MOD;\n            x = x * x % MOD;\n            n >>= 1;\n       \
    \ }\n        return ret;\n    }\n};\n#line 4 \"test/math/stirling-second/aoj-dpl-5-l.test.cpp\"\
    \n\nint main() {\n    ll n, k;\n    cin >> n >> k;\n\n    StirlingSecond<1000000007>\
    \ stirling(n);\n\n    cout << stirling.get(k) << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_I\"\
  ...
  verifiedWith: []
documentation_of: test/math/stirling-second/aoj-dpl-5-l.test.cpp
layout: document
redirect_from:
- /verify/test/math/stirling-second/aoj-dpl-5-l.test.cpp
- /verify/test/math/stirling-second/aoj-dpl-5-l.test.cpp.html

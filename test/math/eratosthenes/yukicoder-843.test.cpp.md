...
data:
  ...
  bundledCode: "#line 1 \"test/math/eratosthenes/yukicoder-843.test.cpp\"\n#define\
    \ PROBLEM \"https://yukicoder.me/problems/no/843\"\n\n#line 2 \"base.cpp\"\n\n\
    ...
    \n        // \u9AD8\u901F\u30E1\u30D3\u30A6\u30B9\u5909\u63DB\n        fast_mobius(H);\n\
    \n        return H;\n    }\n};\n#line 4 \"test/math/eratosthenes/yukicoder-843.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    Eratosthenes era(N);\n    vb\
    \ is_prime = era.is_prime;\n    vll primes;\n    primes.push_back(2);\n\n    ll\
    \ ans = 0;\n    rep(i, 3, N + 1, 2) if (is_prime[i]) primes.push_back(i);\n\n\
    \    for (size_t i = 0; primes[i] * primes[i] <= 2 * N; ++i) {\n        ll r2\
    \ = primes[i] * primes[i];\n\n        for (size_t j = 0; j < primes.size() and\
    \ primes[j] < r2; ++j) {\n            ll p = primes[j];\n            ll q = r2\
    \ - p;\n            if (q > N) continue;\n            if (is_prime[q]) ++ans;\n\
    \        }\n    }\n\n    cout << ans << endl;\n\n    return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2025-04-29 23:10:06+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/math/eratosthenes/yukicoder-843.test.cpp
layout: document
redirect_from:
- /verify/test/math/eratosthenes/yukicoder-843.test.cpp
- /verify/test/math/eratosthenes/yukicoder-843.test.cpp.html

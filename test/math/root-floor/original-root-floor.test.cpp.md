...
data:
  ...
  bundledCode: "#line 1 \"test/math/root-floor/original-root-floor.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \u7BC4\u56F2\u3092\u30EB\u30FC\u30D7\n    for (unsigned long long x = x_min; x\
    \ <= x_max; x *= 10) { // x\u309210\u500D\u305A\u3064\u5897\u3084\u3057\u3066\u30C6\
    \u30B9\u30C8\n        for (int n = n_min; n <= n_max; n++) {\n            // root_floor\u95A2\
    \u6570\u306E\u51FA\u529B\n            long long fast_result = root_floor((long\
    \ long)x, n);\n            all_tests_passed &= validate_root_floor((long long)x,\
    \ n, fast_result);\n        }\n    }\n\n    // \u30E9\u30F3\u30C0\u30E0\u30C6\u30B9\
  ...
  verifiedWith: []
documentation_of: test/math/root-floor/original-root-floor.test.cpp
layout: document
redirect_from:
- /verify/test/math/root-floor/original-root-floor.test.cpp
- /verify/test/math/root-floor/original-root-floor.test.cpp.html

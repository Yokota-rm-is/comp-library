...
data:
  ...
  bundledCode: "#line 1 \"test/math/root-floor/atcoder-abc361-f.test.cpp\"\n#define\
    ...
    \ false;\n    }\n    return true;\n}\n#line 6 \"test/math/root-floor/atcoder-abc361-f.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    vector<ll> A(65, 0);\n    rep(i,\
...
layout: document
redirect_from:
- /verify/test/math/root-floor/atcoder-abc361-f.test.cpp
- /verify/test/math/root-floor/atcoder-abc361-f.test.cpp.html

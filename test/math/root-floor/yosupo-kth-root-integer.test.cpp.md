...
data:
  ...
  bundledCode: "#line 1 \"test/math/root-floor/yosupo-kth-root-integer.test.cpp\"\n\
  ...
  verifiedWith: []
documentation_of: test/math/root-floor/yosupo-kth-root-integer.test.cpp
layout: document
redirect_from:
- /verify/test/math/root-floor/yosupo-kth-root-integer.test.cpp
- /verify/test/math/root-floor/yosupo-kth-root-integer.test.cpp.html

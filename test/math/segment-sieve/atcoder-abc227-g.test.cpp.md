...
data:
  ...
  bundledCode: "#line 1 \"test/math/segment-sieve/atcoder-abc227-g.test.cpp\"\n#define\
    ...
    using mint007 = Fp<1000000007>;\n// using mint = mint998;\n#line 7 \"test/math/segment-sieve/atcoder-abc227-g.test.cpp\"\
    \n\nusing mint = mint998;\n\nint main() {\n    ll N, K;\n    cin >> N >> K;\n\n\
    \    K = min(N - K, K);\n    \n    if (K == 0) {\n        cout << 1 << endl;\n\
    \        return 0;\n    }\n\n    ll M = 1e6 + 1;\n\n    SegmentSieve sieve_large(N\
    \ - K + 1, N + 1), sieve_small(0, K + 1);\n    vector<ll> factor_cnt(M, 0);\n\
  ...
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/abc227/tasks/abc227_g\"\
    ...
    \ {\n    ll N, K;\n    cin >> N >> K;\n\n    K = min(N - K, K);\n    \n    if\
    \ (K == 0) {\n        cout << 1 << endl;\n        return 0;\n    }\n\n    ll M\
    \ = 1e6 + 1;\n\n    SegmentSieve sieve_large(N - K + 1, N + 1), sieve_small(0,\
    \ K + 1);\n    vector<ll> factor_cnt(M, 0);\n    ll cnt = 0;\n\n    rep(i, N -\
    \ K + 1, N + 1) {\n        auto factors = sieve_large.factorize(i);\n        for\
    \ (auto& [p, exp] : factors) {\n            if (p >= M) cnt++;\n            else\
    \ factor_cnt[p] += exp;\n        }\n    }\n\n    rep(i, 2, K + 1) {\n        auto\
    \ factors = sieve_small.factorize(i);\n        for (auto& [p, exp] : factors)\
    \ {\n            factor_cnt[p] -= exp;\n        }\n    }\n\n    mint ans = 1;\n\
    \    rep(i, M) {\n        ans *= (factor_cnt[i] + 1);\n    }\n    ans *= mint(2).pow(cnt);\n\
    \n    cout << ans << endl;\n\n    return 0;\n} \n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2025-11-16 17:45:37+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/math/segment-sieve/atcoder-abc227-g.test.cpp
layout: document
redirect_from:
- /verify/test/math/segment-sieve/atcoder-abc227-g.test.cpp
- /verify/test/math/segment-sieve/atcoder-abc227-g.test.cpp.html

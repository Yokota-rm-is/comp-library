...
data:
  ...
  bundledCode: "#line 1 \"test/math/permutation/atcoder-abc172-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc172/tasks/abc172_e\"\n\n#line 2 \"\
    ...
    #line 6 \"test/math/permutation/atcoder-abc172-e.test.cpp\"\n\nconst int MOD =\
    \ 1000000007;\nusing mint = mint007;\n\nint main() {\n    ll N, M;\n    cin >>\
...
layout: document
redirect_from:
- /verify/test/math/permutation/atcoder-abc172-e.test.cpp
- /verify/test/math/permutation/atcoder-abc172-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/math/prime-factorization/aoj-ntl-1-a.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=NTL_1_A&\"\
    \n\n#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ long i = 3; i * i <= N; i += 2) {\n        while (N % i == 0) {\n          \
    \  ret[i]++;\n            N /= i;\n        }\n    } \n    if (N > 1) ret[N]++;\n\
    \    return ret;\n}\n#line 4 \"test/math/prime-factorization/aoj-ntl-1-a.test.cpp\"\
    \n\nint main() {\n    ll n;\n    cin >> n;\n\n    cout << n << \":\";\n\n    auto\
  ...
  requiredBy: []
  timestamp: '2024-04-27 14:48:59+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/math/prime-factorization/aoj-ntl-1-a.test.cpp
layout: document
redirect_from:
- /verify/test/math/prime-factorization/aoj-ntl-1-a.test.cpp
- /verify/test/math/prime-factorization/aoj-ntl-1-a.test.cpp.html

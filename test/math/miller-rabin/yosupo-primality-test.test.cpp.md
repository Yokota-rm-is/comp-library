...
data:
  ...
  bundledCode: "#line 1 \"test/math/miller-rabin/yosupo-primality-test.test.cpp\"\n\
    ...
    \    return result;\n}\n#line 3 \"math/miller-rabin.cpp\"\n\n// \u53C2\u8003:\
    \ https://drken1215.hatenablog.com/entry/2023/05/23/233000\n// \u8A08\u7B97\u91CF\
    : O(k log n) (k\u306F\u57FA\u6570\u306E\u500B\u6570)\n\n// montgomery modint (MOD\
    \ < 2^62, MOD is odd)\nstruct MontgomeryModInt64 {\n    using mint = MontgomeryModInt64;\n\
    \    using u64 = uint64_t;\n    using u128 = __uint128_t;\n    \n    // static\
    \ menber\n    static u64 MOD;\n    static u64 INV_MOD;  // INV_MOD * MOD \u2261\
    ...
    }\n#line 4 \"test/math/miller-rabin/yosupo-primality-test.test.cpp\"\n\nint main()\
    \ {\n    ll Q;\n    cin >> Q;\n\n    while (Q--) {\n        ll N;\n        cin\
    \ >> N;\n\n        cout << YesNo(is_prime(N)) << endl;\n    }\n    \n    return\
    \ 0;\n} \n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/primality_test\"\n\n#include\
    \ \"../../../math/miller-rabin.cpp\"\n\nint main() {\n    ll Q;\n    cin >> Q;\n\
    \n    while (Q--) {\n        ll N;\n        cin >> N;\n\n        cout << YesNo(is_prime(N))\
    \ << endl;\n    }\n    \n    return 0;\n} \n"
  dependsOn:
  - math/miller-rabin.cpp
  - base.cpp
  ...
  requiredBy: []
  timestamp: '2025-11-16 17:45:05+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/math/miller-rabin/yosupo-primality-test.test.cpp
layout: document
redirect_from:
- /verify/test/math/miller-rabin/yosupo-primality-test.test.cpp
- /verify/test/math/miller-rabin/yosupo-primality-test.test.cpp.html

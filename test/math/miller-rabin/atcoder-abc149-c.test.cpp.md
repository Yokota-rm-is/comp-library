...
data:
  ...
  bundledCode: "#line 1 \"test/math/miller-rabin/atcoder-abc149-c.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc149/tasks/abc149_c\"\n\n#line 2 \"\
    ...
    }\n#line 4 \"test/math/miller-rabin/atcoder-abc149-c.test.cpp\"\n\nint main()\
    \ {\n    ll X;\n    cin >> X;\n\n    ll x = X;\n\n    while (true) {\n       \
    \ if (is_prime(x)) {\n            cout << x << endl;\n            return 0;\n\
    \        }\n\n        ++x;\n    }\n\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/math/miller-rabin/atcoder-abc149-c.test.cpp
layout: document
redirect_from:
- /verify/test/math/miller-rabin/atcoder-abc149-c.test.cpp
- /verify/test/math/miller-rabin/atcoder-abc149-c.test.cpp.html

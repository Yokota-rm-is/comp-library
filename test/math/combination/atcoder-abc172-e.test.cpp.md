...
data:
  ...
  bundledCode: "#line 1 \"test/math/combination/atcoder-abc172-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc172/tasks/abc172_e\"\n\n#line 2 \"\
    ...
    #line 6 \"test/math/combination/atcoder-abc172-e.test.cpp\"\n\nconst int MOD =\
    \ 1000000007;\nusing mint = mint007;\n\nint main() {\n    ll N, M;\n    cin >>\
    \ N >> M;\n\n    Combination<MOD> com;\n    Permutation<MOD> perm;\n    mint ans\
    \ = 0;\n\n    rep(i, 1, N + 1) {\n        mint count = com(N, i) * perm(M - i,\
    \ N - i);\n        if (i % 2 == 1) ans += count;\n        else ans -= count;\n\
  ...
  verifiedWith: []
documentation_of: test/math/combination/atcoder-abc172-e.test.cpp
layout: document
redirect_from:
- /verify/test/math/combination/atcoder-abc172-e.test.cpp
- /verify/test/math/combination/atcoder-abc172-e.test.cpp.html

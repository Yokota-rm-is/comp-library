...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc354/tasks/abc354_e
    links:
    - https://atcoder.jp/contests/abc354/tasks/abc354_e
  bundledCode: "#line 1 \"test/mystd/mybitset/atcoder-abc354-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc354/tasks/abc354_e\"\n\n#line 2 \"\
    ...
    \ x) { return bit != x.bit && (bit & x.bit) == bit; }\n    // \u81EA\u8EAB\u304C\
    x\u306E\u771F\u4E0A\u4F4D\u96C6\u5408\u304B\u3069\u3046\u304B\u5224\u5B9A\n  \
    \  bool is_proper_superset_of(Bitset x) { return bit != x.bit && (bit & x.bit)\
    \ == x.bit; }\n    // \u81EA\u8EAB\u304Cx\u3068\u4EA4\u5DEE\u3057\u3066\u3044\u308B\
    \u304B\u3069\u3046\u304B\u5224\u5B9A\n    bool intersects(Bitset x) { return bit\
    ...
    \ x; }\n    bool operator>(long long x) { return bit > x; }\n    bool operator<=(long\
    \ long x) { return bit <= x; }\n    bool operator>=(long long x) { return bit\
    \ >= x; }\n\n    friend istream& operator>>(istream& is, Bitset& x) { return is\
    \ >> x.bit; }\n    friend ostream& operator<<(ostream& os, Bitset& x) { \n   \
    \     os << (x.bit & 1) << \" \";\n        x.bit >>= 1;\n\n        while (x.bit)\
    \ {\n            os << (x.bit & 1) << \" \";\n            x.bit >>= 1;\n     \
    \   }\n        return os; \n    }\n};\n#line 4 \"test/mystd/mybitset/atcoder-abc354-e.test.cpp\"\
    \n\nll N;\nvll A, B;\nvector<ll> dp;\n\nbool f(Bitset bit) {\n    if (dp[bit]\
    \ != -1) return dp[bit];\n\n    bool ret = false;\n\n    rep(i, N) {\n       \
    ...
    \ 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc354/tasks/abc354_e\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/mystd/mybitset/atcoder-abc354-e.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/mybitset/atcoder-abc354-e.test.cpp
- /verify/test/mystd/mybitset/atcoder-abc354-e.test.cpp.html

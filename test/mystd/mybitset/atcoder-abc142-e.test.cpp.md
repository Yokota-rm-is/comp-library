...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/mybitset/atcoder-abc142-e.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc142/tasks/abc142_e\"\n\n#line 2 \"\
    ...
    \ sub, bit ^ sub);\n            if (sub == 0ll) break;\n        }\n    }\n}\n\
    #line 4 \"test/mystd/mybitset/atcoder-abc142-e.test.cpp\"\n\nint main() {\n  \
    \  ll N, M;\n    cin >> N >> M;\n\n    vll a(M), b(M);\n    vector<vll> c(M);\n\
    \n    rep(i, M) {\n        cin >> a[i] >> b[i];\n        c[i].resize(b[i]);\n\n\
    \        rep(j, b[i]) cin >> c[i][j];\n    }\n\n    vll d(M);\n    rep(i, M) {\n\
    \        long long bit = 0;\n        fore(j, c[i]) {\n            bit |= (1 <<\
  ...
  verifiedWith: []
documentation_of: test/mystd/mybitset/atcoder-abc142-e.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/mybitset/atcoder-abc142-e.test.cpp
- /verify/test/mystd/mybitset/atcoder-abc142-e.test.cpp.html

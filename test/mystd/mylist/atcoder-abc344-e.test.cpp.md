...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/mylist/atcoder-abc344-e.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc344/tasks/abc344_e\"\n\n#line 2 \"base.cpp\"\
    ...
    \    }   \n\n    friend constexpr ostream& operator << (ostream &os, const List<T>&\
    \ lst) noexcept {\n        for (auto it = lst.begin(); it != lst.end(); ++it)\
    \ {\n            os << *it;\n            if (it != prev(lst.end())) os << \" \"\
    ;\n        }\n        return os;\n    }\n};\n#line 4 \"test/mystd/mylist/atcoder-abc344-e.test.cpp\"\
    \n\nint main() {\n    ll N;\n    cin >> N;\n\n    List<ll> lst;\n    map<ll, list<ll>::iterator>\
    \ mp;\n\n    rep(i, N) {\n        ll a;\n        cin >> a;\n        mp[a] = lst.push_back(a);\n\
    \    }\n\n    ll Q;\n    cin >> Q;\n    while (Q--) {\n        ll t;\n       \
    \ cin >> t;\n\n        if (t == 1) {\n            ll x, y;\n            cin >>\
    \ x >> y;\n\n            auto it = mp[x];\n            mp[y] = lst.insert_after(it,\
    \ y);\n        }\n        else {\n            ll x;\n            cin >> x;\n\n\
    \            auto it = mp[x];\n            lst.erase(it);\n            mp.erase(x);\n\
    \        }\n    }\n\n    cout << lst << endl;\n\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc344/tasks/abc344_e\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/mystd/mylist/atcoder-abc344-e.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/mylist/atcoder-abc344-e.test.cpp
- /verify/test/mystd/mylist/atcoder-abc344-e.test.cpp.html

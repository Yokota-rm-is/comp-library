...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/mymultiset/atcoder-abc358-d.test.cpp\"\n#define\
    ...
    \ ? mp::end() : --it;\n    }\n};\n#line 5 \"test/mystd/mymultiset/atcoder-abc358-d.test.cpp\"\
    \n\nint main() {\n    ll N, M;\n    cin >> N >> M;\n    vector<ll> A(N), B(M);\n\
    \n    fore(a, A) cin >> a;\n    fore(b, B) cin >> b;\n\n    MultiSet<ll> ms;\n\
  ...
  code: "#define IGNORE\n#define PROBLEM \"https://atcoder.jp/contests/abc358/tasks/abc358_d\"\
    ...
    \    fore(b, B) cin >> b;\n\n    MultiSet<ll> ms;\n    rep(i, N) ms.insert(A[i]);\n\
    \n    ll ans = 0;\n\n    rep(i, M) {\n        ll key = B[i];\n        auto p =\
    \ ms.find_greater_than_or_equal(key);\n        if (p == ms.end()) {\n        \
    \    cout << -1 << endl;\n            return 0;\n        }\n        ans += p->first;\n\
    \        ms.erase(p->first);\n    }\n\n    cout << ans << endl;\n\n    return\
    \ 0;\n} \n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/mystd/mymultiset/atcoder-abc358-d.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/mymultiset/atcoder-abc358-d.test.cpp
- /verify/test/mystd/mymultiset/atcoder-abc358-d.test.cpp.html

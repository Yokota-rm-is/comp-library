...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/myset/aoj-itp2-7-b.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP2_7_B&\"\n\n\
    #line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ 4 \"test/mystd/myset/aoj-itp2-7-b.test.cpp\"\n\nint main() {\n    Set<ll> st;\n\
    \n    ll q;\n    cin >> q;\n\n    while (q--) {\n        ll t;\n        cin >>\
    \ t;\n\n        if (t == 0) {\n            ll x;\n            cin >> x;\n\n  \
    \          st.insert(x);\n            cout << st.size() << endl;\n        }\n\
    \        else if (t == 1) {\n            ll x;\n            cin >> x;\n\n    \
  ...
  verifiedWith: []
documentation_of: test/mystd/myset/aoj-itp2-7-b.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/myset/aoj-itp2-7-b.test.cpp
- /verify/test/mystd/myset/aoj-itp2-7-b.test.cpp.html

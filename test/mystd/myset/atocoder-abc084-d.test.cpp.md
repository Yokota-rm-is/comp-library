...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/myset/atocoder-abc084-d.test.cpp\"\n#define IGNORE\n\
    ...
    \n        // \u9AD8\u901F\u30E1\u30D3\u30A6\u30B9\u5909\u63DB\n        fast_mobius(H);\n\
    \n        return H;\n    }\n};\n#line 6 \"test/mystd/myset/atocoder-abc084-d.test.cpp\"\
    \n\nint main() {\n    ll N = 1e5;\n\n    Eratosthenes era(N);\n    Set<ll> st;\n\
  ...
  verifiedWith: []
documentation_of: test/mystd/myset/atocoder-abc084-d.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/myset/atocoder-abc084-d.test.cpp
- /verify/test/mystd/myset/atocoder-abc084-d.test.cpp.html

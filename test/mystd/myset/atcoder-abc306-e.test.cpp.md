...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/myset/atcoder-abc306-e.test.cpp\"\n#define IGNORE\n\
    ...
    \ 6 \"test/mystd/myset/atcoder-abc306-e.test.cpp\"\n\nint main() {\n    ll N,\
    \ K, Q;\n    cin >> N >> K >> Q;\n\n    MultiSet<ll> ms;\n    vll A(N, 0);\n \
    \   ms.insert(0, N);\n\n    while (Q--) {\n        ll x, y;\n        cin >> x\
    \ >> y;\n        --x;\n        ms.erase(A[x]);\n        A[x] = y;\n        ms.insert(y);\n\
  ...
  verifiedWith: []
documentation_of: test/mystd/myset/atcoder-abc306-e.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/myset/atcoder-abc306-e.test.cpp
- /verify/test/mystd/myset/atcoder-abc306-e.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/myset/yosupo-ordered-set.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/ordered_set\"\n\n#line 2 \"base.cpp\"\
    ...
    \ 4 \"test/mystd/myset/yosupo-ordered-set.test.cpp\"\n\nint main() {\n    ll N,\
    \ Q;\n    cin >> N >> Q;\n\n    vll a(N);\n    rep(i, N) cin >> a[i];\n\n    Set<ll>\
  ...
  verifiedWith: []
documentation_of: test/mystd/myset/yosupo-ordered-set.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/myset/yosupo-ordered-set.test.cpp
- /verify/test/mystd/myset/yosupo-ordered-set.test.cpp.html

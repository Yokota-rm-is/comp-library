...
data:
  ...
  bundledCode: "#line 1 \"test/mystd/myset/atcoder-abc287-g.test.cpp\"\n#define IGNORE\n\
    ...
    \ 6 \"test/mystd/myset/atcoder-abc287-g.test.cpp\"\n\nint main() {\n    ll N;\n\
    \    cin >> N;\n\n    vll a(N), b(N);\n    rep(i, N) cin >> a[i] >> b[i];\n\n\
    \    MultiSet<ll> ms;\n    rep(i, N) {\n        ms.insert(a[i], b[i]);\n    }\n\
    \n    ll Q;\n    cin >> Q;\n\n    while (Q--) {\n        ll t;\n        cin >>\
    \ t;\n\n        if (t == 1) {\n            ll x, y;\n            cin >> x >> y;\n\
  ...
  requiredBy: []
  timestamp: '2025-11-16 22:03:51+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/mystd/myset/atcoder-abc287-g.test.cpp
layout: document
redirect_from:
- /verify/test/mystd/myset/atcoder-abc287-g.test.cpp
- /verify/test/mystd/myset/atcoder-abc287-g.test.cpp.html

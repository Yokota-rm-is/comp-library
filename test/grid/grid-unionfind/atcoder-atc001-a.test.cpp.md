...
data:
  ...
  bundledCode: "#line 1 \"test/grid/grid-unionfind/atcoder-atc001-a.test.cpp\"\n#define\
    ...
    \     return par(x) = rx;\n    }\n\n    // x\u3068y\u3092\u9023\u7D50\n    void\
    \ unite(Coordinate x, Coordinate y) {\n        Coordinate rx = find(x); //x\u306E\
...
layout: document
redirect_from:
- /verify/test/grid/grid-unionfind/atcoder-atc001-a.test.cpp
- /verify/test/grid/grid-unionfind/atcoder-atc001-a.test.cpp.html

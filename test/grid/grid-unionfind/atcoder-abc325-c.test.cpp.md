...
data:
  ...
  bundledCode: "#line 1 \"test/grid/grid-unionfind/atcoder-abc325-c.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/abc325/tasks/abc325_c\"\n\n#line 2 \"\
    ...
    \ << endl;\n    }\n};\n#line 4 \"test/grid/grid-unionfind/atcoder-abc325-c.test.cpp\"\
    \n\nint main() {\n    ll H, W;\n    cin >> H >> W;\n\n    GridUnionFind uf(H,\
    ...
    \ - count;\n\n    cout << ans << endl;\n\n    return 0;\n} \n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc325/tasks/abc325_c\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/grid/grid-unionfind/atcoder-abc325-c.test.cpp
layout: document
redirect_from:
- /verify/test/grid/grid-unionfind/atcoder-abc325-c.test.cpp
- /verify/test/grid/grid-unionfind/atcoder-abc325-c.test.cpp.html

...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate<class T = __int128_t>\n\
    ...
    \        x *= 2;\n        add(bit0, l, -x * l);\n        add(bit0, r, x * r);\n\
    \        add(bit1, l, x);\n        add(bit1, r, -x);\n    }\n\n    // \u534A\u958B\
    \u533A\u9593[l, l+1, l+2, ..., r) (0-indexed)\u306B[al, al+d, al+2d, ..., al+d(r-l))\u3092\
    ...
    \ l, long long r, T x, T d = 0) {\n        assert(0 <= l and l <= _N and 0 <=\
    \ r and r <= 2 * _N);\n        if (l <= r and r <= _N) {\n            add(l, r,\
    \ x, d);\n            return;\n        }\n        \n        if (r > _N) r -= _N;\n\
    \        \n        add(l, _N, x, d);\n        add(0, r, x + d * (_N - l), d);\n\
    \    }\n\n    // \u4F4D\u7F6Ep (0-indexed)\u3092x\u306B\u3059\u308B\n    void\
...
documentation_of: structure/binary-indexed-tree.cpp
layout: document
redirect_from:
- /library/structure/binary-indexed-tree.cpp
- /library/structure/binary-indexed-tree.cpp.html

...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ = pow(x, 1.0 / n); if (binpow(ret, n) < x) ++ret; return ret;}\n#line 3 \"structure/dynamic-segment-tree-2d.cpp\"\
    \n\ntemplate<typename T>\nstruct Node {\n    T value;\n    long long y, x;\n \
    ...
    \n    T e;\n\n    DynamicSegmentTree2D(long long h, long long w) : _H(h), _W(w),\
    \ op(), mapping(), e(op.e()) {\n        init();\n    }\n\n    DynamicSegmentTree2D(long\
    \ long h, long long w, T a) : _H(h), _W(w), op(), mapping(), e(a) {\n        init();\n\
    \    }\n\n    void init() {\n        H = 1, W = 1;\n        while (H < (_H + 1))\
    \ {\n            H *= 2;\n        }\n\n        while (W < (_W + 1)) {\n      \
    \      W *= 2;\n        }\n    }\n\n    // p\u756A\u76EE\u306E\u914D\u5217\u306E\
    \u5024\u306B\u5BFE\u3057\u3066\uFF0Cf\u3067mapping\n    // p\u306F0-indexed\n\
    ...
    \ <= y and y < _H and 0 <= x and x < _W);\n\n        auto it = node.find(id(y\
    ...
    \ & 1) smu = op(smu, prod(u++, w1, w2));\n            if (d & 1) smd = op(prod(--d,\
    \ w1, w2), smd);\n        }\n\n        return op(smu, smd);\n    }\n\n    S prod(long\
    \ long h, long long w) {\n        return prod(0, h, 0, w);\n    }\n\n    // \u534A\
    \u958B\u533A\u9593[h1, h2) x [w1, w2) (0-indexed)\u306E\u8981\u7D20\u306E\u6570\
    \u3092\u6C42\u3081\u308B\n    T count(long long h1, long long h2, long long w1,\
    \ long long w2) {\n        return prod(h1, h2, w1, w2).size;\n    }\n\n    T count(long\
    \ long h, long long w) {\n        return count(0, h, 0, w);\n    }\n\n    friend\
    \ ostream& operator << (ostream& os, DynamicSegmentTree2D& seg) {\n        rep(i,\
    \ seg._H) {\n            rep(j, seg._W) {\n                os << seg.get(i, j)\
    \ << \" \";\n            }\n            os << endl;\n        }\n\n        return\
    ...
    \ and it1 == node.end()) continue;\n            else if (it0 == node.end()) node[id(i,\
    \ x)] = it1->second;\n            else if (it1 == node.end()) node[id(i, x)] =\
    \ it0->second;\n            else node[id(i, x)] = op(it0->second, it1->second);\n\
    \        }\n\n        for (long long i = y; i > 0; i >>= 1) {\n            for\
    \ (long long j = x >> 1; j > 0; j >>= 1) {\n                auto it0 = node.find(id(i,\
    ...
    \   S sml(e), smr(e);\n        for (long long l = j1, r = j2; l < r; l >>= 1,\
    \ r >>= 1) {\n            if (l & 1) {\n                auto it = node.find(id(i,\
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate<typename T>\nstruct Node\
    \ {\n    T value;\n    long long y, x;\n    long long size;\n    long long coeff;\n\
    \n    Node(T v = 0, long long y = 0, long long x = 0, long long s = 0, long long\
    \ c = 1) : value(v), y(y), x(x), size(s), coeff(c) {};\n\n    bool operator< (const\
    ...
    \ class _op>\nstruct DynamicSegmentTree2D {\n    using S = Node<T>;\n\n    long\
    \ long H, _H, W, _W;\n    unordered_map<ll, S> node;\n    _op<T> op;\n    _mapping<T,\
    \ F> mapping;\n\n    T e;\n\n    DynamicSegmentTree2D(long long h, long long w)\
    \ : _H(h), _W(w), op(), mapping(), e(op.e()) {\n        init();\n    }\n\n   \
    \ DynamicSegmentTree2D(long long h, long long w, T a) : _H(h), _W(w), op(), mapping(),\
    \ e(a) {\n        init();\n    }\n\n    void init() {\n        H = 1, W = 1;\n\
    \        while (H < (_H + 1)) {\n            H *= 2;\n        }\n\n        while\
    \ (W < (_W + 1)) {\n            W *= 2;\n        }\n    }\n\n    // p\u756A\u76EE\
    \u306E\u914D\u5217\u306E\u5024\u306B\u5BFE\u3057\u3066\uFF0Cf\u3067mapping\n \
    ...
    \ = it;\n\n        update(y, x);\n    }\n\n    S get(long long y, long long x)\
    \ {\n        assert(0 <= y and y < _H and 0 <= x and x < _W);\n\n        auto\
    \ it = node.find(id(y + H, x + W));\n        if (it == node.end()) return S(e);\n\
    \        else return it->second;\n    }\n\n    // \u534A\u958B\u533A\u9593[h1,\
    \ h2) x [w1, w2)\u306E\u914D\u5217\u306E\u5024\u3092\u8FD4\u3059\n    // l, r\u3068\
    \u3082\u306B0-indexed\n    S prod(long long h1, long long h2, long long w1, long\
    \ long w2) {\n        assert(0 <= h1 and h1 <= h2 and h2 <= _H and 0 <= w1 and\
    \ w1 <= w2 and w2 <= _W);\n\n        h1 += H, h2 += H, w1 += W, w2 += W;\n   \
    \     S smu(e), smd(e);\n        for (ll u = h1, d = h2; u < d; u >>= 1, d >>=\
    ...
    \ 0, w);\n    }\n\n    friend ostream& operator << (ostream& os, DynamicSegmentTree2D&\
    \ seg) {\n        rep(i, seg._H) {\n            rep(j, seg._W) {\n           \
    \     os << seg.get(i, j) << \" \";\n            }\n            os << endl;\n\
    ...
    \ * 2, x));\n            auto it1 = node.find(id(i * 2 + 1, x));\n\n         \
    \   if (it0 == node.end() and it1 == node.end()) continue;\n            else if\
    \ (it0 == node.end()) node[id(i, x)] = it1->second;\n            else if (it1\
    \ == node.end()) node[id(i, x)] = it0->second;\n            else node[id(i, x)]\
    \ = op(it0->second, it1->second);\n        }\n\n        for (long long i = y;\
    \ i > 0; i >>= 1) {\n            for (long long j = x >> 1; j > 0; j >>= 1) {\n\
    \                auto it0 = node.find(id(i, j * 2));\n                auto it1\
    \ = node.find(id(i, j * 2 + 1));\n\n                if (it0 == node.end() and\
    \ it1 == node.end()) continue;\n                else if (it0 == node.end()) node[id(i,\
    \ j)] = it1->second;\n                else if (it1 == node.end()) node[id(i, j)]\
    \ = it0->second;\n                else node[id(i, j)] = op(it0->second, it1->second);\n\
    \            }\n        }\n    }\n\n    S prod(long long i, long long j1, long\
    \ long j2) {\n        S sml(e), smr(e);\n        for (long long l = j1, r = j2;\
    \ l < r; l >>= 1, r >>= 1) {\n            if (l & 1) {\n                auto it\
    \ = node.find(id(i, l++));\n                if (it != node.end()) sml = op(sml,\
    \ it->second);\n            }\n            if (r & 1) {\n                auto\
    \ it = node.find(id(i, --r));\n                if (it != node.end()) smr = op(it->second,\
    \ smr);\n            }\n        }\n\n        return op(sml, smr);\n    }\n};\n"
  dependsOn:
  - base.cpp
...
layout: document
redirect_from:
- /library/structure/dynamic-segment-tree-2d.cpp
- /library/structure/dynamic-segment-tree-2d.cpp.html

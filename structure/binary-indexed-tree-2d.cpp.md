...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \u3092\u6C42\u3081\u308B\n    T sum(long long h1, long long w1, long long h2,\
    ...
    \ bit) {\n        // os << \"bit\" << endl;\n        // repd(h, bit.height) {\n\
    \        //     for (long long i = (1 << h); i < (long long)bit.bit.size(); i\
    \ += (1 << (h + 1))) {\n        //         os << bit.bit[i] << \" \";\n      \
    \  //     }\n        //     os << endl;\n        // }\n        // os << endl;\n\
    \n        os << \"value\" << endl;\n        rep(i, bit._N) {\n            os <<\
    \ bit.get(i) << \" \";\n        }\n        os << endl;\n\n        return os;\n\
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate<class T = long long>\n\
    ...
    \ << \"bit\" << endl;\n        // repd(h, bit.height) {\n        //     for (long\
    \ long i = (1 << h); i < (long long)bit.bit.size(); i += (1 << (h + 1))) {\n \
    \       //         os << bit.bit[i] << \" \";\n        //     }\n        //  \
    \   os << endl;\n        // }\n        // os << endl;\n\n        os << \"value\"\
    \ << endl;\n        rep(i, bit._N) {\n            os << bit.get(i) << \" \";\n\
    \        }\n        os << endl;\n\n        return os;\n    }\n};"
  ...
  requiredBy: []
  timestamp: '2024-08-17 05:01:18+09:00'

...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\n// \u53C2\u8003: https://trap.jp/post/2251/\n\
    ...
    template <class S,\n    auto op,\n    auto inv>\nstruct UndoUnionFind {\n    struct\
    \ data {\n        int u, v;\n        S x;\n        data(){}\n        data(int\
    \ a, int b, S c) : u(a), v(b), x(c) {}\n    };\n   \n    vector<int> par, sz;\n\
    \    vector<S> val;\n    stack<data> his;\n    int cc_size;\n\n    UndoUnionFind(int\
    \ n, S a = S()) : par(n), sz(n, 1), val(n, a), cc_size(n) {\n        iota(par.begin(),\
    \ par.end(), 0);\n    }\n\n    UndoUnionFind(int n, vector<S> v) : par(n), sz(n,\
    \ 1), val(v), cc_size(n) {\n        iota(par.begin(), par.end(), 0);\n    }\n\
    \  \n    int leader(int u) {\n        while (par[u] != u) {\n            u = par[u];\n\
    \        }\n        return u;\n    }\n    \n    bool same(int a, int b) {\n  \
    ...
    \ N) : n(N), t(0), sz(1), qi(0), li(0), uf(N), edges(N) {}\n    OfflineDynamicConnectivity(int\
    \ N, S a) : n(N), t(0), sz(1), qi(0), li(0), uf(N, a), edges(N) {}\n    OfflineDynamicConnectivity(int\
    \ N, vector<S> v) : n(N), t(0), sz(1), qi(0), li(0), uf(N, v), edges(N) {}\n\n\
    \    void build() {\n        rep(u, n) {\n            for (auto [v, l] : edges[u])\
    \ {\n                lrs.push_back(edge{l, t, int(u), v});\n            }\n  \
...
documentation_of: structure/offline-dynamic-connectivity.cpp
layout: document
redirect_from:
- /library/structure/offline-dynamic-connectivity.cpp
- /library/structure/offline-dynamic-connectivity.cpp.html

...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \    return result;\n}\n#line 3 \"structure/lazy-segment-tree-abstract.cpp\"\n\
    ...
    \            l >>= 1;\n            r >>= 1;\n        }\n\n        return op(sml,\
    \ smr);\n    }\n\n    S prod_all() {\n        return node[1];\n    }\n\n    //\
    \ \u5DE6\u7AEF\u3092l\u306B\u56FA\u5B9A\u3057\u305F\u5834\u5408\u306E\uFF0Cg(prod(op(node[l],\
    \ node[l + 1], ..., node[r - 1]))) = true\u3068\u306A\u308B\u6700\u5927\u306E\
    r\u3092\u8FD4\u3059\n    // g(node[l]) = false\u306E\u5834\u5408\uFF0Cl\u3092\u8FD4\
    \u3059 (\u534A\u958B\u533A\u9593[l, l)\u3068\u306A\u308A\uFF0C\u89E3\u306F\u306A\
    \u3044)\n    // l = N\u306E\u5834\u5408\uFF0CN\u3092\u8FD4\u3059\n    template\
    \ <class G>\n    long long max_right(long long l, G g) {\n#if __cplusplus >= 201703L\n\
    \        static_assert(is_convertible_v<decltype(g), function<bool(S)>>, \"g must\
    \ be function<bool(S)>\");\n#endif\n\n        assert(0 <= l && l <= _N);\n   \
    \     assert(g(e()));\n\n        if (l == _N) return _N;\n        l += N;\n  \
    ...
    \         }\n\n            sm = op(sm, node[l]);\n            l++;\n\n       \
    \ } while ((l & -l) != l);\n\n        return _N;\n    }\n\n    // \u53F3\u7AEF\
    \u3092r - 1\u306B\u56FA\u5B9A\u3057\u305F\u5834\u5408\u306E\uFF0Cg(prod(op(node[l],\
    \ node[l + 1], ..., node[r - 1]))) = true\u3068\u306A\u308B\u6700\u5C0F\u306E\
    l\u3092\u8FD4\u3059\n    // g(node[r - 1]) = false\u306E\u5834\u5408\uFF0Cr\u3092\
    \u8FD4\u3059 (\u534A\u958B\u533A\u9593[r, r)\u3068\u306A\u308A\uFF0C\u89E3\u306F\
    \u306A\u3044)\n    // r = 0\u306E\u5834\u5408\uFF0C0\u3092\u8FD4\u3059\n    template\
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\n#if __cplusplus >= 201703L\ntemplate<class\
    ...
    \   class F,\n    S (*mapping)(S, F),\n    void (*composition)(F&, F),\n    F\
    \ (*id)()>\n#endif\nstruct LazySegmentTree {\n#if __cplusplus >= 201703L\n   \
    \ static_assert(is_convertible_v<decltype(op), function<S(S, S)>>, \"op must be\
  ...
  requiredBy: []
  timestamp: '2025-11-16 17:54:10+09:00'
...
documentation_of: structure/lazy-segment-tree-abstract.cpp
layout: document
redirect_from:
- /library/structure/lazy-segment-tree-abstract.cpp
- /library/structure/lazy-segment-tree-abstract.cpp.html

...
data:
  ...
  bundledCode: "#line 2 \"base.cpp\"\n\n#include <bits/stdc++.h>\n// #include <atcoder/all>\n\
    ...
    \ << endl;\n        }\n\n        return os;\n    }\n};\n"
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate<class T = long long>\n\
    struct DynamicBinaryIndexedTree2D {\n    long long H, W, _H, _W;\n    vector<unordered_map<long\
    \ long, T>> bit;\n\n    DynamicBinaryIndexedTree2D(long long h, long long w):\
    \ _H(h), _W(w) {\n        init();\n    }\n\n    void init() {\n        H = _H\
    \ + 1;\n        W = _W + 1;\n\n        bit.resize(H);\n    }\n\n    // \u4F4D\u7F6E\
    ...
    \                if (it == bit[i].end()) continue;\n                ret += it->second;\n\
    \            }\n        }\n\n        return ret;\n    }\n\n    // \u534A\u958B\
    \u533A\u9593[h1, h2) x [w1, w2) (0-indexed)\u306E\u7DCF\u548C\u3092\u6C42\u3081\
    \u308B\n    T sum(long long h1, long long w1, long long h2, long long w2) {\n\
    \        assert(0 <= h1 and h1 <= h2 and h2 <= _H and 0 <= w1 and w1 <= w2 and\
    \ w2 <= _W);\n\n        return sum(h2, w2) - sum(h1, w2) - sum(h2, w1) + sum(h1,\
    \ w1);\n    }\n\n    // \u4F4D\u7F6Eh, w (0-indexed)\u306E\u5024\u3092\u6C42\u3081\
    \u308B\n    T get(long long h, long long w) {\n        assert(0 <= h and h < _H\
...
documentation_of: structure/dynamic-binary-indexed-tree-2d.cpp
layout: document
redirect_from:
- /library/structure/dynamic-binary-indexed-tree-2d.cpp
- /library/structure/dynamic-binary-indexed-tree-2d.cpp.html

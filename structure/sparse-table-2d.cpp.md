...
documentation_of: structure/sparse-table-2d.cpp
layout: document
redirect_from:
- /library/structure/sparse-table-2d.cpp
- /library/structure/sparse-table-2d.cpp.html

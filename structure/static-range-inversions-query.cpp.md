...
documentation_of: structure/static-range-inversions-query.cpp
layout: document
redirect_from:
- /library/structure/static-range-inversions-query.cpp
- /library/structure/static-range-inversions-query.cpp.html

...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate<typename T>\nstruct RotatableLazySegmentTree\
    ...
    \            min_v[i + N] = v[i];\n                sum_v[i + N] = v[i];\n    \
    \            len[i + N] = 1;\n            }\n            repd(i, 1, N) update(i);\n\
    \        }\n\n        // p\u306F0-indexed\n        void apply_add(long long p,\
    \ T f) {\n            assert(0 <= p and p < _N);\n\n            long long k =\
    \ p + N;\n            repd(i, 1, height) push(k >> i);\n            sum_v[k] +=\
    \ f;\n            max_v[k] += f;\n            min_v[k] += f;\n            rep(i,\
    \ 1, height) update(k >> i);\n        }\n\n        void apply_set(long long p,\
    \ T f) {\n            assert(0 <= p and p < _N);\n\n            long long k =\
    \ p + N;\n            repd(i, 1, height) push(k >> i);\n            sum_v[k] =\
    \ f;\n            max_v[k] = f;\n            min_v[k] = f;\n            rep(i,\
    \ 1, height) update(k >> i);\n        }\n\n        // l, r\u3068\u3082\u306B0-indexed\n\
    ...
    \ & 1) all_apply_add(--r2, f);\n                l2 >>= 1;\n                r2\
    \ >>= 1;\n            }\n\n            rep(i, 1, height) {\n                if\
    \ (((l >> i) << i) != l) update(l >> i);\n                if (((r >> i) << i)\
    \ != r) update((r - 1) >> i);\n            }\n        }\n\n        void apply_set(long\
    \ long l, long long r, T f) {\n            assert(0 <= l && l <= r && r <= _N);\n\
    \n            l += N;\n            r += N;\n\n            repd(i, 1, height) {\n\
    \                if (((l >> i) << i) != l) push(l >> i);\n                if (((r\
    \ >> i) << i) != r) push((r - 1) >> i);\n            }\n\n            long long\
    \ l2 = l, r2 = r;\n            while (l2 < r2) {\n                if (l2 & 1)\
    ...
    \                    h++;\n                }\n            }\n            os <<\
    \ endl;\n\n            os << \"lazy\" << endl;\n            h = 1;\n         \
    \   rep(i, 1, seg.N) {\n                if (seg.lazy[i] == seg.mapping.id()) os\
    \ << \"id \";\n                else os << seg.lazy[i] << \" \";\n            \
    \    if (i == (1 << h) - 1) {\n                    os << endl;\n             \
    \       h++;\n                }\n            }\n\n            os << \"value\"\
    \ << endl;\n            rep(i, seg._N) {\n                os << seg.get(i) <<\
    ...
    \ tree.prod_sum(l, tree._N) + tree.prod_sum(0, r);\n    }\n\n    template<bool\
    \ unrotate = false>\n    T prod_max(long long l, long long r) {\n        if constexpr\
    \ (!unrotate) {\n            l = (l + offset) % tree._N;\n            r = (r +\
    \ offset) % tree._N;\n        }\n\n        if (l < r) return tree.prod_max(l,\
    \ r);\n        else return max(tree.prod_max(l, tree._N), tree.prod_max(0, r));\n\
    \    }\n\n    template<bool unrotate = false>\n    T prod_min(long long l, long\
    \ long r) {\n        if constexpr (!unrotate) {\n            l = (l + offset)\
    \ % tree._N;\n            r = (r + offset) % tree._N;\n        }\n\n        if\
    \ (l < r) return tree.prod_min(l, r);\n        else return min(tree.prod_min(l,\
    \ tree._N), tree.prod_min(0, r));\n    }\n\n    friend ostream& operator << (ostream&\
    \ os, RotatableLazySegmentTree& seg) {\n        os << \"offset: \" << seg.offset\
    \ << endl;\n        os << seg.tree;\n        return os;\n    }\n};"
  dependsOn:
  - base.cpp
...
layout: document
redirect_from:
- /library/structure/rotatable-lazy-segment-tree.cpp
- /library/structure/rotatable-lazy-segment-tree.cpp.html

...
data:
  ...
  code: "#pragma once\n#include \"../base.cpp\"\n\ntemplate<class T = long long>\n\
    ...
    \ << (ostream& os, DynamicBinaryIndexedTree& bit) {\n        // os << \"bit\"\
    \ << endl;\n        // repd(h, bit.height) {\n        //     for (long long i\
    \ = (1 << h); i < (long long)bit.bit.size(); i += (1 << (h + 1))) {\n        //\
    \         os << bit.bit[i] << \" \";\n        //     }\n        //     os << endl;\n\
    \        // }\n        // os << endl;\n\n        os << \"value\" << endl;\n  \
    \      rep(i, bit._N) {\n            os << bit.get(i) << \" \";\n        }\n \
    \       os << endl;\n\n        return os;\n    }\n};\n"
...
documentation_of: structure/dynamic-binary-indexed-tree.cpp
layout: document
redirect_from:
- /library/structure/dynamic-binary-indexed-tree.cpp
- /library/structure/dynamic-binary-indexed-tree.cpp.html
